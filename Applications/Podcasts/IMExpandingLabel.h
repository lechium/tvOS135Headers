...
- (void).cxx_destruct;	// IMP=0x00000001001e6064
...
- (double)heightForWidth:(double)arg1;	// IMP=0x00000001001e5e30
- (void)moreButtonTapped:(id)arg1;	// IMP=0x00000001001e59cc
- (void)layoutSubviews;	// IMP=0x00000001001e4cc0
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000001001e48b8
- (id)_font;	// IMP=0x0000000100145888
- (unsigned long long)maximumNumberOfLinesThatFitHeight:(double)arg1;	// IMP=0x000000010014582c
- (void)setMoreButtonFont:(id)arg1;	// IMP=0x0000000100145720
- (void)setFont:(id)arg1;	// IMP=0x0000000100145604
