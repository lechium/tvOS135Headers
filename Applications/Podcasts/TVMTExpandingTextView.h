...
+ (double)cornerRadius;	// IMP=0x0000000100146f68
- (void).cxx_destruct;	// IMP=0x0000000100147c0c
...
- (void)_playButtonAction:(id)arg1;	// IMP=0x000000010014798c
- (void)_selectButtonAction:(id)arg1;	// IMP=0x0000000100147900
- (void)floatingContentView:(id)arg1 isTransitioningFromState:(unsigned long long)arg2 toState:(unsigned long long)arg3;	// IMP=0x00000001001478d8
- (_Bool)gestureRecognizerShouldBegin:(id)arg1;	// IMP=0x0000000100147840
- (void)pressesBegan:(id)arg1 withEvent:(id)arg2;	// IMP=0x0000000100147748
- (struct CGRect)_moreLabelFrame;	// IMP=0x00000001001473fc
- (id)_moreLabelExclusionPath;	// IMP=0x0000000100147360
- (void)_recomputeTextSizeIfNeeded;	// IMP=0x0000000100147214
- (void)_setNeedsTextSizeComputation;	// IMP=0x0000000100147200
@property(nonatomic) unsigned long long maximumNumberOfLines;
- (void)setFrame:(struct CGRect)arg1;	// IMP=0x0000000100146eec
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x0000000100146de8
- (_Bool)canBecomeFocused;	// IMP=0x0000000100146ddc
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x0000000100146ce4
- (void)setSelected:(_Bool)arg1 animated:(_Bool)arg2;	// IMP=0x0000000100146c88
- (void)setSelected:(_Bool)arg1 animated:(_Bool)arg2 withAnimationCoordinator:(id)arg3;	// IMP=0x0000000100146bec
- (void)layoutSubviews;	// IMP=0x000000010014687c
- (void)updateLabelsTextColorForFocused:(_Bool)arg1;	// IMP=0x00000001001466dc
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000100145e8c
