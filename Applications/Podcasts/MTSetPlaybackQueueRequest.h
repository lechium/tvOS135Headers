...
+ (id)requestWithContext:(id)arg1;	// IMP=0x0000000100150c94
- (void).cxx_destruct;	// IMP=0x0000000100150f0c
...
- (void)finishWithStatus:(long long)arg1;	// IMP=0x0000000100150dfc
- (_Bool)validate;	// IMP=0x0000000100150d0c
