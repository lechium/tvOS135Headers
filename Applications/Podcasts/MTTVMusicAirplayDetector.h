...
- (void).cxx_destruct;	// IMP=0x000000010013ea88
...
- (void)controller:(id)arg1 defersResponseReplacement:(CDUnknownBlockType)arg2;	// IMP=0x000000010013e888
- (id)initWithDelegate:(id)arg1;	// IMP=0x000000010013e72c
