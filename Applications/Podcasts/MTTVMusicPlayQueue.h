...
+ (CDStruct_912cb5d2)_tracklistRangeForRadioPlayback:(_Bool)arg1;	// IMP=0x00000001000ab8b4
+ (_Bool)_isTracklist:(id)arg1 equalToTrackList:(id)arg2;	// IMP=0x00000001000ab5ac
- (void).cxx_destruct;	// IMP=0x00000001000abc50
...
- (void)_activeSystemRouteDidChange:(id)arg1;	// IMP=0x00000001000ab99c
- (void)_repeatModeSettingDidChange:(id)arg1;	// IMP=0x00000001000ab8d8
- (void)_applicationDidBecomeActive:(id)arg1;	// IMP=0x00000001000ab8cc
- (_Bool)_isUserSubscribed;	// IMP=0x00000001000ab5a4
- (void)_updatePlayQueue;	// IMP=0x00000001000aa1b8
- (long long)_repeatModeFromRepeatType:(long long)arg1;	// IMP=0x00000001000aa1a0
- (long long)_tracklistRepeatMode;	// IMP=0x00000001000aa11c
- (id)_playEventFromGenericObject:(id)arg1;	// IMP=0x00000001000a9e90
- (id)_mediaItemForMPCPlayerResponseItem:(id)arg1 section:(id)arg2 atIndexPath:(id)arg3;	// IMP=0x00000001000a9bd4
- (void)_updateMediaItemsWithTrackList:(id)arg1;	// IMP=0x00000001000a9814
- (void)_performPlayerCommandRequest:(id)arg1 name:(id)arg2;	// IMP=0x00000001000a9560
- (void)_performPlayerCommand:(long long)arg1 name:(id)arg2;	// IMP=0x00000001000a9410
- (void)_performInternalPlayerCommand:(long long)arg1;	// IMP=0x00000001000a93ec
- (id)_podcastsPlayerPathWithRoute:(id)arg1;	// IMP=0x00000001000a93c0
- (id)_createGlobalPlayerPathWithRoute:(id)arg1;	// IMP=0x00000001000a9324
- (void)_updatePlayerPathWithRoute:(id)arg1;	// IMP=0x00000001000a9150
- (void)airplayDetectorAirplayEnded:(id)arg1;	// IMP=0x00000001000a8f40
- (void)airplayDetectorAirplayStarted:(id)arg1;	// IMP=0x00000001000a8d2c
- (_Bool)controller:(id)arg1 shouldRetryFailedRequestWithError:(id)arg2;	// IMP=0x00000001000a8a00
- (void)controller:(id)arg1 defersResponseReplacement:(CDUnknownBlockType)arg2;	// IMP=0x00000001000a8860
- (void)_mediaServicesDidReset;	// IMP=0x00000001000a86f8
- (_Bool)isMusicAppQueue;	// IMP=0x00000001000a8684
@property(readonly, nonatomic) _Bool isLocalDeviceQueue;
- (void)addToPlayQueueWithPlaybackIntent:(id)arg1 playNext:(_Bool)arg2;	// IMP=0x00000001000a823c
- (_Bool)canAddToPlayQueueAtEndWithPlaybackIntent:(id)arg1;	// IMP=0x00000001000a8164
- (_Bool)canAddToPlayQueueNextWithPlaybackIntent:(id)arg1;	// IMP=0x00000001000a808c
- (void)clearPlayQueueWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000001000a7d70
- (long long)repeatMode;	// IMP=0x00000001000a7d60
- (void)_setRepeatMode:(long long)arg1;	// IMP=0x00000001000a7c5c
- (void)_setRepeatType:(long long)arg1;	// IMP=0x00000001000a79b0
- (void)setRepeatMode:(long long)arg1;	// IMP=0x00000001000a7910
- (_Bool)shuffleEnabled;	// IMP=0x00000001000a7900
- (void)_setShuffleEnabled:(_Bool)arg1;	// IMP=0x00000001000a7800
- (void)setShuffleEnabled:(_Bool)arg1 preserveCurrentItem:(_Bool)arg2;	// IMP=0x00000001000a75a4
- (id)lastAVPlayer;	// IMP=0x00000001000a7598
...
- (void)setElapsedTime:(double)arg1;	// IMP=0x00000001000a7240
- (void)changeToItemAtIndex:(long long)arg1;	// IMP=0x00000001000a6ee8
- (void)changeToPreviousItem;	// IMP=0x00000001000a6e4c
- (void)changeToNextItem;	// IMP=0x00000001000a6db0
- (void)rewind;	// IMP=0x00000001000a6d08
- (void)fastForward;	// IMP=0x00000001000a6c60
- (void)stop;	// IMP=0x00000001000a6c48
- (void)pause;	// IMP=0x00000001000a6c30
- (void)play;	// IMP=0x00000001000a6b2c
- (id)responseTrackList;	// IMP=0x00000001000a6ab4
@property(readonly, nonatomic) long long playerState;
@property(readonly, nonatomic) MPCPlayerResponseItem *currentPlayingItem;
- (void)stopUpdating;	// IMP=0x00000001000a6880
- (void)startUpdating;	// IMP=0x00000001000a6808
- (void)updatePlayerPath;	// IMP=0x00000001000a6790
- (void)moveItemAtIndexToPlayNext:(long long)arg1;	// IMP=0x00000001000a64c8
- (_Bool)canMoveItemAtIndexToPlayNext:(long long)arg1;	// IMP=0x00000001000a6358
@property(retain, nonatomic) MPAVRoute *audioRoute;
@property(readonly, nonatomic) NSString *audioRouteName;
- (_Bool)isMediaItem:(id)arg1 matchingResponseItem:(id)arg2;	// IMP=0x00000001000a610c
- (id)currentMediaItem;	// IMP=0x00000001000a5fe0
- (unsigned long long)activeListIndex;	// IMP=0x00000001000a5ef8
- (unsigned long long)count;	// IMP=0x00000001000a5eac
- (id)trackList;	// IMP=0x00000001000a5ea0
- (id)activeList;	// IMP=0x00000001000a5e94
- (void)dealloc;	// IMP=0x00000001000a5e1c
- (id)initWithMediaItems:(id)arg1 index:(long long)arg2 isCollection:(_Bool)arg3;	// IMP=0x00000001000a5288
