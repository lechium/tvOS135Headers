...
- (void).cxx_destruct;	// IMP=0x00000001000b7de4
...
- (void)_lookupEpisodeUuidIfNecessaryFromURLString:(id)arg1;	// IMP=0x00000001000b7b1c
- (void)_lookupPodcastUuidIfNecessaryFromURLString:(id)arg1;	// IMP=0x00000001000b78bc
- (void)_loadQueryParameterValuesFromString:(id)arg1;	// IMP=0x00000001000b73a8
- (id)copyWithPlayReason:(unsigned long long)arg1;	// IMP=0x00000001000b737c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001000b7244
- (id)initWithURLString:(id)arg1;	// IMP=0x00000001000b71b8
