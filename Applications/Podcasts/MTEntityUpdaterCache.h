...
- (void).cxx_destruct;	// IMP=0x0000000100092f40
@property(copy, nonatomic) CDUnknownBlockType allowKeyForValue; // @synthesize allowKeyForValue=_allowKeyForValue;
- (void)enumerateUnvisitedItemUuids:(CDUnknownBlockType)arg1;	// IMP=0x0000000100092de0
- (void)_addDictionary:(id)arg1;	// IMP=0x0000000100092cc8
- (void)addEntityToCache:(id)arg1;	// IMP=0x0000000100092c78
- (void)_buildMap;	// IMP=0x00000001000929e0
- (id)propertyDictionaryForSearchItem:(id)arg1;	// IMP=0x0000000100092834
- (id)initWithPredicate:(id)arg1 entityName:(id)arg2 ctx:(id)arg3 properties:(id)arg4 fetchProperties:(id)arg5;	// IMP=0x0000000100092704
