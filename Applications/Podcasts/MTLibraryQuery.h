...
- (void).cxx_destruct;	// IMP=0x0000000100039a48
...
- (void)runQueryInContext:(id)arg1;	// IMP=0x000000010003955c
- (void)runQuery;	// IMP=0x00000001000394e0
- (void)runQueryWithPodcastPredicate:(id)arg1 episodePredicate:(id)arg2;	// IMP=0x0000000100039458
- (id)init;	// IMP=0x00000001000393f4
