...
+ (id)metadataWithValuesItemIdentifier:(id)arg1 keyValueStorePayload:(id)arg2;	// IMP=0x0000000100049144
+ (id)metadataWithValuesFromDataSourceItem:(id)arg1;	// IMP=0x0000000100048cb0
+ (id)keyValueStoreItemIdentifierForItem:(id)arg1;	// IMP=0x000000010004846c
...
- (id)keyValueStorePayload;	// IMP=0x000000010004998c
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100048398
- (unsigned long long)hash;	// IMP=0x00000001000482d8
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001000481e0
- (id)description;	// IMP=0x0000000100047fc0
- (id)init;	// IMP=0x0000000100047f8c
