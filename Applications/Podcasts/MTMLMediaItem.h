...
+ (_Bool)isMediaItemSyncedFromiTunes:(id)arg1;	// IMP=0x00000001000a4f5c
+ (id)propertiesForMediaItem;	// IMP=0x00000001000a4db8
+ (_Bool)isMissingAssetForItem:(id)arg1;	// IMP=0x00000001000a4c40
+ (_Bool)isMissingFilePathForItem:(id)arg1;	// IMP=0x00000001000a4be0
+ (id)itemWithMPMediaItem:(id)arg1 isRestoreDownloadCandidate:(_Bool)arg2;	// IMP=0x00000001000a43f0
+ (id)itemWithMPMediaItem:(id)arg1;	// IMP=0x00000001000a43e0
...
- (id)description;	// IMP=0x00000001000a4cec
