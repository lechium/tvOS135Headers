...
- (id)description;	// IMP=0x0000000100045a8c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001000459d8
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100045834
- (unsigned long long)hash;	// IMP=0x00000001000457a0
