...
- (void)layoutSubviews;	// IMP=0x000000010008d6b4
- (void)_updateGradientColors;	// IMP=0x000000010008d548
- (id)_blurredImageForImage:(id)arg1;	// IMP=0x000000010008d4b0
- (id)initWithArtwork:(id)arg1 blendColor:(id)arg2;	// IMP=0x000000010008d0e8
- (id)init;	// IMP=0x000000010008d0d4
