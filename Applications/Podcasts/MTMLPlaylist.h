...
+ (id)playlistWithMPPlaylist:(id)arg1;	// IMP=0x000000010009ea50
- (void).cxx_destruct;	// IMP=0x000000010009f0cc
...
- (id)description;	// IMP=0x000000010009ef3c
- (_Bool)isEmpty;	// IMP=0x000000010009eda0
- (id)children;	// IMP=0x000000010009ed98
- (void)addChild:(id)arg1;	// IMP=0x000000010009ed24
