...
- (void).cxx_destruct;	// IMP=0x000000010016624c
...
- (void)didMoveToWindow;	// IMP=0x000000010016605c
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x0000000100166050
- (void)layoutSubviews;	// IMP=0x0000000100165eb8
- (void)updatePlaybackState;	// IMP=0x0000000100165d24
- (void)_unregisterForNotifications;	// IMP=0x0000000100165c34
- (void)_registerForNotifications;	// IMP=0x0000000100165b30
@property(nonatomic) unsigned long long barsStyle;
@property(nonatomic) UIImage *image;
- (void)dealloc;	// IMP=0x00000001001655d0
- (id)init;	// IMP=0x0000000100165550
