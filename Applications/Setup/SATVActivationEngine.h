...
+ (id)activationEngineWithOverrideActivationURL:(id)arg1 sessionURL:(id)arg2;	// IMP=0x0000000100091488
- (void).cxx_destruct;	// IMP=0x00000001000932a8
...
- (void)URLSession:(id)arg1 task:(id)arg2 willPerformHTTPRedirection:(id)arg3 newRequest:(id)arg4 completionHandler:(CDUnknownBlockType)arg5;	// IMP=0x0000000100092fc0
- (void)URLSession:(id)arg1 task:(id)arg2 didCompleteWithError:(id)arg3;	// IMP=0x0000000100092cf8
- (void)URLSession:(id)arg1 dataTask:(id)arg2 didReceiveData:(id)arg3;	// IMP=0x0000000100092c58
- (void)URLSession:(id)arg1 dataTask:(id)arg2 didReceiveResponse:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x0000000100092b88
- (void)makeRequest:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000100092a54
- (void)tryActivateWithOptions:(id)arg1 requestMutator:(CDUnknownBlockType)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x0000000100092678
- (void)_sendSessionRequest:(id)arg1 withOptions:(id)arg2;	// IMP=0x0000000100091d64
- (id)_newActivationRequestWithOptions:(id)arg1 sessionData:(id)arg2 error:(id *)arg3;	// IMP=0x00000001000917cc
@property(readonly, nonatomic) NSURLSession *session;
- (void)_cleanup;	// IMP=0x0000000100091670
- (void)cancel;	// IMP=0x00000001000915a0
- (id)initWithOverrideActivationURL:(id)arg1 sessionURL:(id)arg2;	// IMP=0x00000001000914fc
