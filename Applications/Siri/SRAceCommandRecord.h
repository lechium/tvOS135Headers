...
- (void).cxx_destruct;	// IMP=0x0000000100080260
...
- (void)incrementNumberOfUnsuccessfullyCompletedActions;	// IMP=0x00000001000801a4
- (void)incrementNumberOfSuccessfullyCompletedActions;	// IMP=0x000000010007fce8
- (void)incrementNumberOfStoppedActions;	// IMP=0x000000010007fcb0
- (void)incrementNumberOfStartedActions;	// IMP=0x000000010007fc78
- (id)initWithAceCommand:(id)arg1 andCompletion:(CDUnknownBlockType)arg2;	// IMP=0x000000010007fb50
