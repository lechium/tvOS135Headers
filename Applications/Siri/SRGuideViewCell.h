...
+ (_Bool)chevronBlendEffectEnabled;	// IMP=0x000000010002ff7c
+ (struct UIEdgeInsets)defaultInsets;	// IMP=0x000000010002ff20
+ (double)heightOfCellWithName:(id)arg1 tagPhrase:(id)arg2 width:(double)arg3;	// IMP=0x000000010002fb90
+ (_Bool)placesImageAboveText;	// IMP=0x000000010002f434
+ (_Bool)_allowsTextToWrap;	// IMP=0x000000010002f3c0
+ (id)_tagPhraseLabelFont;	// IMP=0x000000010002f3ac
+ (id)_nameLabelFont;	// IMP=0x000000010002f398
...
- (void)updateConstraints;	// IMP=0x000000010002f4a8
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000010002f02c
