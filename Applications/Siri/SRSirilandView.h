...
+ (id)sirilandView;	// IMP=0x0000000100072e1c
- (void).cxx_destruct;	// IMP=0x0000000100073544
...
- (void)statusBarFrameDidChange;	// IMP=0x00000001000733d4
- (_Bool)_keylineIsVisible;	// IMP=0x000000010007339c
- (void)layoutSubviews;	// IMP=0x0000000100073084
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000100072e30
