...
- (void).cxx_destruct;	// IMP=0x0000000100074d80
...
- (void)speechSynthesizer:(id)arg1 didFinishSynthesisRequest:(id)arg2 withInstrumentMetrics:(id)arg3 error:(id)arg4;	// IMP=0x0000000100074a54
- (_Bool)handlePreSynthesisCommandWithError:(id *)arg1;	// IMP=0x0000000100074004
- (id)init;	// IMP=0x00000001000735bc
