...
+ (id)sharedInstance;	// IMP=0x0000000100005b60
- (void)pairingAgent:(id)arg1 peerDidRequestPairing:(id)arg2 type:(long long)arg3 passkey:(id)arg4;	// IMP=0x0000000100005bcc
