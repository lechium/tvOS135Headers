...
- (void).cxx_destruct;	// IMP=0x0000000100020b34
@property(nonatomic, readonly) _TtC6Arcade19DynamicTypeTextView *accessibilityTextLabel;
- (void)moreFrom:(id)arg1;	// IMP=0x00000001000208f8
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x0000000100020824
- (struct JUMeasurements)measurementsWithFitting:(struct CGSize)arg1 in:(id)arg2;	// IMP=0x00000001000205bc
- (void)layoutSubviews;	// IMP=0x00000001000202d4
@property(nonatomic) struct CGRect frame;
- (id)initWithCoder:(id)arg1;	// IMP=0x000000010001fd14
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000010001fcf4
