...
- (void)_clearCachedValues;	// IMP=0x000000010007f948
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x000000010007f878
- (struct CGRect)textRectForBounds:(struct CGRect)arg1 limitedToNumberOfLines:(long long)arg2;	// IMP=0x000000010007f73c
- (void)setBaselineAdjustment:(long long)arg1;	// IMP=0x000000010007f6ec
- (void)setAdjustsFontSizeToFitWidth:(_Bool)arg1;	// IMP=0x000000010007f69c
- (void)setNumberOfLines:(long long)arg1;	// IMP=0x000000010007f64c
- (void)setLineBreakMode:(long long)arg1;	// IMP=0x000000010007f5fc
- (void)setFont:(id)arg1;	// IMP=0x000000010007f5ac
- (void)setText:(id)arg1;	// IMP=0x000000010007f55c
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000010007f494
