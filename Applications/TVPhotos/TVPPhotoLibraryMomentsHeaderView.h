...
- (void).cxx_destruct;	// IMP=0x0000000100028968
...
- (_Bool)_isLabel:(id)arg1 aboveFocusedRect:(struct CGRect)arg2;	// IMP=0x0000000100028694
- (_Bool)_hasSubtitle;	// IMP=0x0000000100028638
- (void)applyLayoutAttributes:(id)arg1;	// IMP=0x000000010002808c
- (void)prepareForReuse;	// IMP=0x0000000100027fa0
...
- (struct CGRect)_effectiveFocusedRect;	// IMP=0x0000000100027aec
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000100026964
- (_Bool)canBecomeFocused;	// IMP=0x000000010002695c
