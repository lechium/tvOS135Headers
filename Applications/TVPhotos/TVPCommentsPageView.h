...
- (void).cxx_destruct;	// IMP=0x000000010002e644
...
- (long long)_previousSectionWithItems;	// IMP=0x000000010002e3d0
- (long long)_nextSectionWithItems;	// IMP=0x000000010002e350
- (_Bool)_scrollToPreviousItem;	// IMP=0x000000010002e248
- (_Bool)_scrollToNextItem;	// IMP=0x000000010002e134
- (_Bool)_performPageScrollByEvaluatingOffset:(double)arg1;	// IMP=0x000000010002e07c
- (void)_resetPageScrollOffsets;	// IMP=0x000000010002e034
- (void)_startPageScroll:(double)arg1;	// IMP=0x000000010002df24
- (void)_handleDownScrollButtonGesture:(id)arg1;	// IMP=0x000000010002dcf0
- (void)_handleUpScrollButtonGesture:(id)arg1;	// IMP=0x000000010002db2c
- (id)preferredFocusedView;	// IMP=0x000000010002db28
- (_Bool)canBecomeFocused;	// IMP=0x000000010002db20
- (void)reloadData;	// IMP=0x000000010002da8c
@property(readonly, nonatomic) long long currentSection;
@property(readonly, nonatomic) long long currentIndex;
- (void)setFlowLayoutDefaultAttributes:(id)arg1;	// IMP=0x000000010002d9f8
- (void)scrollToItemAtIndexPath:(id)arg1 atScrollPosition:(unsigned long long)arg2 animated:(_Bool)arg3;	// IMP=0x000000010002d8c4
- (id)initWithFrame:(struct CGRect)arg1 collectionViewLayout:(id)arg2;	// IMP=0x000000010002d5e0
