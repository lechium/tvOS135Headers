...
- (void).cxx_destruct;	// IMP=0x000000010008cec8
...
- (void)_configureVideoBadgeView;	// IMP=0x000000010008cbec
- (void)layoutSubviews;	// IMP=0x000000010008c9c8
- (void)didAnimateToFullScreenMode;	// IMP=0x000000010008c978
- (void)willAnimateToFullScreenMode;	// IMP=0x000000010008c95c
- (void)didAnimateToCaptionMode;	// IMP=0x000000010008c918
- (void)willAnimateToCaptionMode;	// IMP=0x000000010008c8c8
