...
- (void).cxx_destruct;	// IMP=0x0000000100032b88
...
- (void)_crossfadeToImage:(id)arg1;	// IMP=0x0000000100032930
- (void)_loadNextImage:(id)arg1;	// IMP=0x0000000100032888
- (void)_startTimer;	// IMP=0x00000001000327d0
- (void)layoutSubviews;	// IMP=0x0000000100032458
- (void)didMoveToSuperview;	// IMP=0x00000001000323f0
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000100032318
