...
- (void).cxx_destruct;	// IMP=0x00000001000184b4
...
- (id)_latestCommentIndexPathForCommentsView;	// IMP=0x00000001000182e4
- (void)_scrollToLastComment;	// IMP=0x0000000100018264
- (void)layoutSubviews;	// IMP=0x0000000100017f18
- (id)preferredFocusEnvironments;	// IMP=0x0000000100017e88
- (id)dequeueReusableViewForIdentifier:(id)arg1;	// IMP=0x0000000100017de4
- (void)reloadCommentsData;	// IMP=0x0000000100017da0
- (void)registerClass:(Class)arg1 forCommentsWithReuseIdentifier:(id)arg2;	// IMP=0x0000000100017cb4
- (void)registerClass:(Class)arg1 forSubheaderWithReuseIdentifier:(id)arg2;	// IMP=0x0000000100017bd4
- (void)registerClass:(Class)arg1 forHeaderWithReuseIdentifier:(id)arg2;	// IMP=0x0000000100017af4
