...
- (void).cxx_destruct;	// IMP=0x00000001000868fc
...
- (void)_checkForPreloadCompletion;	// IMP=0x00000001000867ec
- (void)_imageProxyDidFail:(id)arg1 withError:(id)arg2;	// IMP=0x00000001000866f4
- (void)_imageProxyDidLoad:(id)arg1 withImage:(id)arg2;	// IMP=0x0000000100086628
- (void)_loadPendingImages;	// IMP=0x00000001000862a4
- (id)_imageProxyToLoadNext;	// IMP=0x00000001000861f0
- (void)_fillQueue;	// IMP=0x00000001000860ec
- (long long)_currentQueueSize;	// IMP=0x0000000100086090
- (id)popNextImage;	// IMP=0x0000000100085fec
- (void)preloadImageCount:(long long)arg1 withCompletionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000100085f90
- (void)dealloc;	// IMP=0x0000000100085e90
- (id)init;	// IMP=0x0000000100085db4
