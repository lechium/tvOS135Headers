...
- (void).cxx_destruct;	// IMP=0x0000000100060fd8
...
- (void)_detachMotionEffects;	// IMP=0x0000000100060eb8
- (void)_attachMotionEffects;	// IMP=0x0000000100060c64
- (void)layoutSubviews;	// IMP=0x0000000100060888
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x00000001000606e8
- (_Bool)canBecomeFocused;	// IMP=0x00000001000606e0
- (void)pressesCancelled:(id)arg1 withEvent:(id)arg2;	// IMP=0x00000001000604c8
- (void)pressesEnded:(id)arg1 withEvent:(id)arg2;	// IMP=0x00000001000602b0
- (void)pressesBegan:(id)arg1 withEvent:(id)arg2;	// IMP=0x0000000100060098
- (_Bool)_unapplyMotionEffect:(id)arg1;	// IMP=0x0000000100060060
- (_Bool)_applyKeyPathsAndRelativeValues:(id)arg1 forMotionEffect:(id)arg2;	// IMP=0x000000010005ff7c
- (id)init;	// IMP=0x000000010005fb18
