...
- (void).cxx_destruct;	// IMP=0x000000010001ed44
...
- (void)viewDidLayoutSubviews;	// IMP=0x000000010001e8f4
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x000000010001e718
- (void)loadView;	// IMP=0x000000010001e4b4
- (void)dealloc;	// IMP=0x000000010001e454
- (id)initWithNibName:(id)arg1 bundle:(id)arg2;	// IMP=0x000000010001e3d0
