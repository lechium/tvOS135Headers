...
- (void).cxx_destruct;	// IMP=0x0000000100038e64
...
- (void)_deflateLayerStack;	// IMP=0x0000000100038cac
- (void)_inflateLayerStack;	// IMP=0x00000001000389c4
...
- (id)imageConfigurationForConfiguration:(id)arg1;	// IMP=0x000000010003884c
- (id)initWithApplication:(id)arg1;	// IMP=0x0000000100038410
