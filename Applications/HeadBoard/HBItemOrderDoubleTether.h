...
- (unsigned long long)insertionIndexInItems:(id)arg1;	// IMP=0x000000010005d940
- (id)initWithLeadingApplication:(id)arg1 distance:(unsigned long long)arg2 trailingApplication:(id)arg3 distance:(unsigned long long)arg4;	// IMP=0x000000010005d864
