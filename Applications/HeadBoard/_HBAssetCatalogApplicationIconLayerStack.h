...
- (void).cxx_destruct;	// IMP=0x000000010001c3a8
...
- (void)_deflateLayerStack;	// IMP=0x000000010001c1f0
- (void)_inflateLayerStack;	// IMP=0x000000010001bf08
...
- (id)imageConfigurationForConfiguration:(id)arg1;	// IMP=0x000000010001bd90
- (id)initWithApplication:(id)arg1;	// IMP=0x000000010001ba80
