...
- (void).cxx_destruct;	// IMP=0x0000000100030b90
...
- (id)description;	// IMP=0x00000001000309c0
- (void)cancel;	// IMP=0x00000001000308b4
- (void)_executionDidBegin;	// IMP=0x0000000100030164
- (id)initWithApplicationIdentifier:(id)arg1 fetchIdentifier:(id)arg2 contentExtensionController:(id)arg3;	// IMP=0x0000000100030060
