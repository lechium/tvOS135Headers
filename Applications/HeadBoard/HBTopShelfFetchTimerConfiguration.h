...
+ (id)_fastFetchConfiguration;	// IMP=0x0000000100019f10
+ (id)_noRefetchingConfiguration;	// IMP=0x0000000100019ec8
+ (id)_defaultFetchConfiguration;	// IMP=0x0000000100019ddc
+ (id)sharedConfiguration;	// IMP=0x0000000100019c2c
- (void).cxx_destruct;	// IMP=0x000000010001a08c
...
- (id)initWithFetchMode:(id)arg1;	// IMP=0x0000000100019bac
