...
- (void).cxx_destruct;	// IMP=0x000000010003f5a0
...
- (id)imageConfigurationForConfiguration:(id)arg1;	// IMP=0x000000010003f4b0
- (id)initWithApplication:(id)arg1;	// IMP=0x000000010003f2b8
