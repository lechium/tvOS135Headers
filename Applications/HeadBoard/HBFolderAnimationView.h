...
- (void)_updateWithCurrentStyle;	// IMP=0x0000000100058164
- (void)_updateImageViews;	// IMP=0x0000000100057e64
@property(readonly, nonatomic) struct CGSize imageSize;
- (void)layoutSubviews;	// IMP=0x00000001000579b0
- (id)initWithConfiguration:(id)arg1;	// IMP=0x00000001000577f8
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000100057790
