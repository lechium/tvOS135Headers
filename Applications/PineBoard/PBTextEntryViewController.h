...
- (void).cxx_destruct;	// IMP=0x0000000100120d0c
...
- (id)_messageStringAttributes;	// IMP=0x0000000100120518
- (id)_titleStringAttributes;	// IMP=0x0000000100120290
- (void)_menuButtonPressed:(id)arg1;	// IMP=0x00000001001200ec
- (void)textEntryControllerDidFinish:(id)arg1;	// IMP=0x000000010011ffb8
- (void)buttonView:(id)arg1 didSelectButton:(id)arg2 atIndex:(long long)arg3;	// IMP=0x000000010011fe04
- (void)_synchronizeEnteredValues;	// IMP=0x000000010011fd64
- (id)textField;	// IMP=0x000000010011fc6c
- (void)_showChildViewController:(id)arg1;	// IMP=0x000000010011f9d4
- (id)_buttonsForTextField:(long long)arg1 defaultButtonIndex:(long long *)arg2;	// IMP=0x000000010011f638
- (void)_showTextEntryViewControllerForTextField:(long long)arg1;	// IMP=0x000000010011ed9c
- (void)_configureStateMachine;	// IMP=0x000000010011e29c
- (id)presentationControllerForPresentedViewController:(id)arg1 presentingViewController:(id)arg2 sourceViewController:(id)arg3;	// IMP=0x000000010011e1cc
- (id)animationControllerForDismissedController:(id)arg1;	// IMP=0x000000010011e154
- (id)animationControllerForPresentedController:(id)arg1 presentingController:(id)arg2 sourceController:(id)arg3;	// IMP=0x000000010011e088
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x000000010011dfb4
- (void)viewDidLoad;	// IMP=0x000000010011df50
- (void)loadView;	// IMP=0x000000010011dd34
- (unsigned long long)addButtonWithTitle:(id)arg1;	// IMP=0x000000010011dc78
- (void)setAlternateTitle:(id)arg1 message:(id)arg2 forTextFieldAtIndex:(unsigned long long)arg3;	// IMP=0x000000010011db34
- (unsigned long long)addTextFieldWithInitialText:(id)arg1 placeholder:(id)arg2 keyboardType:(long long)arg3;	// IMP=0x000000010011d91c
- (id)init;	// IMP=0x000000010011d8a4
- (id)initWithNibName:(id)arg1 bundle:(id)arg2;	// IMP=0x000000010011d660
