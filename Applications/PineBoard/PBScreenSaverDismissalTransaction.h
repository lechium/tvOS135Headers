...
- (void).cxx_destruct;	// IMP=0x00000001000fa1e4
...
- (void)_prepareKioskAnimationInTransaction:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000001000f99fc
- (id)_defaultAppAnimationTransaction;	// IMP=0x00000001000f9820
- (void)_begin;	// IMP=0x00000001000f90f4
- (_Bool)_canBeInterrupted;	// IMP=0x00000001000f90d8
- (id)initWithScreenSaverViewController:(id)arg1 animated:(_Bool)arg2 updateWallpaper:(_Bool)arg3 applyStartValues:(_Bool)arg4;	// IMP=0x00000001000f8f64
