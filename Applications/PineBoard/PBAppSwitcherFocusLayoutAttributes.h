...
- (id)description;	// IMP=0x00000001000d6ab0
- (unsigned long long)hash;	// IMP=0x00000001000d66f8
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001000d60e8
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001000d5d50
