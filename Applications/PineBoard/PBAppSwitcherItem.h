...
- (void).cxx_destruct;	// IMP=0x00000001001cf450
...
- (void)_updateIconImage;	// IMP=0x00000001001cf0b0
- (void)_updateDisplayName;	// IMP=0x00000001001cef50
- (void)_updateForProgressChange;	// IMP=0x00000001001cef18
- (id)description;	// IMP=0x00000001001ceeb8
- (id)initWithType:(long long)arg1 bundleIdentifier:(id)arg2 appInfo:(id)arg3 dataSource:(id)arg4 live:(_Bool)arg5;	// IMP=0x00000001001ce9e8
