...
- (void).cxx_destruct;	// IMP=0x00000001001f5320
...
- (void)processManager:(id)arg1 didRemoveProcess:(id)arg2;	// IMP=0x00000001001f4e5c
- (void)processManager:(id)arg1 didAddProcess:(id)arg2;	// IMP=0x00000001001f4ddc
- (void)transaction:(id)arg1 willLaunchProcess:(id)arg2;	// IMP=0x00000001001f4994
- (_Bool)_canPerformAppLaunch:(id *)arg1;	// IMP=0x00000001001f4270
- (void)_relinquishSystemAnimationDeactivationAssertion;	// IMP=0x00000001001f40b4
- (void)_beginSceneTransitionInTransaction:(id)arg1;	// IMP=0x00000001001f2f24
- (void)_beginSceneUpdateTransactionInTransaction:(id)arg1 withSchedulingPolicy:(unsigned long long)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x00000001001f24b0
- (void)_callFrontBoardCompletionIfNeededWithError:(id)arg1;	// IMP=0x00000001001f1ec0
- (void)_didComplete;	// IMP=0x00000001001f1c40
- (_Bool)_shouldFailForChildTransaction:(id)arg1;	// IMP=0x00000001001f1bec
- (void)_begin;	// IMP=0x00000001001f13dc
- (_Bool)_canBeInterrupted;	// IMP=0x00000001001f1348
@property(readonly, copy) NSString *debugDescription;
@property(readonly, copy) NSString *description;
- (void)transferSceneDeactivationAssertionFromInterruptedTransition:(id)arg1;	// IMP=0x00000001001f0e28
- (void)removeObserver:(id)arg1;	// IMP=0x00000001001f0d7c
- (void)addObserver:(id)arg1;	// IMP=0x00000001001f0cd0
...
- (void)dealloc;	// IMP=0x00000001001f0b04
- (id)initWithRequest:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000001001efb3c
