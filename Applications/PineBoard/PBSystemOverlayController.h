...
+ (id)keyPathsForValuesAffectingHasActivePresentation;	// IMP=0x00000001000cd350
- (void).cxx_destruct;	// IMP=0x00000001000ce9c0
...
- (void)_checkPendingRequests;	// IMP=0x00000001000ce0b0
- (void)_callPendingDismissalCompletionHandlersForSession:(id)arg1 success:(_Bool)arg2;	// IMP=0x00000001000cde40
- (void)_callPendingPresentationCompletionHandlersForSession:(id)arg1 success:(_Bool)arg2;	// IMP=0x00000001000cdbd0
- (void)systemOverlaySessionDidInvalidate:(id)arg1;	// IMP=0x00000001000cd8ec
- (void)systemOverlaySessionDidCancel:(id)arg1 withContext:(id)arg2;	// IMP=0x00000001000cd7d4
- (void)systemOverlaySessionDidDismiss:(id)arg1;	// IMP=0x00000001000cd718
- (void)systemOverlaySessionWillDismiss:(id)arg1 withContext:(id)arg2;	// IMP=0x00000001000cd624
- (void)systemOverlaySessionDidPresent:(id)arg1;	// IMP=0x00000001000cd568
- (void)systemOverlaySessionWillPresent:(id)arg1;	// IMP=0x00000001000cd4d4
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x00000001000cd3b0
- (void)resume;	// IMP=0x00000001000cd08c
- (void)pauseWithOptions:(long long)arg1;	// IMP=0x00000001000cce58
@property(readonly, nonatomic) _Bool hasActivePresentation;
- (void)dismissWithRequest:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000001000cc964
- (void)presentWithRequest:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000001000cc464
- (id)initWithName:(id)arg1 layoutLevel:(long long)arg2 presentationHandler:(id)arg3 delegate:(id)arg4;	// IMP=0x00000001000cc10c
- (id)init;	// IMP=0x00000001000cc0c8
