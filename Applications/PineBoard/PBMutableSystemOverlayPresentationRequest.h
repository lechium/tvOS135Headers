...
- (void)_setInsertAtFrontOfQueue:(_Bool)arg1;	// IMP=0x00000001000cf224
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001000ceff4
- (id)init;	// IMP=0x00000001000cef70
