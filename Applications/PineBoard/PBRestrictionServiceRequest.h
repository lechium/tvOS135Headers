...
- (void).cxx_destruct;	// IMP=0x0000000100014e20
...
- (id)description;	// IMP=0x0000000100014aa8
- (unsigned long long)hash;	// IMP=0x0000000100014a6c
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001000148e0
- (id)initWithToken:(id)arg1 requestType:(unsigned long long)arg2;	// IMP=0x00000001000147e4
- (id)initWithToken:(id)arg1;	// IMP=0x0000000100014744
