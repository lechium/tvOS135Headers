...
+ (id)_appIconNameForAppInfo:(id)arg1;	// IMP=0x00000001000903dc
+ (id)_placeholderIconImageForScale:(double)arg1;	// IMP=0x0000000100090394
+ (id)_pathForCacheKey:(id)arg1 cacheDirectory:(id)arg2;	// IMP=0x00000001000902f4
+ (id)_cacheKeyForBundleIdentifier:(id)arg1 scale:(double)arg2 lastModifiedDate:(double)arg3;	// IMP=0x0000000100090248
+ (id)sharedAppSwitcherIconCache;	// IMP=0x000000010008d140
- (void).cxx_destruct;	// IMP=0x00000001000905c0
...
- (void)_buildAndPruneCache;	// IMP=0x000000010008f948
- (void)_workQueue_removeApplicationIconsForCacheEntry:(id)arg1;	// IMP=0x000000010008f670
- (void)_workQueue_removeApplicationIconsForAppInfo:(id)arg1;	// IMP=0x000000010008f3d4
- (void)_workQueue_createApplicationIcon:(id)arg1 preferExisting:(_Bool)arg2;	// IMP=0x000000010008e8fc
- (void)appInfoController:(id)arg1 didUpdate:(id)arg2;	// IMP=0x000000010008e018
- (id)iconImageForAppWithBundleIdentifier:(id)arg1 scale:(double)arg2;	// IMP=0x000000010008db0c
- (id)initWithName:(id)arg1 iconSize:(struct CGSize)arg2;	// IMP=0x000000010008d2ac
