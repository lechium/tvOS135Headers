...
- (void).cxx_destruct;	// IMP=0x000000010010ceb0
@property(readonly, nonatomic) PBSystemServiceConnection *remoteConnection; // @synthesize remoteConnection=_remoteConnection;
- (void)installAppWithMetadata:(id)arg1;	// IMP=0x000000010010babc
- (id)initWithRemoteConnection:(id)arg1;	// IMP=0x000000010010b988
- (id)init;	// IMP=0x000000010010b954
