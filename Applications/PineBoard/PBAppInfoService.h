...
- (void).cxx_destruct;	// IMP=0x0000000100066354
...
- (void)appInfoUpdatesWithReply:(CDUnknownBlockType)arg1;	// IMP=0x000000010006567c
- (void)setServiceDelegate:(id)arg1;	// IMP=0x00000001000655e8
- (void)appInfoController:(id)arg1 didUpdate:(id)arg2;	// IMP=0x0000000100064f14
- (void)invalidate;	// IMP=0x0000000100064f00
- (id)initWithInfoStore:(id)arg1 remoteConnection:(id)arg2;	// IMP=0x0000000100064964
- (id)init;	// IMP=0x0000000100064920
