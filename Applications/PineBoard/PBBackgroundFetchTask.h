...
+ (id)makeUIFetchContentInBackgroundActionFromBundleID:(id)arg1;	// IMP=0x00000001000d714c
- (void).cxx_destruct;	// IMP=0x00000001000d81b4
...
- (void)finishWithResult:(unsigned long long)arg1;	// IMP=0x00000001000d7dd8
- (id)initForApplication:(id)arg1 sequenceNumber:(unsigned int)arg2;	// IMP=0x00000001000d773c
