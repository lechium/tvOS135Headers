...
- (void).cxx_destruct;	// IMP=0x000000010015f4bc
...
- (long long)_typeForCurrentTemplateKey;	// IMP=0x000000010015e880
- (id)_safeLocalizedValue:(id)arg1 withBundle:(id)arg2;	// IMP=0x000000010015e3e0
- (_Bool)isAlive;	// IMP=0x000000010015e174
- (void)cancel;	// IMP=0x000000010015e138
- (void)didSelectButtonAtIndex:(long long)arg1;	// IMP=0x000000010015d9fc
- (_Bool)isLastTextField:(long long)arg1;	// IMP=0x000000010015d978
- (long long)keyboardTypeForTextField:(long long)arg1;	// IMP=0x000000010015d854
- (_Bool)isSecureTextField:(long long)arg1;	// IMP=0x000000010015d7e0
@property(readonly, nonatomic) long long notificationType;
- (void)updateWithMessage:(id)arg1 requestFlags:(int)arg2;	// IMP=0x000000010015b7c4
- (id)initWithMessage:(id)arg1 replyPort:(unsigned int)arg2 requestFlags:(int)arg3;	// IMP=0x000000010015b6b4
