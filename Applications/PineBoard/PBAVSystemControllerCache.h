...
+ (id)sharedInstance;	// IMP=0x000000010012ecf8
+ (id)new;	// IMP=0x000000010012e93c
...
- (void)_callUpdateHandlerForNotificationName:(id)arg1 notification:(id)arg2;	// IMP=0x000000010013028c
- (void)_updateAirplayDisplayActiveFromNotification:(id)arg1;	// IMP=0x000000010012fe1c
- (void)_rebuildCache;	// IMP=0x000000010012fb60
- (void)_initializeCache;	// IMP=0x000000010012f614
- (void)_handleSystemControllerMetadataDidChangeNotification:(id)arg1;	// IMP=0x000000010012f23c
- (void)_handleSystemControllerServerConnectionDied:(id)arg1;	// IMP=0x000000010012ef80
...
- (void)dealloc;	// IMP=0x000000010012ec58
- (id)initWithDataProviderInitializer:(CDUnknownBlockType)arg1;	// IMP=0x000000010012e9d4
- (id)init;	// IMP=0x000000010012e97c
