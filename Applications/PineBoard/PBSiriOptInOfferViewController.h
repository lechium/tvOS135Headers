...
- (void).cxx_destruct;	// IMP=0x0000000100141a90
...
- (void)_readAboutText:(id)arg1;	// IMP=0x000000010014141c
- (void)_didNotCompleteOptIn;	// IMP=0x00000001001413bc
- (void)_optOut:(id)arg1;	// IMP=0x0000000100141328
- (void)_optIn:(id)arg1;	// IMP=0x0000000100141294
- (void)_handleHomeButton:(id)arg1;	// IMP=0x0000000100141160
- (void)_handleMenuButton:(id)arg1;	// IMP=0x0000000100140fec
- (id)preferredFocusEnvironments;	// IMP=0x0000000100140f34
- (void)viewDidLoad;	// IMP=0x00000001001404a0
- (id)initWithOfferDictationOnly:(_Bool)arg1;	// IMP=0x00000001001403cc
