...
- (void).cxx_destruct;	// IMP=0x000000010020578c
...
- (void)_begin;	// IMP=0x00000001002052a0
- (_Bool)_canBeInterrupted;	// IMP=0x0000000100205284
- (id)initWithRequest:(id)arg1 viewController:(id)arg2 layoutLevel:(long long)arg3 deactivationReasons:(unsigned long long)arg4 presentationDelegate:(id)arg5;	// IMP=0x000000010020507c
- (id)init;	// IMP=0x0000000100205038
