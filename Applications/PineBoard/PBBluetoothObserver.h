...
- (void).cxx_destruct;	// IMP=0x0000000100068b50
...
- (void)_reloadStatistics;	// IMP=0x0000000100068004
- (void)_signalReloadStatisticsSource;	// IMP=0x0000000100067fb0
- (void)_handleBluetoothManagerNotificationHandler:(id)arg1;	// IMP=0x0000000100067f4c
- (void)pairingAgent:(id)arg1 peerDidUnpair:(id)arg2;	// IMP=0x0000000100067eb4
- (void)pairingAgent:(id)arg1 peerDidFailToCompletePairing:(id)arg2 error:(id)arg3;	// IMP=0x0000000100067de8
- (void)pairingAgent:(id)arg1 peerDidCompletePairing:(id)arg2;	// IMP=0x0000000100067d50
@property(readonly, nonatomic) PBBluetoothDeviceStatistics *pairedDeviceStatistics;
- (void)dealloc;	// IMP=0x00000001000679e0
- (id)init;	// IMP=0x000000010006737c
