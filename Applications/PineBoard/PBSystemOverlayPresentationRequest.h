...
- (void).cxx_destruct;	// IMP=0x00000001000cef00
- (_Bool)_insertAtFrontOfQueue;	// IMP=0x00000001000ceee0
...
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001000cedf8
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001000cedd8
- (id)initWithRequest:(id)arg1;	// IMP=0x00000001000cebc0
