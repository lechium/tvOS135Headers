...
- (void).cxx_destruct;	// IMP=0x00000001001c24b4
...
- (void)_handleHomeButton:(id)arg1;	// IMP=0x00000001001c2200
- (void)_handleMenuButton;	// IMP=0x00000001001c20cc
- (void)viewDidLoad;	// IMP=0x00000001001c11e4
- (id)initWithTitle:(id)arg1 text:(id)arg2;	// IMP=0x00000001001c10bc
