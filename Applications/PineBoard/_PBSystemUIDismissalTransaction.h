...
- (void).cxx_destruct;	// IMP=0x00000001000692f8
...
- (_Bool)_canBeInterrupted;	// IMP=0x0000000100069218
- (void)_begin;	// IMP=0x0000000100068e24
- (id)initWithViewController:(id)arg1 parentViewController:(id)arg2 animated:(_Bool)arg3 transitionBlock:(CDUnknownBlockType)arg4;	// IMP=0x0000000100068c40
