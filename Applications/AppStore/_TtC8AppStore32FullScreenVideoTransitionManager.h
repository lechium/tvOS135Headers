...
- (void).cxx_destruct;	// IMP=0x00000001000a6714
- (id)init;	// IMP=0x00000001000a678c
- (void)animateTransition:(id)arg1;	// IMP=0x00000001000a5c40
- (double)transitionDuration:(id)arg1;	// IMP=0x00000001000a5b1c
- (id)animationControllerForDismissedController:(id)arg1;	// IMP=0x00000001000a5b0c
- (id)animationControllerForPresentedController:(id)arg1 presentingController:(id)arg2 sourceController:(id)arg3;	// IMP=0x00000001000a5a70
