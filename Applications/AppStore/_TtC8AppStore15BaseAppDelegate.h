...
- (void).cxx_destruct;	// IMP=0x00000001000fd95c
- (id)init;	// IMP=0x00000001000fd90c
- (void)performDebugGesture:(id)arg1;	// IMP=0x00000001000fd0e4
- (_Bool)application:(id)arg1 openURL:(id)arg2 options:(id)arg3;	// IMP=0x00000001000fcfa0
- (void)applicationDidEnterBackground:(id)arg1;	// IMP=0x00000001000fce80
- (void)applicationWillEnterForeground:(id)arg1;	// IMP=0x00000001000fce34
- (void)applicationDidBecomeActive:(id)arg1;	// IMP=0x00000001000fcde8
- (_Bool)application:(id)arg1 didFinishLaunchingWithOptions:(id)arg2;	// IMP=0x00000001000fcc44
