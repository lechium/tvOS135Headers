...
- (id)preferredFocusEnvironments;	// IMP=0x00000001000057bc
- (void)viewDidLoad;	// IMP=0x0000000100004a74
- (id)initWithMap:(id)arg1 allProfiles:(id)arg2 allUsers:(id)arg3 appName:(id)arg4;	// IMP=0x0000000100004774
