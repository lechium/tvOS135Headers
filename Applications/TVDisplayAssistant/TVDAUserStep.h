...
- (void).cxx_destruct;	// IMP=0x0000000100004ab0
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100004668
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010000444c
- (void)addAction:(id)arg1;	// IMP=0x00000001000043e4
@property(readonly, copy, nonatomic) NSArray *actions;
- (id)initWithTitle:(id)arg1 subtitle:(id)arg2 footer:(id)arg3 appleSupportFooter:(id)arg4;	// IMP=0x00000001000042a8
