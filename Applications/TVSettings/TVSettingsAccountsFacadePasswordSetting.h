...
- (void).cxx_destruct;	// IMP=0x0000000100081284
...
- (void)_setPaidSettingValue:(unsigned long long)arg1 freeSettingValue:(unsigned long long)arg2;	// IMP=0x0000000100080fc8
- (void)_syncPasswordPaidSetting:(unsigned long long)arg1 freeSetting:(unsigned long long)arg2 originalPaidSetting:(unsigned long long)arg3 originalFreeSetting:(unsigned long long)arg4;	// IMP=0x0000000100080b94
- (void)_updatePaidSetting:(unsigned long long)arg1 freeSetting:(unsigned long long)arg2;	// IMP=0x0000000100080a08
- (void)_refreshAccount;	// IMP=0x0000000100080864
- (void)_accountStoreDidChange:(id)arg1;	// IMP=0x00000001000806e0
- (void)AMSURLSession:(id)arg1 task:(id)arg2 handleDialogRequest:(id)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x00000001000804c8
- (void)AMSURLSession:(id)arg1 task:(id)arg2 handleAuthenticateRequest:(id)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x0000000100080270
- (void)setAsnFreeSetting:(id)arg1 presentingViewController:(id)arg2;	// IMP=0x0000000100080218
- (void)setAsnPaidSetting:(id)arg1 presentingViewController:(id)arg2;	// IMP=0x00000001000801c0
- (void)setAsnFreeSetting:(id)arg1;	// IMP=0x0000000100080178
- (void)setAsnPaidSetting:(id)arg1;	// IMP=0x0000000100080130
- (void)dealloc;	// IMP=0x00000001000800a8
- (id)initWithAccount:(id)arg1 amsBag:(id)arg2;	// IMP=0x000000010007ff78
