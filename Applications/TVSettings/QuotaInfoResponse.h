...
- (void).cxx_destruct;	// IMP=0x00000001000cb4a8
@property(readonly, nonatomic) NSDictionary *accountStatus; // @synthesize accountStatus=_accountStatus;
- (_Bool)hasPurchasedMoreStorage;	// IMP=0x00000001000cb434
- (id)storageFooter:(_Bool)arg1;	// IMP=0x00000001000cb42c
...
- (id)initWithHTTPResponse:(id)arg1 data:(id)arg2;	// IMP=0x00000001000cad04
