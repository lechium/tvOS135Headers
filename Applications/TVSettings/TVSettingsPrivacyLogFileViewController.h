...
- (void).cxx_destruct;	// IMP=0x00000001000b6f38
...
- (void)_deleteItem:(id)arg1;	// IMP=0x00000001000b6a90
- (void)_airDropItem:(id)arg1;	// IMP=0x00000001000b6794
- (void)_viewItem:(id)arg1;	// IMP=0x00000001000b6590
- (id)loadSettingGroups;	// IMP=0x00000001000b5fc4
