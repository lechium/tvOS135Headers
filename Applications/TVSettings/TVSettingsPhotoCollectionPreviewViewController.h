...
- (void).cxx_destruct;	// IMP=0x00000001000aa978
@property(retain, nonatomic) TVPhotoCollection *photoCollection; // @synthesize photoCollection=_photoCollection;
- (void)_updateViewWithImageProxies:(id)arg1 inCollection:(id)arg2;	// IMP=0x00000001000aa8cc
- (void)viewDidLayoutSubviews;	// IMP=0x00000001000aa370
- (void)loadView;	// IMP=0x00000001000aa2b4
