...
- (void).cxx_destruct;	// IMP=0x00000001000874e8
...
- (void)_fetchAppUsageInfo;	// IMP=0x00000001000870f0
- (void)uninstallAppWithProxy:(id)arg1;	// IMP=0x0000000100086f1c
- (void)dealloc;	// IMP=0x0000000100086e48
- (id)init;	// IMP=0x0000000100086d00
