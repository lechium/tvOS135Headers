...
+ (id)_imageForInfo:(id)arg1;	// IMP=0x0000000100077128
+ (id)_allowedAccessTypesForInfo:(id)arg1;	// IMP=0x0000000100076fdc
+ (unsigned long long)_accessTypeForInfo:(id)arg1;	// IMP=0x0000000100076f9c
+ (unsigned long long)_itemTypeForInfo:(id)arg1;	// IMP=0x0000000100076f54
+ (id)_explanatoryTextForInfo:(id)arg1;	// IMP=0x0000000100076df0
+ (id)_titleForIdentifier:(id)arg1 info:(id)arg2;	// IMP=0x0000000100076b64
- (void).cxx_destruct;	// IMP=0x00000001000771ac
...
- (id)initWithInfo:(id)arg1 identifier:(id)arg2;	// IMP=0x00000001000766cc
- (id)init;	// IMP=0x00000001000766b8
