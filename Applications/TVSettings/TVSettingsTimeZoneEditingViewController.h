...
- (void).cxx_destruct;	// IMP=0x00000001000b9a98
...
- (id)_gradientMask;	// IMP=0x00000001000b9674
- (void)timeZoneTableViewController:(id)arg1 didSelectCityWithIdentifier:(id)arg2;	// IMP=0x00000001000b9600
- (void)updateSearchResultsForSearchController:(id)arg1;	// IMP=0x00000001000b9580
- (void)didDismissSearchController:(id)arg1;	// IMP=0x00000001000b9518
- (void)willDismissSearchController:(id)arg1;	// IMP=0x00000001000b9504
- (void)viewDidLayoutSubviews;	// IMP=0x00000001000b9464
- (void)viewDidLoad;	// IMP=0x00000001000b90b4
