...
- (void).cxx_destruct;	// IMP=0x000000010009765c
...
- (id)_imageForAction:(int)arg1;	// IMP=0x0000000100097280
- (void)_learnNextAction:(id)arg1;	// IMP=0x00000001000971e0
- (void)_learnPreviousAction:(id)arg1;	// IMP=0x0000000100097140
- (void)_updateProgressViewWithProgress:(double)arg1 animated:(_Bool)arg2;	// IMP=0x00000001000970a8
- (void)_hideProgressView;	// IMP=0x0000000100097020
- (void)irLearningManager:(id)arg1 didFinishLearningAction:(int)arg2;	// IMP=0x0000000100096ba0
- (void)irLearningManager:(id)arg1 didCompleteLearningAction:(int)arg2 withResult:(_Bool)arg3 error:(id)arg4;	// IMP=0x00000001000965ec
- (void)irLearningManager:(id)arg1 didLearnAction:(int)arg2 withProgress:(double)arg3;	// IMP=0x0000000100096498
- (void)irLearningManager:(id)arg1 willStartLearningAction:(int)arg2;	// IMP=0x0000000100096128
- (void)irLearningManagerDidCancel:(id)arg1;	// IMP=0x0000000100096124
- (void)irLearningManager:(id)arg1 didSaveLearnedActions:(id)arg2 forDeviceWithUUID:(id)arg3;	// IMP=0x0000000100095e48
- (void)irLearningManager:(id)arg1 didFailToStartLearningWithError:(id)arg2;	// IMP=0x0000000100095c34
- (id)preferredFocusEnvironments;	// IMP=0x0000000100095ba4
- (void)viewDidDisappear:(_Bool)arg1;	// IMP=0x0000000100095a28
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x0000000100095830
- (void)viewDidLoad;	// IMP=0x00000001000943f4
- (id)initWithNibName:(id)arg1 bundle:(id)arg2;	// IMP=0x0000000100094310
