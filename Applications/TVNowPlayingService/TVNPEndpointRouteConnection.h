...
+ (id)keyPathsForValuesAffectingPaired;	// IMP=0x000000010001e7f8
- (void).cxx_destruct;	// IMP=0x00000001000210a8
...
- (id)_preloadArtwork;	// IMP=0x0000000100020e98
- (id)_placeholderArtwork;	// IMP=0x0000000100020dc4
- (void)_updateState;	// IMP=0x0000000100020c30
- (void)_updateAutomaticResponseLoading;	// IMP=0x0000000100020b70
- (void)_connectPairingIfNeeded:(_Bool)arg1;	// IMP=0x000000010002071c
- (void)_connectionDidInvalidate:(id)arg1;	// IMP=0x000000010002061c
- (void)_updateMetadata;	// IMP=0x000000010001f4c4
- (void)_createRequestController;	// IMP=0x000000010001f054
- (void)_reloadPlayerPathWithRoute:(id)arg1;	// IMP=0x000000010001ee18
- (void)controller:(id)arg1 defersResponseReplacement:(CDUnknownBlockType)arg2;	// IMP=0x000000010001ed08
- (void)sendCommand:(unsigned int)arg1 options:(id)arg2;	// IMP=0x000000010001e990
- (void)playPause;	// IMP=0x000000010001e97c
- (void)deregisterMetadataUpdateHandler:(id)arg1;	// IMP=0x000000010001e920
- (id)registerMetadataUpdateHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000010001e884
@property(retain, nonatomic) MPAVEndpointRoute *route;
- (id)response;	// IMP=0x000000010001e7a4
- (id)playerPath;	// IMP=0x000000010001e6f8
@property(readonly, copy, nonatomic) NSString *bundleID;
@property(readonly, nonatomic, getter=isPaired) _Bool paired;
- (void)connectAndPair;	// IMP=0x000000010001e5b8
@property(readonly, copy) NSString *description;
- (id)initWithRoute:(id)arg1;	// IMP=0x000000010001e34c
