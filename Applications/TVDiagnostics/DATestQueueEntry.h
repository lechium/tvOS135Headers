...
+ (id)queueEntryWithAttributes:(id)arg1 parameters:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x0000000100010264
- (void).cxx_destruct;	// IMP=0x00000001000105b8
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100010524
- (_Bool)isEqualToTestQueueEntry:(id)arg1;	// IMP=0x000000010001043c
- (unsigned long long)hash;	// IMP=0x00000001000103c8
- (id)initWithAttributes:(id)arg1 parameters:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x00000001000102f4
