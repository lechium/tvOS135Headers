...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000010000ec90
- (void).cxx_destruct;	// IMP=0x0000000100010150
...
- (void)resetState;	// IMP=0x0000000100010028
- (void)_sendChangeNotification;	// IMP=0x000000010000fe6c
- (void)_sendChangeNotificationIfNeeded;	// IMP=0x000000010000fe54
- (id)_stringForPhase:(long long)arg1;	// IMP=0x000000010000fde4
- (id)description;	// IMP=0x000000010000fbe8
- (void)removeErrorCodes:(id)arg1;	// IMP=0x000000010000f950
- (void)removeErrorCode:(long long)arg1;	// IMP=0x000000010000f8c4
- (void)addErrorCode:(long long)arg1 userInfo:(id)arg2;	// IMP=0x000000010000f7a8
- (void)updateWithDeviceState:(id)arg1;	// IMP=0x000000010000f554
- (void)transactionWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x000000010000f4d4
- (_Bool)object:(id)arg1 isEqualToObject:(id)arg2;	// IMP=0x000000010000f478
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010000ec98
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000010000e9e8
- (id)initWithCoder:(id)arg1;	// IMP=0x000000010000e57c
- (id)initWithSerialNumber:(id)arg1 attributes:(id)arg2;	// IMP=0x000000010000e4ec
- (id)init;	// IMP=0x000000010000e3b8
