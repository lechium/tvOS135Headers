...
@class MPAVRoute, MPCPlayerResponse, MPCPlayerResponseItem, MPModelGenericObject, MPRequestResponseController, NSArray, NSObject, NSString, TVMusicAirplayDetector;
...
+ (id)_stringForMPCPlayerState:(long long)arg1;	// IMP=0x0000000100039e28
+ (_Bool)_isNewTracklist:(id)arg1 equalToOldTracklist:(id)arg2;	// IMP=0x00000001000399cc
- (void).cxx_destruct;	// IMP=0x000000010003ab18
...
- (void)_libraryWasUpdated:(id)arg1;	// IMP=0x000000010003a744
- (void)_activeSystemRouteDidChange:(id)arg1;	// IMP=0x000000010003a678
- (void)_repeatModeSettingDidChange:(id)arg1;	// IMP=0x000000010003a4a8
- (void)_applicationDidBecomeActive:(id)arg1;	// IMP=0x000000010003a3dc
- (id)convertPreviousIndexPathToIndexPathForUpdatedPlaylist:(id)arg1;	// IMP=0x0000000100039ecc
- (_Bool)_isUserSubscribed;	// IMP=0x0000000100039978
- (void)_updatePlayQueue;	// IMP=0x0000000100037e54
- (long long)_repeatModeFromRepeatType:(long long)arg1;	// IMP=0x0000000100037e3c
- (long long)_tracklistRepeatMode;	// IMP=0x0000000100037dd8
- (id)_mediaItemForMPCPlayerResponseItem:(id)arg1 section:(id)arg2 atIndexPath:(id)arg3;	// IMP=0x0000000100037854
- (void)_updateMediaItemsWithTrackList:(id)arg1;	// IMP=0x00000001000375d0
- (void)_performPlayerCommandRequest:(id)arg1 name:(id)arg2;	// IMP=0x0000000100037328
- (void)_performPlayerCommand:(long long)arg1 name:(id)arg2;	// IMP=0x0000000100037174
- (id)_createGlobalPlayerPathWithRoute:(id)arg1;	// IMP=0x0000000100037010
- (void)_updatePlayerPathWithRoute:(id)arg1;	// IMP=0x0000000100036e38
- (void)airplayDetectorAirplayEnded:(id)arg1;	// IMP=0x0000000100036b18
- (void)airplayDetectorAirplayStarted:(id)arg1;	// IMP=0x00000001000367f8
- (_Bool)controller:(id)arg1 shouldRetryFailedRequestWithError:(id)arg2;	// IMP=0x00000001000363f4
- (void)controller:(id)arg1 defersResponseReplacement:(CDUnknownBlockType)arg2;	// IMP=0x0000000100036248
- (id)sectionForItemWithIdentifiers:(id)arg1;	// IMP=0x0000000100035f18
- (id)metadataObjectMatchingIdentifierSet:(id)arg1;	// IMP=0x0000000100035bdc
@property(readonly, nonatomic) _Bool isMusicAppQueue;
@property(readonly, nonatomic) _Bool isLocalDeviceQueue;
- (void)addToPlayQueueWithPlaybackIntent:(id)arg1 playNext:(_Bool)arg2;	// IMP=0x0000000100035670
- (_Bool)canAddToPlayQueueAtEndWithPlaybackIntent:(id)arg1;	// IMP=0x0000000100035598
- (_Bool)canAddToPlayQueueNextWithPlaybackIntent:(id)arg1;	// IMP=0x00000001000354c0
- (void)clearPlayQueueWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000010003510c
- (void)replacePlayQueueWithPlaybackIntent:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000100034bc0
- (long long)repeatMode;	// IMP=0x0000000100034bb0
- (void)_setRepeatMode:(long long)arg1;	// IMP=0x0000000100034aa4
- (void)_setRepeatType:(long long)arg1;	// IMP=0x00000001000347ec
- (void)setRepeatMode:(long long)arg1;	// IMP=0x00000001000346b8
- (_Bool)shuffleEnabled;	// IMP=0x00000001000346a8
- (void)_setShuffleEnabled:(_Bool)arg1;	// IMP=0x00000001000345a0
- (void)setShuffleEnabled:(_Bool)arg1 preserveCurrentItem:(_Bool)arg2;	// IMP=0x0000000100034328
...
- (void)setElapsedTime:(double)arg1;	// IMP=0x0000000100033fb8
- (void)changeToItemAtIndex:(long long)arg1;	// IMP=0x0000000100033bfc
- (void)changeToPreviousItem;	// IMP=0x0000000100033b60
- (void)changeToNextItem;	// IMP=0x0000000100033ac4
- (void)rewind;	// IMP=0x0000000100033a1c
- (void)fastForward;	// IMP=0x0000000100033974
- (void)stop;	// IMP=0x000000010003395c
- (void)pause;	// IMP=0x0000000100033944
- (void)play;	// IMP=0x0000000100033840
- (id)responseTrackList;	// IMP=0x00000001000337ec
@property(readonly, nonatomic) long long playerState;
@property(readonly, nonatomic) MPCPlayerResponseItem *currentPlayingItem;
- (void)stopUpdating;	// IMP=0x00000001000335fc
- (void)startUpdating;	// IMP=0x0000000100033584
- (void)updatePlayerPath;	// IMP=0x0000000100033468
- (void)moveItemAtIndexToPlayNext:(long long)arg1;	// IMP=0x000000010003312c
- (_Bool)canMoveItemAtIndexToPlayNext:(long long)arg1;	// IMP=0x0000000100032fbc
@property(retain, nonatomic) MPAVRoute *audioRoute;
@property(readonly, nonatomic) NSString *audioRouteName;
- (_Bool)isMediaItem:(id)arg1 matchingResponseItem:(id)arg2;	// IMP=0x0000000100032d70
- (id)currentMediaItem;	// IMP=0x0000000100032c64
- (unsigned long long)activeListIndex;	// IMP=0x0000000100032bc8
- (unsigned long long)count;	// IMP=0x0000000100032b7c
- (id)trackList;	// IMP=0x0000000100032b70
- (id)activeList;	// IMP=0x0000000100032b64
- (void)dealloc;	// IMP=0x0000000100032aec
- (id)initWithMediaItems:(id)arg1 index:(long long)arg2 isCollection:(_Bool)arg3;	// IMP=0x0000000100031dfc
