...
- (void).cxx_destruct;	// IMP=0x0000000100074ea8
...
- (void)controller:(id)arg1 defersResponseReplacement:(CDUnknownBlockType)arg2;	// IMP=0x0000000100074954
- (void)_playerPathChanged:(id)arg1;	// IMP=0x00000001000747cc
- (long long)playbackStateforItemWithIdentifiers:(id)arg1 inContainer:(id)arg2;	// IMP=0x0000000100074624
- (long long)playbackStateforItemWithIdentifiers:(id)arg1;	// IMP=0x0000000100074430
- (void)dealloc;	// IMP=0x0000000100074394
- (id)init;	// IMP=0x0000000100073e24
