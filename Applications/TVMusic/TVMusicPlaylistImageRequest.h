...
- (void).cxx_destruct;	// IMP=0x0000000100044e08
...
- (void)loadImagesWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000100044610
- (id)identifier;	// IMP=0x00000001000440d4
- (id)initWithImageProxies:(id)arg1 playlistStyle:(id)arg2;	// IMP=0x0000000100044014
