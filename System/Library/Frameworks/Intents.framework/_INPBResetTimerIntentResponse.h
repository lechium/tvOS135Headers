...
#import <libobjc.A.dylib/_INPBResetTimerIntentResponse.h>
@class NSArray;
...
@property (nonatomic,copy) NSArray * resetTimers;                                                        //@synthesize resetTimers=_resetTimers - In the implementation block
@property (nonatomic,readonly) unsigned long long resetTimersCount; 
