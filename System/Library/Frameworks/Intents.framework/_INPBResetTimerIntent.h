...
#import <libobjc.A.dylib/_INPBResetTimerIntent.h>
...
@property (assign,nonatomic) BOOL resetMultiple; 
@property (assign,nonatomic) BOOL hasResetMultiple; 
...
@property (nonatomic,readonly) BOOL hasIntentMetadata; 
@property (assign,nonatomic) BOOL resetMultiple;                                                         //@synthesize resetMultiple=_resetMultiple - In the implementation block
@property (assign,nonatomic) BOOL hasResetMultiple; 
