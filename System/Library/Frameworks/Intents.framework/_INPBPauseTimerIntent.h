...
#import <libobjc.A.dylib/_INPBPauseTimerIntent.h>
...
@property (assign,nonatomic) BOOL pauseMultiple; 
@property (assign,nonatomic) BOOL hasPauseMultiple; 
...
@property (nonatomic,readonly) BOOL hasIntentMetadata; 
@property (assign,nonatomic) BOOL pauseMultiple;                                                         //@synthesize pauseMultiple=_pauseMultiple - In the implementation block
@property (assign,nonatomic) BOOL hasPauseMultiple; 
