...
#import <libobjc.A.dylib/_INPBSnoozeTasksIntentResponse.h>
@class NSArray;
...
@property (nonatomic,copy) NSArray * snoozedTasks;                                                       //@synthesize snoozedTasks=_snoozedTasks - In the implementation block
@property (nonatomic,readonly) unsigned long long snoozedTasksCount; 
