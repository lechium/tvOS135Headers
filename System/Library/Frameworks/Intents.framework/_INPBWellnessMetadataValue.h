...
#import <libobjc.A.dylib/_INPBWellnessMetadataValue.h>
...
@class _INPBDouble, _INPBInteger, _INPBString, NSString;
...
@property (nonatomic,readonly) BOOL hasOrdinalValue; 
@property (nonatomic,retain) _INPBString * pbStringValue;                                                //@synthesize pbStringValue=_pbStringValue - In the implementation block
@property (nonatomic,readonly) BOOL hasPbStringValue; 
