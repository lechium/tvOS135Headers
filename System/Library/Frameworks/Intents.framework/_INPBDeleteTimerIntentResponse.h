...
#import <libobjc.A.dylib/_INPBDeleteTimerIntentResponse.h>
@class NSArray;
...
@property (nonatomic,copy) NSArray * deletedTimers;                                                      //@synthesize deletedTimers=_deletedTimers - In the implementation block
@property (nonatomic,readonly) unsigned long long deletedTimersCount; 
