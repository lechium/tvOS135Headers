...
#import <libobjc.A.dylib/_INPBAddMediaIntent.h>
@class _INPBIntentMetadata, _INPBMediaDestination, NSArray, _INPBMediaSearch;
...
@class _INPBIntentMetadata, _INPBMediaDestination, NSArray, _INPBMediaSearch, NSString;
...
@property (nonatomic,readonly) BOOL hasIntentMetadata; 
@property (nonatomic,retain) _INPBMediaDestination * mediaDestination;                                   //@synthesize mediaDestination=_mediaDestination - In the implementation block
@property (nonatomic,readonly) BOOL hasMediaDestination; 
