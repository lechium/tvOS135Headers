...
#import <libobjc.A.dylib/_INPBDeleteTasksIntentResponse.h>
@class NSArray;
...
@property (nonatomic,copy) NSArray * deletedTasks;                                                       //@synthesize deletedTasks=_deletedTasks - In the implementation block
@property (nonatomic,readonly) unsigned long long deletedTasksCount; 
