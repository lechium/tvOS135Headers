...
#import <libobjc.A.dylib/_INPBPlayMediaIntent.h>
@class NSArray, _INPBString, _INPBTimestamp, _INPBIntentMetadata, _INPBMediaItemValue, _INPBMediaSearch, NSString;
...
@property (assign,nonatomic) int parsecCategory; 
@property (assign,nonatomic) BOOL hasParsecCategory; 
...
@property (nonatomic,copy) NSArray * alternativeResults;                                                 //@synthesize alternativeResults=_alternativeResults - In the implementation block
@property (nonatomic,readonly) unsigned long long alternativeResultsCount; 
@property (nonatomic,copy) NSArray * audioSearchResults;                                                 //@synthesize audioSearchResults=_audioSearchResults - In the implementation block
@property (nonatomic,readonly) unsigned long long audioSearchResultsCount; 
...
@property (nonatomic,readonly) BOOL hasMusicArtistName; 
@property (assign,nonatomic) int parsecCategory;                                                         //@synthesize parsecCategory=_parsecCategory - In the implementation block
@property (assign,nonatomic) BOOL hasParsecCategory; 
