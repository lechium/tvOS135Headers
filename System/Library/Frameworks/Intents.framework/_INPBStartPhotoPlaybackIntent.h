...
#import <libobjc.A.dylib/_INPBStartPhotoPlaybackIntent.h>
@class _INPBString, _INPBContactList, _INPBDateTimeRange, _INPBIntentMetadata, _INPBStringList, _INPBLocation;
...
@class _INPBString, _INPBContactList, _INPBDateTimeRange, _INPBIntentMetadata, _INPBStringList, _INPBLocation, NSString;
