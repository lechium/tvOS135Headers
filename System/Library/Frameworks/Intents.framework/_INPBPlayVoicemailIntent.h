...
#import <libobjc.A.dylib/_INPBPlayVoicemailIntent.h>
...
@property (nonatomic,copy) NSString * callRecordIdentifier;                                              //@synthesize callRecordIdentifier=_callRecordIdentifier - In the implementation block
@property (nonatomic,readonly) BOOL hasCallRecordIdentifier; 
