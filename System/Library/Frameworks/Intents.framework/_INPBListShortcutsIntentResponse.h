...
#import <libobjc.A.dylib/_INPBListShortcutsIntentResponse.h>
@class NSArray;
...
@property (nonatomic,copy) NSArray * shortcuts;                                                          //@synthesize shortcuts=_shortcuts - In the implementation block
@property (nonatomic,readonly) unsigned long long shortcutsCount; 
