...
#import <libobjc.A.dylib/_INPBPaymentMethodValue.h>
@class _INPBImageValue, NSString, _INPBValueMetadata;
...
@property (nonatomic,readonly) BOOL hasIcon; 
@property (nonatomic,copy) NSString * identificationHint;                                                //@synthesize identificationHint=_identificationHint - In the implementation block
@property (nonatomic,readonly) BOOL hasIdentificationHint; 
