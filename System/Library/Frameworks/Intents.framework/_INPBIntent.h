...
#import <libobjc.A.dylib/_INPBIntent.h>
...
@property (assign,nonatomic) BOOL hasEncodingFormat; 
@property (nonatomic,copy) NSString * intentTypeName;                                                    //@synthesize intentTypeName=_intentTypeName - In the implementation block
@property (nonatomic,readonly) BOOL hasIntentTypeName; 
