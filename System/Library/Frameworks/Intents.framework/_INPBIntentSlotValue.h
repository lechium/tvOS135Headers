...
#import <libobjc.A.dylib/_INPBIntentSlotValue.h>
@class NSArray;
...
@interface _INPBIntentSlotValue : PBCodable <_INPBIntentSlotValue, NSSecureCoding, NSCopying> {
	...
	SCD_Struct_IN5* _payloadParsecCategories;
...
@property (nonatomic,readonly) unsigned long long payloadDateTimeValuesCount; 
@property (nonatomic,copy) NSArray * payloadDeviceDetails;                                                 //@synthesize payloadDeviceDetails=_payloadDeviceDetails - In the implementation block
@property (nonatomic,readonly) unsigned long long payloadDeviceDetailsCount; 
@property (nonatomic,readonly) int* payloadDeviceTypes; 
@property (nonatomic,readonly) unsigned long long payloadDeviceTypesCount; 
...
@property (nonatomic,readonly) unsigned long long payloadMediaDestinationsCount; 
@property (nonatomic,copy) NSArray * payloadMediaItemGroups;                                               //@synthesize payloadMediaItemGroups=_payloadMediaItemGroups - In the implementation block
@property (nonatomic,readonly) unsigned long long payloadMediaItemGroupsCount; 
