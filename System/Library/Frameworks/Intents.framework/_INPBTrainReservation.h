...
#import <libobjc.A.dylib/_INPBTrainReservation.h>
...
@class _INPBReservation, _INPBSeat, _INPBTrainTrip, NSString;
...
@property (nonatomic,readonly) BOOL hasReservedSeat; 
@property (nonatomic,retain) _INPBTrainTrip * trainTrip;                                                 //@synthesize trainTrip=_trainTrip - In the implementation block
@property (nonatomic,readonly) BOOL hasTrainTrip; 
