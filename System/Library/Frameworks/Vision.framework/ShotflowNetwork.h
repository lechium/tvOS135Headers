...
@interface ShotflowNetwork : NSObject {
	...
	SCD_Struct_VN16* _espressoNetwork;
	void* _espressoPlan;
...
+(id)processingDeviceDetectorWithEspressoNetwork:(SCD_Struct_VN16*)arg1 espressoPlan:(void*)arg2 threshold:(float)arg3 ;
-(void)dealloc;
...
-(id)initWithEspressoNetwork:(SCD_Struct_VN16*)arg1 espressoPlan:(void*)arg2 threshold:(float)arg3 ;
