...
@property (nonatomic,readonly) SCD_Struct_VN7 pose; 
...
+(BOOL)computeYawPitchRollFromPoseMatrix:(SCD_Struct_VN7)arg1 outputYaw:(float*)arg2 outputPitch:(float*)arg3 outputRoll:(float*)arg4 ;
