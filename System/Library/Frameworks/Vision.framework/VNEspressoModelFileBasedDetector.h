...
@property (nonatomic,readonly) SCD_Struct_VN16* espressoNetwork;                                //@synthesize espressoNetwork=_espressoNetwork - In the implementation block
...
-(void*)espressoPlan;
-(SCD_Struct_VN16*)espressoNetwork;
