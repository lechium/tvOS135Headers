...
@property (assign,nonatomic) SCD_Struct_SK21 matrixFloat3x3Value; 
@property (assign,nonatomic) SCD_Struct_SK4 matrixFloat4x4Value; 
...
+(id)uniformWithName:(id)arg1 matrixFloat3x3:(SCD_Struct_SK21)arg2 ;
+(id)uniformWithName:(id)arg1 matrixFloat4x4:(SCD_Struct_SK4)arg2 ;
...
-(SCD_Struct_SK21)matrixFloat3x3Value;
-(SCD_Struct_SK4)matrixFloat4x4Value;
...
-(void)setMatrixFloat3x3Value:(SCD_Struct_SK21)arg1 ;
-(void)setMatrixFloat4x4Value:(SCD_Struct_SK4)arg1 ;
...
-(id)initWithName:(id)arg1 matrixFloat3x3:(SCD_Struct_SK21)arg2 ;
-(id)initWithName:(id)arg1 matrixFloat4x4:(SCD_Struct_SK4)arg2 ;
