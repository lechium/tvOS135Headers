...
+(SCD_Struct_CM341)gyroCalibrationDatabaseGetBiasFit;
...
+(SCD_Struct_CM341)gyroCalibrationDatabaseGetBiasFitAndEstimate:(SCD_Struct_CM316*)arg1 atTemperature:(float)arg2 ;
+(BOOL)hasRunMiniCal;
-(id)init;
-(void)dealloc;
-(void)connect;
...
-(void)onGeomagneticModel:(const SCD_Struct_CM332*)arg1 ;
-(id)initPrivate;
...
-(void)startDeviceMotionLiteUpdatesForDeviceID:(id)arg1 usingConfiguration:(SCD_Struct_CM342)arg2 toQueue:(id)arg3 withFusedHandler:(/*^block*/id)arg4 ;
