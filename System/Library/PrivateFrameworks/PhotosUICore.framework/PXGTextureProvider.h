...
@interface PXGTextureProvider : NSObject <PXImageDataSpecRegistration> {
	...
	SCD_Struct_PX135 _lastImageDataSpec;
...
-(long long)registerImageDataSpec:(SCD_Struct_PX135)arg1 ;
...
-(SCD_Struct_PX135)imageDataSpecAtIndex:(long long)arg1 ;
-(long long)requestQueue_indexForImageDataSpec:(SCD_Struct_PX135)arg1 ;
