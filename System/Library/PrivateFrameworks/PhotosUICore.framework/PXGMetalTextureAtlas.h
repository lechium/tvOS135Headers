...
@interface PXGMetalTextureAtlas : PXGImageTexture <PXGMetalSpriteTexture> {
	...
	SCD_Struct_PX106* _syncQueue_pendingThumbnailRequestInfo;
...
-(void)getTextureInfos:({?=}*)arg1 forSpriteIndexes:(unsigned*)arg2 geometries:(const SCD_Struct_PX102*)arg3 spriteStyles:(const SCD_Struct_PX77*)arg4 spriteInfos:(const SCD_Struct_PX17*)arg5 screenScale:(double)arg6 count:(unsigned)arg7 ;
