...
@interface CLIPSShim : NSObject {
	...
	SCD_Struct_CL40* _consoleNameRegex;
	SCD_Struct_CL40* _dumpStringRegex;
...
@property (assign,nonatomic) SCD_Struct_CL41* consoleNameRegex;                    //@synthesize consoleNameRegex=_consoleNameRegex - In the implementation block
@property (assign,nonatomic) SCD_Struct_CL41* dumpStringRegex;                     //@synthesize dumpStringRegex=_dumpStringRegex - In the implementation block
...
-(SCD_Struct_CL41*)consoleNameRegex;
-(void)setConsoleNameRegex:(SCD_Struct_CL41*)arg1 ;
-(SCD_Struct_CL41*)dumpStringRegex;
-(void)setDumpStringRegex:(SCD_Struct_CL41*)arg1 ;
