...
@interface _UISwipeHandler : NSObject <UIGestureRecognizerDelegate, _UISwipeDismissalGestureRecognizerDelegate> {
	...
	SCD_Struct_UI113 _currentSwipeConfig;
...
@property (nonatomic,readonly) SCD_Struct_UI113 currentSwipeConfig; 
...
-(SCD_Struct_UI113)currentSwipeConfig;
-(void)resetSwipe;
...
-(SCD_Struct_UI112)_currentSwipeInfoWithTargetOffset:(double)arg1 animated:(BOOL)arg2 usingSpringWithStiffness:(double)arg3 ;
