...
@class NSArray, UIView, UITextInputAssistantItem, UIInputViewController, UITextInputMode, NSString, NSUserActivity, NSUndoManager;
...
-(NSArray *)px_keyCommandsFoundByIteratingUpTheResponderChain;
