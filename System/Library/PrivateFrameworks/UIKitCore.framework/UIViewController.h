...
@interface UIViewController : UIResponder <IMMetricsDataSource, GKContentRefresh, GKURLHandling, PXDiagnosticsEnvironment, PXAnonymousViewController, PXProgrammaticNavigationParticipant, MKInfoCardThemeListener, NSExtensionRequestHandling, _UIFallbackEnvironment, _UIViewServiceDeputy, UIWindowDelegate, _UITraitEnvironmentInternal, _UIContentContainerInternal, _UIFocusEnvironmentInternal, _UIStatusBarAnimationProviding, NSCoding, UIAppearanceContainer, UITraitEnvironment, UIContentContainer, UIFocusEnvironment> {
	...
	SCD_Struct_UI48 _presentationSizeClassPair;
...
@property (nonatomic,readonly) SCD_Struct_UI48 __sizeClassPair; 
...
@property (assign,setter=_setPresentationSizeClassPair:,getter=_presentationSizeClassPair,nonatomic) SCD_Struct_UI48 presentationSizeClassPair;                                                    //@synthesize presentationSizeClassPair=_presentationSizeClassPair - In the implementation block
...
-(SCD_Struct_UI49)_gkBubbleFlowAdoptionInfo;
-(void)setGkFocusBubbleType:(long long)arg1 ;
-(long long)gkFocusBubbleType;
-(SCD_Struct_UI49)_gkMakeBubbleFlowAdoptionInfo;
...
-(SCD_Struct_UI50)_hostAuditToken;
...
-(SCD_Struct_UI48)__sizeClassPair;
...
-(void)_setPresentationSizeClassPair:(SCD_Struct_UI48)arg1 ;
...
-(void)_setHostAuditToken:(SCD_Struct_UI50)arg1 ;
