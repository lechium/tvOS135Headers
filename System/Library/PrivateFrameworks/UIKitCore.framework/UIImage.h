...
+(id)px_roundedCornerMaskImage:(SCD_Struct_UI65)arg1 size:(CGSize)arg2 ;
...
-(SCD_Struct_UI69)_calculateStatisticsOfEdge:(BOOL)arg1 ;
...
-(SCD_Struct_UI69)_calculateStatistics;
-(SCD_Struct_UI69)_calculateEdgeStatistics;
...
-(void)draw9PartImageWithSliceRects:(SCD_Struct_UI71)arg1 inRect:(CGRect)arg2 fraction:(double)arg3 ;
-(void)draw9PartImageWithSliceRects:(SCD_Struct_UI71)arg1 inRect:(CGRect)arg2 operation:(int)arg3 fraction:(double)arg4 ;
-(void)compositeToPoint:(CGPoint)arg1 fromRect:(CGRect)arg2 operation:(int)arg3 fraction:(double)arg4 ;
-(void)draw3PartImageWithSliceRects:(SCD_Struct_UI70)arg1 inRect:(CGRect)arg2 fraction:(double)arg3 ;
-(void)draw3PartImageWithSliceRects:(SCD_Struct_UI70)arg1 inRect:(CGRect)arg2 operation:(int)arg3 fraction:(double)arg4 ;
...
-(void)draw9PartImageWithSliceRects:(SCD_Struct_UI71)arg1 inRect:(CGRect)arg2 ;
-(void)draw3PartImageWithSliceRects:(SCD_Struct_UI70)arg1 inRect:(CGRect)arg2 ;
