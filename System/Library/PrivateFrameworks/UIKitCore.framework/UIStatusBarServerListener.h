...
@interface UIStatusBarServerListener : NSObject {
	...
	SCD_Struct_UI106 _statusBarData;
	SCD_Struct_UI106 _composedStatusBarData;
	SCD_Struct_UI107 _overrides;
...
-(SCD_Struct_UI109*)_statusBarOverrideData;
-(void)_postStatusBarData:(SCD_Struct_UI106*)arg1 actions:(int)arg2 animated:(BOOL)arg3 ;
...
-(void)_postStatusBarOverrideData:(SCD_Struct_UI109*)arg1 ;
