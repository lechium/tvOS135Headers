...
@class UITraitCollection, _UIStackedImageContainerLayer, NSString, UIImageSymbolConfiguration, _UIStackedImageContainerView, UILayoutGuide, UIImage, NSArray, UIColor, UIView;
