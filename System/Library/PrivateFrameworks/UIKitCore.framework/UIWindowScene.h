...
@class UIScreen, UITraitCollection, _UIContextBinder, NSPointerArray, HBUILaunchAnimator, UIAlertControllerStackManager, _UICanvasDefinition, FBSScene, UIStatusBarManager, _UISystemAppearanceManager, UIInputResponderController, UIScreenshotService, NSString, _UIBannerManager, UIWindow, FBSDisplayConfigurationRequest, UISceneSizeRestrictions, NSArray;
