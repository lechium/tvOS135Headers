...
@property (assign,nonatomic) SCD_Struct_UI81 styling; 
...
+(id)tokenForKey:(id)arg1 style:(SCD_Struct_UI81)arg2 ;
...
+(id)tokenForKeyMask:(id)arg1 style:(SCD_Struct_UI81)arg2 displayInsets:(UIEdgeInsets)arg3 ;
