...
@interface UIStatusBar : UIStatusBar_Base <UIStatusBarServerClient> {
	...
	SCD_Struct_UI106 _currentRawData;
...
+(void)getData:(SCD_Struct_UI106*)arg1 forRequestedData:(const SCD_Struct_UI106*)arg2 withOverrides:(const SCD_Struct_UI109*)arg3 ;
