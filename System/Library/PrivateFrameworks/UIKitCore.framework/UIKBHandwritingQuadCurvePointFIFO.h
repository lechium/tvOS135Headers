...
@property (assign,nonatomic) SCD_Struct_UI85 lastPoint;                //@synthesize lastPoint=_lastPoint - In the implementation block
...
-(void)setLastPoint:(SCD_Struct_UI85)arg1 ;
-(SCD_Struct_UI85)lastPoint;
-(id)emissionHandler;
