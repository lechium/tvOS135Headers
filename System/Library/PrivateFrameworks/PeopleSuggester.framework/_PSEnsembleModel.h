...
@class _CDInteractionStore, _CDInteractionCache, NSUserDefaults, CNContactStore, NSArray, NSString, _PSRuleMiningModel, _PSKNNModel, _PSHeuristics, _PSInteractionAndContactMonitor, NSSet, NSDictionary;
