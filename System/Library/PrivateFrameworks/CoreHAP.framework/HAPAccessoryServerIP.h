...
@class HMFUnfairLock, NSString, NSData, NSDictionary, HAPAccessoryServerBrowserIP, NSArray, NSMutableArray, HAPAccessory, HAPAuthSession, HAPAccessoryProtocolInfo, NSMutableSet, HMFBlockOperation, NSOperationQueue, HAPAccessoryWiFiConfiguration, HAPWACAccessory, HMFTimer, HMFNetMonitor, HAPHTTPClient, HMFNetAddress;
