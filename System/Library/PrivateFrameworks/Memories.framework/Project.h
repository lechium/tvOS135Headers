...
-(void)nextKenBurnsStart:(SCD_Struct_Mi18*)arg1 end:(SCD_Struct_Mi18*)arg2 ;
-(CGRect)rectFromKenBurnsPosition:(SCD_Struct_Mi18)arg1 outputAspectRatio:(float)arg2 image:(id)arg3 ;
