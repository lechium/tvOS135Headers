...
-(id)instructionToShowClip:(id)arg1 withTrackID:(int)arg2 withTransform:(CGAffineTransform)arg3 timeRange:(SCD_Struct_VE7)arg4 requiresCARendering:(BOOL)arg5 isFreezeFrame:(BOOL)arg6 applyTitleEffect:(BOOL)arg7 ;
-(id)instructionToHideTrackID:(int)arg1 whileHidingTrackID:(int)arg2 timeRange:(SCD_Struct_VE7)arg3 requiresCARendering:(BOOL)arg4 ;
-(void)addVideoInstructionsForTransition:(id)arg1 forRange:(SCD_Struct_VE7)arg2 toInstructions:(id)arg3 previousTrackID:(int)arg4 previousClip:(id)arg5 previousClipRequiresCA:(BOOL)arg6 nextTrackID:(int)arg7 nextClip:(id)arg8 nextClipRequiresCA:(BOOL)arg9 cutawaysIntersection:(id)arg10 ;
-(BOOL)cutIsContiguous:(id)arg1 transition:(id)arg2 next:(id)arg3 ;
-(void)addTransitionSoundsForState:(id)arg1 ;
-(id)instructionToShowImageWithClip:(id)arg1 withTransform:(CGAffineTransform)arg2 timeRange:(SCD_Struct_VE7)arg3 requiresCARendering:(BOOL)arg4 applyTitleEffect:(BOOL)arg5 ;
...
-(SCD_Struct_VE7)sourceTimeRangeForClip:(id)arg1 endOfComposition:(SCD_Struct_TV3)arg2 projectStartTime:(SCD_Struct_TV3*)arg3 ;
-(BOOL)addVolumeRampToTrackGroup:(id)arg1 forClip:(id)arg2 shouldUseDucking:(BOOL)arg3 ;
-(SCD_Struct_VE7)sourceTimeRangeForAudioClip:(id)arg1 endOfComposition:(SCD_Struct_TV3)arg2 ;
...
-(float)percentBetweenRange:(SCD_Struct_VE7)arg1 forTime:(SCD_Struct_TV3)arg2 firstRange:(SCD_Struct_VE7*)arg3 secondRange:(SCD_Struct_VE7*)arg4 ;
...
-(SCD_Struct_VE7)compositionItemsForState:(id)arg1 compositionItem:(id*)arg2 backfillCompositionItem:(id*)arg3 ;
...
-(id)instructionToTransitionTracksForRange:(SCD_Struct_VE7)arg1 requiresCARendering:(BOOL)arg2 incomingClipIsNarrower:(BOOL)arg3 incomingClipRequiresBG:(BOOL)arg4 outgoingClipRequiresBG:(BOOL)arg5 incomingClipIsZoomed:(BOOL)arg6 outgoingClipIsZoomed:(BOOL)arg7 transitionClip:(id)arg8 applyTitleEffect:(BOOL)arg9 ;
...
-(SCD_Struct_VE7)timeRangeForClipIncludingTransitions:(id)arg1 ;
-(void)refreshCompositionInstructionsWithinRange:(SCD_Struct_VE7)arg1 ;
-(int)outputFrameRate;
...
-(void)checkIt:(id)arg1 timeRange:(SCD_Struct_VE7)arg2 ;
