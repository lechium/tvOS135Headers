...
@interface EditListCompositionState : NSObject <NSCopying> {
	...
	SCD_Struct_VE7 m_videoCompTimeRange;
	SCD_Struct_VE7 m_audioCompTimeRange;
...
@property (assign,nonatomic) SCD_Struct_VE7 videoCompTimeRange; 
@property (assign,nonatomic) SCD_Struct_VE7 audioCompTimeRange; 
...
-(SCD_Struct_VE7)videoCompTimeRange;
-(void)setVideoCompTimeRange:(SCD_Struct_VE7)arg1 ;
-(SCD_Struct_VE7)audioCompTimeRange;
-(void)setAudioCompTimeRange:(SCD_Struct_VE7)arg1 ;
