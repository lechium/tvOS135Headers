...
-(void)generatePreviewImageForEffectID:(id)arg1 currentTime:(SCD_Struct_TV3)arg2 effectRange:(SCD_Struct_VE7)arg3 rawImage:(id)arg4 previewSize:(CGSize)arg5 completion:(/*^block*/id)arg6 ;
...
-(void)generateAllFilterPreviewsAtTime:(SCD_Struct_TV3)arg1 effectRange:(SCD_Struct_VE7)arg2 rawImage:(id)arg3 previewSize:(CGSize)arg4 ;
