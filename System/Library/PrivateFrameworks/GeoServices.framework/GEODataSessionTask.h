...
@property (nonatomic,readonly) SCD_Struct_GE92 requestKind;                                   //@synthesize requestKind=_requestKind - In the implementation block
...
-(id<GEORequestCounterTicket>)requestCounterTicket;
-(id)initWithSession:(id)arg1 delegate:(id)arg2 delegateQueue:(id)arg3 requestKind:(SCD_Struct_GE92)arg4 requestCounterTicket:(id)arg5 ;
