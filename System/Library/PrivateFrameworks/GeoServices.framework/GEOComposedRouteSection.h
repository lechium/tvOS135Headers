...
@property (nonatomic,readonly) SCD_Struct_GE182* points;                                     //@synthesize points=_points - In the implementation block
@property (nonatomic,readonly) SCD_Struct_GE184 bounds;                                      //@synthesize bounds=_bounds - In the implementation block
...
-(id)description;
-(void)dealloc;
-(SCD_Struct_GE184)bounds;
-(int)transportType;
-(unsigned)pointCount;
-(SCD_Struct_GE182*)points;
-(BOOL)_MapsCarPlay_isEqual:(id)arg1 ;
-(unsigned)startPointIndex;
-(unsigned)endPointIndex;
-(id)initWithRoute:(id)arg1 startPoint:(unsigned)arg2 pointCount:(unsigned)arg3 bounds:(SCD_Struct_GE184)arg4 transportType:(int)arg5 finalStepIndex:(unsigned long long)arg6 startDistance:(double)arg7 lengthScaleFactor:(double)arg8 ;
