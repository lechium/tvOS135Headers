...
-(id)_sectionForRoute:(id)arg1 pointRange:(NSRange)arg2 stepIndex:(unsigned long long)arg3 bounds:(SCD_Struct_GE184)arg4 currentTransitLineColor:(id)arg5 startDistance:(double)arg6 ;
