...
@property (nonatomic,readonly) SCD_Struct_GE92 requestKind; 
...
-(id)initWithSession:(id)arg1 taskIdentifier:(unsigned long long)arg2 requestTypeCode:(unsigned)arg3 responseClass:(Class)arg4 delegate:(id)arg5 delegateQueue:(id)arg6 requestKind:(SCD_Struct_GE92)arg7 auditToken:(id)arg8 throttleToken:(id)arg9 ;
