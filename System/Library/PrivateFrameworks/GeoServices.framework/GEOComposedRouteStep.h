...
@property (nonatomic,readonly) SCD_Struct_GE183 startGeoCoordinate; 
@property (nonatomic,readonly) SCD_Struct_GE183 endGeoCoordinate; 
...
-(SCD_Struct_GE183)startGeoCoordinate;
-(SCD_Struct_GE183)endGeoCoordinate;
