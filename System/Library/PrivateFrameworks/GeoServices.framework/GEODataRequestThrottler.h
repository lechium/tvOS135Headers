...
-(void)reset;
-(void)_reset;
-(void)valueChangedForGEOConfigKey:(SCD_Struct_GE116*)arg1 ;
...
-(void)getInfoForRequest:(SCD_Struct_GE92)arg1 client:(id)arg2 timeUntilNextReset:(double*)arg3 availableRequestCount:(unsigned*)arg4 ;
@end
