...
@interface BWIrisStagingNode : BWNode {
	...
	SCD_Struct_BW93 _vitalityScoringSmartCameraPipelineVersion;
...
-(void)setVitalityScoringSmartCameraPipelineVersion:(SCD_Struct_BW93)arg1 ;
...
-(SCD_Struct_BW93)vitalityScoringSmartCameraPipelineVersion;
