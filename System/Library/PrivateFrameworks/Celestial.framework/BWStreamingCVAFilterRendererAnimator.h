...
@interface BWStreamingCVAFilterRendererAnimator : NSObject {
	...
	SCD_Struct_BW120 _currentFrame;
...
-(SCD_Struct_BW120*)simulateNextFrameWithEffectStatus:(int)arg1 portraitStability:(float)arg2 clientSuppliedSimulatedAperture:(float)arg3 ;
@end
