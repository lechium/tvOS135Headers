...
typedef struct {
	SCD_Struct_BW75 modelInfo;
	unsigned frameId;
	unsigned numFaces;
	SCD_Struct_BW77 faces[10];
	unsigned numObjects;
	SCD_Struct_BW78 objects[10];
	unsigned numSaliencyObjects;
	SCD_Struct_BW78 saliencyObjects[1];
	SCD_Struct_BW76 saliencyHeatMap;
} SCD_Struct_BW79;
...
typedef struct {
	SCD_Struct_BW88 netInputBufferDesc[3];
	SCD_Struct_BW88 netOutputBufferDescs[3][24];
