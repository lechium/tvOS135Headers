...
@interface FigCaptureMovieFileSinkPipelineConfiguration : NSObject {
	...
	SCD_Struct_BW93 _smartCameraPipelineVersion;
...
@property (assign,nonatomic) SCD_Struct_BW93 smartCameraPipelineVersion;                                                                  //@synthesize smartCameraPipelineVersion=_smartCameraPipelineVersion - In the implementation block
...
-(void)setSmartCameraPipelineVersion:(SCD_Struct_BW93)arg1 ;
...
-(SCD_Struct_BW93)smartCameraPipelineVersion;
