...
@interface FigCapturePreviewSinkPipelineConfiguration : NSObject {
	...
	SCD_Struct_BW93 _sceneClassifierPipelineVersion;
...
@property (assign,nonatomic) SCD_Struct_BW93 sceneClassifierPipelineVersion;                                                       //@synthesize sceneClassifierPipelineVersion=_sceneClassifierPipelineVersion - In the implementation block
...
-(void)setSceneClassifierPipelineVersion:(SCD_Struct_BW93)arg1 ;
...
-(SCD_Struct_BW93)sceneClassifierPipelineVersion;
