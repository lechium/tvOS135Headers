...
@property (nonatomic,readonly) SCD_Struct_BW59 clientAuditToken;                                                          //@synthesize clientAuditToken=_clientAuditToken - In the implementation block
...
-(id)_aeTables;
-(id)initWithFigCaptureStream:(OpaqueFigCaptureStreamRef)arg1 attributes:(id)arg2 sensorIDDictionary:(id)arg3 isSynchronizationMaster:(BOOL)arg4 synchronizedStreamsEnabled:(BOOL)arg5 cameraViewMatrix:(id)arg6 cameraPoseMatrix:(id)arg7 applicationID:(id)arg8 clientAuditToken:(SCD_Struct_BW59)arg9 baseZoomFactor:(float)arg10 error:(int*)arg11 ;
...
-(SCD_Struct_BW59)clientAuditToken;
