...
typedef struct VCMediaStreamTransportSetupInfo {
	...
	/*function pointer*/void* ;
	SCD_Struct_VC123 socketInfo;
	SCD_Struct_VC125 ipInfo;
	SCD_Struct_VC124) nwInfo;
	unsigned sourceRate;
...
typedef struct tagWRMMetricsInfo {
	...
	SCD_Struct_VC147 wrmMetricsReportingContext;
