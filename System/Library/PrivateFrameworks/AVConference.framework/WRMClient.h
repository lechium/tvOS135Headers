...
@interface WRMClient : NSObject {
	...
	int _mode;
	SCD_Struct_WR129 _metricsConfig;
...
-(void)reportMetricsFaceTimeCalling:(const SCD_Struct_VC109*)arg1 ;
-(void)sendStatusUpdateFaceTimeCalling:(const SCD_Struct_VC93*)arg1 ;
-(void)requestNotificationFaceTimeCalling;
-(void)startWRMClientWithMode:(int)arg1 metricsConfig:(SCD_Struct_WR129)arg2 ;
-(void)stopWRMClient;
...
-(void)reportMetricsWifiCalling:(const SCD_Struct_VC109*)arg1 ;
@end
