...
@interface VCAudioTransmitter : NSObject <VCAudioIOSink, VCConnectionChangedHandler> {
	...
	SCD_Struct_VC155 _currentChannelMetrics;
	SCD_Struct_VC157 _idsChannelDataFormat;
...
@property (assign,nonatomic) SCD_Struct_VC155 currentChannelMetrics;                          //@synthesize currentChannelMetrics=_currentChannelMetrics - In the implementation block
...
-(SCD_Struct_VC155)currentChannelMetrics;
...
-(void)setCurrentChannelMetrics:(SCD_Struct_VC155)arg1 ;
@end
