...
@class NSUndoManager, VSPreferences, VSPersistentStorage, NSOperationQueue, VSRemoteNotifier, NSArray, VSAppDescription, NSString, VSIdentityProviderRequestManager, VSDevice;
