...
-(id)newLibraryWithCIFilters:(id)arg1 imageFilterFunctionInfo:(const SCD_Struct_MT19*)arg2 error:(id*)arg3 ;
...
-(void)getDefaultSamplePositions:(SCD_Struct_MT20*)arg1 count:(unsigned long long)arg2 ;
...
-(id)newLibraryWithCIFiltersForComputePipeline:(id)arg1 imageFilterFunctionInfo:(const SCD_Struct_MT19*)arg2 error:(id*)arg3 ;
