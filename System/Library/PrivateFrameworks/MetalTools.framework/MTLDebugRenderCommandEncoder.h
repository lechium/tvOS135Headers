...
@interface MTLDebugRenderCommandEncoder : MTLToolsRenderCommandEncoder {
	...
	SCD_Struct_MT66 _vertexBuffers[36];
	SCD_Struct_MT66 _vertexTextures[31];
	SCD_Struct_MT66 _vertexSamplers[16];
	SCD_Struct_MT66 _fragmentBuffers[31];
	SCD_Struct_MT66 _fragmentTextures[31];
	SCD_Struct_MT66 _fragmentSamplers[16];
	SCD_Struct_MT92 _limits;
	...
	SCD_Struct_MT66 _tessellationFactorBufferArgument;
...
@property (nonatomic,readonly) SCD_Struct_MT91 scissorRect; 
...
@property (nonatomic,readonly) SCD_Struct_MT66 tessellationFactorBufferArgument;                       //@synthesize tessellationFactorBufferArgument=_tessellationFactorBufferArgument - In the implementation block
...
-(void)setScissorRect:(SCD_Struct_MT91)arg1 ;
-(float)lineWidth;
...
-(SCD_Struct_MT66)tessellationFactorBufferArgument;
