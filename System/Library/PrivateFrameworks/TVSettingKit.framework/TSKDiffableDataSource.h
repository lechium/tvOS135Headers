...
@interface TSKDiffableDataSource : UITableViewDiffableDataSource {
	...
	SCD_Struct_TS0 _dataSourceProxyRespondsTo;
	id<TSKDiffableDataSourceProxy> _dataSourceProxy;

}

@property (assign,nonatomic,__weak) id<TSKDiffableDataSourceProxy> dataSourceProxy;              //@synthesize dataSourceProxy=_dataSourceProxy - In the implementation block
...
-(id<TSKDiffableDataSourceProxy>)dataSourceProxy;
-(void)setDataSourceProxy:(id<TSKDiffableDataSourceProxy>)arg1 ;
@end
