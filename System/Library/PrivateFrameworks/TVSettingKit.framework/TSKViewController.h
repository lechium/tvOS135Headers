...
#import <libobjc.A.dylib/TSKDiffableDataSourceProxy.h>
#import <libobjc.A.dylib/TSKSettingGroupDelegate.h>
#import <libobjc.A.dylib/TSKSettingItemEditingControllerDelegate.h>

@protocol OS_dispatch_source;
@class NSArray, UIViewController, NSObject, TSKVibrantImageView, NSMutableDictionary, TSKSettingItem, TSKDiffableDataSource, NSString;
...
@property (nonatomic,retain) TSKDiffableDataSource * diffableDataSource;                                                                                             //@synthesize diffableDataSource=_diffableDataSource - In the implementation block
...
-(void)setDiffableDataSource:(TSKDiffableDataSource *)arg1 ;
-(TSKDiffableDataSource *)diffableDataSource;
-(void)reloadSettings;
