...
@class PKPaymentWebService, NSMutableArray, PKPaymentService, NSArray, NSMutableSet, PKAccount, NSObject, NSString, PKAssertion, PKFeatureApplication, PKPaymentProvisioningController, PKPaymentInstallmentConfiguration;
