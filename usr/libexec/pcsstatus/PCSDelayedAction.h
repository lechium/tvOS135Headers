...
- (void).cxx_destruct;	// IMP=0x00000001000057c0
...
- (void)trigger;	// IMP=0x0000000100005628
- (void)setHoldTransaction:(_Bool)arg1;	// IMP=0x0000000100005590
- (void)run;	// IMP=0x0000000100005580
- (void)setAction:(CDUnknownBlockType)arg1;	// IMP=0x000000010000553c
- (id)initWithDelay:(unsigned long long)arg1 operationQueue:(id)arg2;	// IMP=0x0000000100005154
