...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000100102f80
- (unsigned long long)hash;	// IMP=0x0000000100102dec
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100102c08
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000100102a44
- (void)copyTo:(id)arg1;	// IMP=0x00000001001028b4
- (void)writeTo:(id)arg1;	// IMP=0x0000000100102748
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000100102740
- (id)dictionaryRepresentation;	// IMP=0x0000000100101dd0
- (id)description;	// IMP=0x0000000100101d50
...
- (void)dealloc;	// IMP=0x0000000100101a20
