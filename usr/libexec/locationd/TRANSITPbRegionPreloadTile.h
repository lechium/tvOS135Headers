...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000001000e6954
- (unsigned long long)hash;	// IMP=0x00000001000e68a0
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001000e6780
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001000e6670
- (void)copyTo:(id)arg1;	// IMP=0x00000001000e659c
- (void)writeTo:(id)arg1;	// IMP=0x00000001000e64b0
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000001000e64a8
- (id)dictionaryRepresentation;	// IMP=0x00000001000e5e20
- (id)description;	// IMP=0x00000001000e5da0
