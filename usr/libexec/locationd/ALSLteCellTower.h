...
- (unsigned long long)hash;	// IMP=0x00000001005284e0
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100528358
- (void)copyTo:(id)arg1;	// IMP=0x00000001005281ac
- (void)writeTo:(id)arg1;	// IMP=0x0000000100528014
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000010052800c
- (id)dictionaryRepresentation;	// IMP=0x0000000100527824
- (id)description;	// IMP=0x00000001005277a4
...
- (void)dealloc;	// IMP=0x0000000100527544
