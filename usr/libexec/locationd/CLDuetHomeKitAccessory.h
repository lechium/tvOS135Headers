...
- (void)dealloc;	// IMP=0x0000000100104e58
- (id)initWithHomeUUID:(id)arg1 accessoryUUID:(id)arg2 accessoryName:(id)arg3 serviceName:(id)arg4 serviceType:(id)arg5 characteristicType:(id)arg6 clientName:(id)arg7;	// IMP=0x0000000100104d50
