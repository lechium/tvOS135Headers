...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000001005ed638
- (unsigned long long)hash;	// IMP=0x00000001005ed370
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001005ed1d8
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001005ed04c
- (void)copyTo:(id)arg1;	// IMP=0x00000001005ecefc
- (void)writeTo:(id)arg1;	// IMP=0x00000001005ecda0
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000001005ecd98
- (id)dictionaryRepresentation;	// IMP=0x00000001005ec6b0
- (id)description;	// IMP=0x00000001005ec630
...
- (struct CLDaemonLocationPrivate)daemonLocationPrivate;	// IMP=0x00000001005cfab4
- (id)initWithDaemonLocationPrivate:(const struct CLDaemonLocationPrivate *)arg1;	// IMP=0x00000001005cf888
