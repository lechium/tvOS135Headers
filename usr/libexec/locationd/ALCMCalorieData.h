...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000100243538
- (unsigned long long)hash;	// IMP=0x0000000100243304
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010024317c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010024302c
- (void)copyTo:(id)arg1;	// IMP=0x0000000100242f18
- (void)writeTo:(id)arg1;	// IMP=0x0000000100242dcc
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000100242dc4
- (id)dictionaryRepresentation;	// IMP=0x0000000100242200
- (id)description;	// IMP=0x0000000100242180
@property(nonatomic) _Bool hasMetsFM;
@property(nonatomic) _Bool hasMetsWR;
@property(nonatomic) _Bool hasMetsHR;
- (int)StringAsTruthMetsSource:(id)arg1;	// IMP=0x0000000100241fc0
- (id)truthMetsSourceAsString:(int)arg1;	// IMP=0x0000000100241f2c
...
- (int)StringAsUserMetsSource:(id)arg1;	// IMP=0x0000000100241dec
- (id)userMetsSourceAsString:(int)arg1;	// IMP=0x0000000100241d58
...
- (int)StringAsActivityType:(id)arg1;	// IMP=0x00000001002418d4
- (id)activityTypeAsString:(int)arg1;	// IMP=0x00000001002415fc
