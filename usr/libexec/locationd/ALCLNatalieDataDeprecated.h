...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000001005ce494
- (unsigned long long)hash;	// IMP=0x00000001005ce278
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001005ce0c4
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001005cdf58
- (void)copyTo:(id)arg1;	// IMP=0x00000001005cde28
- (void)writeTo:(id)arg1;	// IMP=0x00000001005cdcd0
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000001005cdcc8
- (id)dictionaryRepresentation;	// IMP=0x00000001005cd024
- (id)description;	// IMP=0x00000001005ccfa4
...
- (int)StringAsActivityType:(id)arg1;	// IMP=0x00000001005cc9f8
- (id)activityTypeAsString:(int)arg1;	// IMP=0x00000001005cc720
