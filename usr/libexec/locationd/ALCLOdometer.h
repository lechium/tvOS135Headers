...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000100798f38
- (unsigned long long)hash;	// IMP=0x0000000100798c40
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100798a90
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001007988f4
- (void)copyTo:(id)arg1;	// IMP=0x0000000100798794
- (void)writeTo:(id)arg1;	// IMP=0x0000000100798620
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000100798618
- (id)dictionaryRepresentation;	// IMP=0x0000000100797df8
- (id)description;	// IMP=0x0000000100797d78
- (int)StringAsQuality:(id)arg1;	// IMP=0x0000000100797cd4
- (id)qualityAsString:(int)arg1;	// IMP=0x0000000100797c4c
