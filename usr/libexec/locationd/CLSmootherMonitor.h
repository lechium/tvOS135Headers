...
+ (id)getSilo;	// IMP=0x0000000100799220
+ (void)performSyncOnSilo:(id)arg1 invoker:(CDUnknownBlockType)arg2;	// IMP=0x00000001007991fc
+ (void)becameFatallyBlocked:(id)arg1 index:(unsigned long long)arg2;	// IMP=0x00000001008accfc
...
- (void)smoothLocations:(id)arg1 handler:(CDUnknownBlockType)arg2;	// IMP=0x000000010079a748
- (void)smoothLocations:(id)arg1 useType:(id)arg2;	// IMP=0x0000000100799e8c
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x00000001007995a8
- (void)dealloc;	// IMP=0x0000000100799574
- (void)endService;	// IMP=0x000000010079944c
- (void)beginService;	// IMP=0x00000001007992dc
- (id)init;	// IMP=0x0000000100799298
