...
+ (id)withEvent:(long long)arg1 andPredicate:(id)arg2;	// IMP=0x00000001003591cc
...
- (void)dealloc;	// IMP=0x00000001003592a4
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010035911c
- (unsigned long long)hash;	// IMP=0x00000001003590a0
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100358fd8
