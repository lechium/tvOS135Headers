...
+ (_Bool)isSupported;	// IMP=0x00000001002a11d0
+ (id)getSilo;	// IMP=0x00000001002a1158
+ (void)performSyncOnSilo:(id)arg1 invoker:(CDUnknownBlockType)arg2;	// IMP=0x00000001002a1134
+ (void)becameFatallyBlocked:(id)arg1 index:(unsigned long long)arg2;	// IMP=0x00000001008807e8
- (id).cxx_construct;	// IMP=0x00000001002a413c
- (void).cxx_destruct;	// IMP=0x00000001002a4098
...
- (void)pairedDeviceIsNearby:(_Bool)arg1;	// IMP=0x00000001002a3e18
- (void)successfullySentMessage:(id)arg1;	// IMP=0x00000001002a3d20
- (void)failedToSendMessage:(id)arg1 withError:(id)arg2 isFatal:(_Bool)arg3;	// IMP=0x00000001002a3c00
- (void)receivedMessageOfType:(id)arg1 withPayload:(id)arg2;	// IMP=0x00000001002a3844
- (void)onMotionStateNotification:(const int *)arg1 withData:(const union NotificationData *)arg2;	// IMP=0x00000001002a35c4
- (void)sendMotionState;	// IMP=0x00000001002a33c4
- (void)stopMotionAlarm;	// IMP=0x00000001002a3274
- (void)startMotionAlarm;	// IMP=0x00000001002a3138
- (void)reevaluateMotionSubscription;	// IMP=0x00000001002a2f44
- (void)onLocationNotification:(const int *)arg1 withData:(const struct NotificationData *)arg2;	// IMP=0x00000001002a2a38
- (void)startUpdatingLocationWithGranularity:(int)arg1 includeMotion:(_Bool)arg2 inFitnessSession:(_Bool)arg3 inAirborneSession:(_Bool)arg4 emergencyEnablementAssertionActive:(_Bool)arg5;	// IMP=0x00000001002a2658
- (void)stopLocation;	// IMP=0x00000001002a20e8
- (void)unregisterAllLocationNotifications;	// IMP=0x00000001002a2064
- (void)sendAliveAgainMessage;	// IMP=0x00000001002a1e80
- (void)endService;	// IMP=0x00000001002a1d30
- (void)beginService;	// IMP=0x00000001002a1288
- (id)init;	// IMP=0x00000001002a1244
