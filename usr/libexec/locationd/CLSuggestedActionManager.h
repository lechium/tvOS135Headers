...
@class CLLocation, CLTimer, NSMutableArray, NSMutableDictionary, NSString, NSUserActivity;
...
+ (id)getSilo;	// IMP=0x0000000100369230
+ (void)performSyncOnSilo:(id)arg1 invoker:(CDUnknownBlockType)arg2;	// IMP=0x000000010036920c
+ (void)becameFatallyBlocked:(id)arg1 index:(unsigned long long)arg2;	// IMP=0x0000000100888990
+ (_Bool)isSupported;	// IMP=0x0000000100368e48
- (id).cxx_construct;	// IMP=0x0000000100371870
- (void).cxx_destruct;	// IMP=0x0000000100371778
...
- (void)onDaemonStatusDisplayOff;	// IMP=0x00000001003713cc
- (void)onPurgeTimer;	// IMP=0x0000000100371194
- (_Bool)isAppSuggestionsAllowed;	// IMP=0x000000010037114c
- (void)_updateAppSuggestionsAllowed;	// IMP=0x0000000100370efc
- (void)beaconRegion:(struct MonitoredRegion)arg1 didTransitionToState:(int)arg2;	// IMP=0x0000000100370d58
- (void)suggestBeaconAppWithBundleIdentifierSet:(id)arg1;	// IMP=0x00000001003707b8
- (void)onUAUserActivityDidContinueToAppStoreNotification:(id)arg1;	// IMP=0x0000000100370370
- (id)identifierForAdamId:(id)arg1 atLocation:(id)arg2;	// IMP=0x0000000100370100
- (_Bool)shouldSuggestActionWithIdentifier:(id)arg1;	// IMP=0x000000010036fe98
- (void)actionWithIdentifier:(id)arg1 wasSuggested:(_Bool)arg2;	// IMP=0x000000010036fd4c
- (void)_suggestWithLocation:(id)arg1;	// IMP=0x000000010036da4c
- (id)_filterAppRecommendationResults:(id)arg1 touristMode:(_Bool)arg2;	// IMP=0x000000010036ce90
- (id)_appRecommendationResultsFromCandidateList:(id)arg1 atLocation:(id)arg2;	// IMP=0x000000010036c45c
- (void)onLocation:(id)arg1;	// IMP=0x000000010036be44
- (void)suggestLocationApp;	// IMP=0x000000010036b978
- (void)handleNudge;	// IMP=0x000000010036b078
- (void)_updatePredictedApplicationExtensions:(id)arg1 error:(id)arg2;	// IMP=0x000000010036abe4
- (void)_determinePredictedApplicationExtensionEnabled;	// IMP=0x000000010036aa1c
- (void)_registerForZeroKeywordDisabledNotification;	// IMP=0x000000010036a750
- (_Bool)_determineZeroKeywordEnabled;	// IMP=0x000000010036a68c
- (void)endService;	// IMP=0x000000010036a278
- (void)beginService;	// IMP=0x00000001003692ec
- (id)init;	// IMP=0x00000001003692a8
