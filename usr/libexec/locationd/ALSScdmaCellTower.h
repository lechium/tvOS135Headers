...
- (unsigned long long)hash;	// IMP=0x0000000100731e1c
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100731ce4
- (void)copyTo:(id)arg1;	// IMP=0x0000000100731b88
- (void)writeTo:(id)arg1;	// IMP=0x0000000100731a1c
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000100731a14
- (id)dictionaryRepresentation;	// IMP=0x0000000100731294
- (id)description;	// IMP=0x0000000100731214
@property(nonatomic) _Bool hasPsc;
@property(nonatomic) _Bool hasArfcn;
@property(readonly, nonatomic) _Bool hasLocation;
- (void)dealloc;	// IMP=0x0000000100731104
