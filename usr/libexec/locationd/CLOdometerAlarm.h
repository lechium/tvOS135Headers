...
- (void)fire:(double)arg1 withError:(id)arg2;	// IMP=0x00000001005ac218
- (void)invalidate;	// IMP=0x00000001005ac1a8
- (void)dealloc;	// IMP=0x00000001005ac144
- (id)initWithDistance:(double)arg1 inUniverse:(id)arg2 handler:(CDUnknownBlockType)arg3;	// IMP=0x00000001005ac028
- (id)init;	// IMP=0x00000001005abfec
