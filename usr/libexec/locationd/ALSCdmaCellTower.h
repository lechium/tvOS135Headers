...
- (unsigned long long)hash;	// IMP=0x0000000100514adc
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001005148f8
- (void)copyTo:(id)arg1;	// IMP=0x00000001005146dc
- (void)writeTo:(id)arg1;	// IMP=0x00000001005144f0
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000001005144e8
- (id)dictionaryRepresentation;	// IMP=0x0000000100513ae8
- (id)description;	// IMP=0x0000000100513a68
...
- (void)dealloc;	// IMP=0x000000010051375c
