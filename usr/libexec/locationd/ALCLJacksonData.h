...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000010010193c
- (unsigned long long)hash;	// IMP=0x0000000100101818
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100101730
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000100101660
- (void)copyTo:(id)arg1;	// IMP=0x00000001001015cc
- (void)writeTo:(id)arg1;	// IMP=0x0000000100101510
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000100101508
- (id)dictionaryRepresentation;	// IMP=0x0000000100101018
- (id)description;	// IMP=0x0000000100100f98
