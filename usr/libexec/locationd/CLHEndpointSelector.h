...
- (id)description;	// IMP=0x000000010074652c
- (id)jsonObject;	// IMP=0x00000001007463b8
- (void)updateEndpoint:(id *)arg1 withKey:(id)arg2;	// IMP=0x00000001007461f4
- (void)refresh;	// IMP=0x0000000100746100
- (void)dealloc;	// IMP=0x0000000100746078
- (id)init;	// IMP=0x0000000100745f10
