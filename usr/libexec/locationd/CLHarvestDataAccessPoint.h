...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000100185004
...
- (id)description;	// IMP=0x00000001001855ac
- (id)jsonObject;	// IMP=0x0000000100185398
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000100185298
- (id)initWithCoder:(id)arg1;	// IMP=0x000000010018516c
- (void)dealloc;	// IMP=0x0000000100185124
- (id)initWithAccessPoint:(struct AccessPoint)arg1;	// IMP=0x000000010018500c
