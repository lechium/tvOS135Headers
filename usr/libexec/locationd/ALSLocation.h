...
- (unsigned long long)hash;	// IMP=0x0000000100523154
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100522f9c
- (void)copyTo:(id)arg1;	// IMP=0x0000000100522d84
- (void)writeTo:(id)arg1;	// IMP=0x0000000100522bc0
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000100522bb8
- (id)dictionaryRepresentation;	// IMP=0x00000001005220b8
- (id)description;	// IMP=0x0000000100522038
...
- (void)dealloc;	// IMP=0x0000000100521db8
