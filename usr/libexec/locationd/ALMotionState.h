...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000001000bd330
- (unsigned long long)hash;	// IMP=0x00000001000bd254
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001000bd154
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001000bd070
- (void)copyTo:(id)arg1;	// IMP=0x00000001000bcfd8
- (void)writeTo:(id)arg1;	// IMP=0x00000001000bcf40
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000001000bcf38
- (id)dictionaryRepresentation;	// IMP=0x00000001000bcaa8
- (id)description;	// IMP=0x00000001000bca28
@property(readonly, nonatomic) _Bool hasNatalieFeatures;
@property(nonatomic) _Bool hasTimestamp;
- (void)dealloc;	// IMP=0x00000001000bc958
