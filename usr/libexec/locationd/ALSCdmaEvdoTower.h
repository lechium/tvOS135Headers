...
- (unsigned long long)hash;	// IMP=0x00000001005165f0
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001005164b4
- (void)copyTo:(id)arg1;	// IMP=0x0000000100516378
- (void)writeTo:(id)arg1;	// IMP=0x0000000100516238
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000100516230
- (id)dictionaryRepresentation;	// IMP=0x0000000100515c88
- (id)description;	// IMP=0x0000000100515c08
...
- (void)dealloc;	// IMP=0x0000000100515a78
