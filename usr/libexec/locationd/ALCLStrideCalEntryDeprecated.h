...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000100153094
- (unsigned long long)hash;	// IMP=0x0000000100152ee0
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100152da8
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000100152cb4
- (void)copyTo:(id)arg1;	// IMP=0x0000000100152bf4
- (void)writeTo:(id)arg1;	// IMP=0x0000000100152af8
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000100152af0
- (id)dictionaryRepresentation;	// IMP=0x0000000100152434
- (id)description;	// IMP=0x00000001001523b4
