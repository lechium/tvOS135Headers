...
+ (id)sharedInstance;	// IMP=0x000000010000af3c
...
- (id)copyDeviceTreeInt:(id)arg1 key:(id)arg2 defaultValue:(int)arg3;	// IMP=0x000000010000b904
- (id)copyBootArgs;	// IMP=0x000000010000b860
- (id)copyDeviceTreeProperty:(id)arg1 key:(id)arg2;	// IMP=0x000000010000b7ac
- (id)init;	// IMP=0x000000010000afa8
