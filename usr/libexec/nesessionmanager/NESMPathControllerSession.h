...
+ (id)monitorStatusString:(long long)arg1;	// IMP=0x000000010007a454
- (void).cxx_destruct;	// IMP=0x000000010007d70c
...
- (void)unassertFallbackForClient:(id)arg1;	// IMP=0x000000010007d374
- (void)assertFallbackForClient:(id)arg1 process:(id)arg2;	// IMP=0x000000010007d27c
...
- (void)updatePolicies:(_Bool)arg1 agent:(_Bool)arg2;	// IMP=0x000000010007c7b0
- (void)updateFallbackInUse;	// IMP=0x000000010007c4fc
- (void)postFallbackInUseWithDelay:(unsigned long long)arg1;	// IMP=0x000000010007c4d0
- (void)postFallbackInUse;	// IMP=0x000000010007c2c0
- (id)copyUUIDsForBundleIDArray:(id)arg1;	// IMP=0x000000010007c040
- (id)currentFallbackBundleIDs;	// IMP=0x000000010007bd40
- (id)fallbackExceptionBundleIDsForce:(_Bool)arg1;	// IMP=0x000000010007ba9c
- (id)currentRouteRules:(id)arg1 defaultPathRule:(id)arg2;	// IMP=0x000000010007b6c4
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x000000010007a840
- (void)handleChangeEventForFallbackInterfaces:(id)arg1;	// IMP=0x000000010007a480
- (void)dealloc;	// IMP=0x000000010007a408
- (void)uninstall;	// IMP=0x000000010007a37c
- (void)install;	// IMP=0x000000010007a258
- (void)didStopTrackingAllNOIs:(id)arg1;	// IMP=0x000000010007a0f8
- (void)didStopTrackingNOI:(id)arg1;	// IMP=0x000000010007a014
- (void)didStartTrackingNOI:(id)arg1;	// IMP=0x0000000100079f2c
- (void)removeFallbackNotifications;	// IMP=0x0000000100079d14
- (void)setupFallbackNotifications;	// IMP=0x00000001000799f4
- (void)cancelFallbackNotificationTimer;	// IMP=0x00000001000799a4
- (void)resetFallbackNotificationTimeout:(unsigned long long)arg1;	// IMP=0x0000000100079940
- (void)createFallbackNotificationTimer;	// IMP=0x0000000100079844
- (void)checkBundleIDsForFallback:(id)arg1;	// IMP=0x00000001000792b4
- (void)teardownRoamingMonitor;	// IMP=0x00000001000791c4
- (void)setupRoamingMonitor;	// IMP=0x0000000100078ff8
- (void)handleInstalledAppsChanged;	// IMP=0x0000000100078da4
- (void)handleNetworkDetectionNotification:(int)arg1;	// IMP=0x0000000100078c50
- (_Bool)handleUpdateConfiguration:(id)arg1;	// IMP=0x0000000100078b18
- (void)handleStopMessageWithReason:(int)arg1;	// IMP=0x0000000100078998
- (void)handleStartMessage:(id)arg1;	// IMP=0x000000010007891c
- (_Bool)shouldBeIdleForStatus:(int)arg1;	// IMP=0x0000000100078900
- (int)type;	// IMP=0x00000001000788f8
- (id)initWithConfiguration:(id)arg1 andServer:(id)arg2;	// IMP=0x0000000100078778
- (_Bool)configurationNeedsFallbackNotifications;	// IMP=0x0000000100078714
- (_Bool)configurationNeedsRoamingMonitorIgnoreFallback:(_Bool)arg1;	// IMP=0x0000000100078560
