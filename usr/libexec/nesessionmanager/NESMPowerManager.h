...
- (void).cxx_destruct;	// IMP=0x00000001000783e4
...
- (void)setPowerState:(long long)arg1;	// IMP=0x0000000100078070
- (void)stop;	// IMP=0x0000000100077fe8
- (_Bool)start;	// IMP=0x0000000100077d88
- (void)setReadyToSleep;	// IMP=0x0000000100077b94
- (_Bool)sleepPending;	// IMP=0x0000000100077b58
- (id)initWithDelegate:(id)arg1 queue:(id)arg2;	// IMP=0x0000000100077ab0
