...
- (void).cxx_destruct;	// IMP=0x000000010001e0c4
...
- (void)session:(id)arg1 receivedInvitationDeclineFromID:(id)arg2;	// IMP=0x000000010001d5a8
- (void)session:(id)arg1 receivedInvitationCancelFromID:(id)arg2;	// IMP=0x000000010001d3d0
- (void)session:(id)arg1 receivedInvitationAcceptFromID:(id)arg2;	// IMP=0x000000010001d1f8
- (void)session:(id)arg1 didReceiveData:(id)arg2;	// IMP=0x000000010001cfa4
- (void)sessionEnded:(id)arg1 withReason:(unsigned int)arg2 error:(id)arg3;	// IMP=0x000000010001cac0
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x000000010001ca08
- (void)sessionStarted:(id)arg1;	// IMP=0x000000010001c428
- (void)service:(id)arg1 account:(id)arg2 inviteReceivedForSession:(id)arg3 fromID:(id)arg4 withOptions:(id)arg5;	// IMP=0x000000010001bde8
- (void)requestConfigurationForListener:(id)arg1 session:(id)arg2 sessionConfig:(id)arg3 childConfig:(id)arg4 validateAuthBlock:(CDUnknownBlockType)arg5 responseBlock:(CDUnknownBlockType)arg6;	// IMP=0x000000010001b290
- (void)listener:(id)arg1 receivedNewSession:(id)arg2;	// IMP=0x000000010001b16c
- (void)handleRequestToActivateNexus:(id)arg1 fromFlow:(id)arg2;	// IMP=0x000000010001b168
- (void)acceptNewFlow:(id)arg1 fromNexus:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x000000010001b158
- (void)setPacketReceiver:(id)arg1;	// IMP=0x000000010001aed4
- (_Bool)sendPacketData:(id)arg1;	// IMP=0x000000010001aa94
- (void)readDatagramFromSession;	// IMP=0x000000010001a7c8
- (_Bool)writeDatagramToSession:(id)arg1;	// IMP=0x000000010001a3f8
- (_Bool)sendControlData:(id)arg1;	// IMP=0x000000010001a164
- (void)setupIPsec;	// IMP=0x0000000100019c48
- (void)setupIPsecClassC;	// IMP=0x0000000100019b9c
- (void)setupIPsecClassD;	// IMP=0x0000000100019af0
- (void)setupIKEListener;	// IMP=0x0000000100019980
- (void)setupIKEInitiatorSessionForClass:(unsigned char)arg1;	// IMP=0x0000000100019464
- (void)setupIKECallbacksForClass:(unsigned char)arg1;	// IMP=0x0000000100018f1c
- (void)restartIKESessionForClass:(unsigned char)arg1;	// IMP=0x0000000100018d94
- (void)invalidateIKESessionForClass:(unsigned char)arg1;	// IMP=0x0000000100018d28
- (id *)ikeSessionPointerForDataProtectionClass:(unsigned char)arg1;	// IMP=0x0000000100018be4
- (void)handleIKEConnected;	// IMP=0x0000000100018a48
- (void)ikeSessionTimeoutSourceDisarm;	// IMP=0x00000001000189bc
- (void)armIKELinkTimeout;	// IMP=0x00000001000187d8
- (void)handleLinkIdleTimeout;	// IMP=0x00000001000186dc
- (void)armLinkIdleTimer;	// IMP=0x000000010001847c
- (void)linkIdleTimerDisarm;	// IMP=0x00000001000183f0
- (_Bool)setupNexus;	// IMP=0x000000010001708c
- (void)sendInvitation;	// IMP=0x0000000100016ef8
- (void)reportEventToPowerLog:(int)arg1;	// IMP=0x0000000100016c8c
- (void)invalidateIDSSession;	// IMP=0x0000000100016968
- (void)invalidateConnection;	// IMP=0x0000000100016814
- (void)setupIDSSessionAndSendInvitation;	// IMP=0x0000000100016434
- (_Bool)setupIDSService;	// IMP=0x0000000100016250
- (_Bool)resume;	// IMP=0x0000000100016058
- (_Bool)suspend;	// IMP=0x0000000100015bcc
- (_Bool)start;	// IMP=0x000000010001599c
- (id)copyStatusString;	// IMP=0x0000000100014e68
- (unsigned short)metric;	// IMP=0x0000000100014e60
- (_Bool)cancelWithReason:(id)arg1;	// IMP=0x0000000100014b78
- (void)invalidateLink;	// IMP=0x00000001000146cc
- (void)dealloc;	// IMP=0x0000000100014630
- (id)initLinkWithQueue:(id)arg1 linkDelegate:(id)arg2 nrUUID:(id)arg3;	// IMP=0x000000010001438c
