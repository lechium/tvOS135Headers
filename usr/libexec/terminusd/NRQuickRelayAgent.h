...
+ (id)agentFromData:(id)arg1;	// IMP=0x000000010000efd0
+ (id)agentDomain;	// IMP=0x000000010000ef8c
+ (id)agentType;	// IMP=0x000000010000ef48
- (void).cxx_destruct;	// IMP=0x000000010000ebd8
...
- (void)unassertAgentWithOptions:(id)arg1;	// IMP=0x000000010000ea2c
- (_Bool)assertAgentWithOptions:(id)arg1;	// IMP=0x000000010000e9ac
- (_Bool)registerAgent;	// IMP=0x000000010000e534
- (void)activateAgent;	// IMP=0x000000010000e398
- (void)suspendAgent;	// IMP=0x000000010000e210
- (_Bool)unregisterAgent;	// IMP=0x000000010000e01c
- (id)copyAgentData;	// IMP=0x000000010000e014
- (id)description;	// IMP=0x000000010000de74
- (void)dealloc;	// IMP=0x000000010000ddd0
- (id)initWithNRUUID:(id)arg1 queue:(id)arg2 delegate:(id)arg3;	// IMP=0x000000010000d89c
