...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000001000b5dfc
- (void).cxx_destruct;	// IMP=0x00000001000a330c
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000001000a2604
- (id)initWithCoder:(id)arg1;	// IMP=0x00000001000a0b78
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010009fed8
- (id)copyNewEncoding;	// IMP=0x000000010009f184
- (id)initWithNRUUID:(id)arg1;	// IMP=0x000000010009efc8
