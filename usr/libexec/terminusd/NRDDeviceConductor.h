...
@interface NRDDeviceConductor : NSObject <NRLinkDelegate, NRLinkManagerWiFiDelegate, NRLinkManagerBluetoothDelegate, NRLinkManagerQuickRelayDelegate, NRPhoneCallRelayAgentDelegate, NRQuickRelayAgentDelegate, NRBTLinkPreferencesAgentDelegate>
{
    ...
    unsigned char _lastPrimaryLinkType;	// 29 = 0x1d
    unsigned short _deviceLinkInnerVersion;	// 30 = 0x1e
    NSUUID *_nrUUID;	// 32 = 0x20
    NSObject<OS_dispatch_queue> *_queue;	// 40 = 0x28
    NSMutableSet *_availableLinks;	// 48 = 0x30
    NSMutableArray *_requests;	// 56 = 0x38
    NRLink *_primaryLink;	// 64 = 0x40
    NWAddressEndpoint *_lastSentWiFiEndpoint;	// 72 = 0x48
    NSData *_lastSentWiFiSignature;	// 80 = 0x50
    NSMutableSet *_deviceMonitorConnections;	// 88 = 0x58
    NSMutableSet *_deviceSetupInProgressConnections;	// 96 = 0x60
    NRDevicePreferencesManager *_devicePreferencesManager;	// 104 = 0x68
    NRQuickRelayAgent *_quickRelayAgent;	// 112 = 0x70
    NRBTLinkPreferencesAgent *_btLinkPreferencesAgent;	// 120 = 0x78
    unsigned long long _peerDeviceIsNearbyUpdateCounter;	// 128 = 0x80
    NSUUID *_forcedWoWUUID;	// 136 = 0x88
    NSString *_policyIdentifier;	// 144 = 0x90
    unsigned long long _latestWiFiAddressUpdateMsgIdentifier;	// 152 = 0x98
    unsigned long long _latestPreferWiFiRequestMsgIdentifier;	// 160 = 0xa0
    unsigned long long _latestPreferWiFiAckMsgIdentifier;	// 168 = 0xa8
    NRAnalyticsPreferWiFi *_preferWiFiAnalytics;	// 176 = 0xb0
    NRAnalyticsPhoneCallRelay *_phoneCallRelayAnalytics;	// 184 = 0xb8
    NRCompanionLinkViabilityAgent *_companionLinkViabilityAgent;	// 192 = 0xc0
    unsigned long long _companionLinkViableCounter;	// 200 = 0xc8
    unsigned long long _rejectPreferWiFiRequestTime;	// 208 = 0xd0
}

+ (id)copyDeviceMonitorStatusForOrphanWithNRUUID:(id)arg1 replyDict:(id)arg2;	// IMP=0x0000000100088134
+ (id)createDeviceMonitorDictWithNRUUID:(id)arg1 isNearby:(_Bool)arg2 isConnected:(_Bool)arg3 isCloudConnected:(_Bool)arg4 isAsleep:(_Bool)arg5 isClassCConnected:(_Bool)arg6 linkType:(unsigned char)arg7 replyDict:(id)arg8;	// IMP=0x0000000100087e88
- (void).cxx_destruct;	// IMP=0x0000000100086db8
...
- (void)measureBTLatencyWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0000000100086970
- (id)wifiManager;	// IMP=0x0000000100086914
- (void)handleAlwaysOnWiFiQueryComplete;	// IMP=0x0000000100086898
- (void)removeDevicePreferencesManagerConnection:(id)arg1;	// IMP=0x00000001000867f8
- (void)setPolicyTrafficClasses:(id)arg1 forConnection:(id)arg2;	// IMP=0x0000000100086734
- (void)setLinkPreferences:(id)arg1 forConnection:(id)arg2;	// IMP=0x0000000100086670
- (void)removeDeviceMonitorConnection:(id)arg1;	// IMP=0x00000001000865d0
- (void)addDeviceMonitorConnection:(id)arg1;	// IMP=0x0000000100086530
- (void)removeDeviceSetupInProgressConnection:(id)arg1;	// IMP=0x000000010008643c
- (void)addDeviceSetupInProgressConnection:(id)arg1;	// IMP=0x0000000100086348
- (void)reportEvent:(int)arg1;	// IMP=0x0000000100086338
- (void)reportEvent:(int)arg1 detailsFormat:(id)arg2;	// IMP=0x00000001000862a4
- (void)reportEvent:(int)arg1 details:(id)arg2;	// IMP=0x0000000100086294
- (void)deviceHasBTLinkUpgradeRequest:(_Bool)arg1;	// IMP=0x00000001000860f0
- (void)deviceHasQuickRelayRequest:(id)arg1 hasQuickRelayRequest:(_Bool)arg2;	// IMP=0x0000000100085eac
- (void)apsIsConnected:(_Bool)arg1;	// IMP=0x0000000100085d90
- (void)deviceHasPhoneCallRelayRequest:(_Bool)arg1;	// IMP=0x0000000100085b6c
- (void)pipeDidConnectForNRUUID:(_Bool)arg1 nrUUID:(id)arg2;	// IMP=0x00000001000858d8
- (void)linkPeerIsAsleep:(id)arg1 isAsleep:(_Bool)arg2;	// IMP=0x000000010008583c
- (void)linkDidReceiveData:(id)arg1 data:(id)arg2;	// IMP=0x0000000100084f70
- (void)linkIsUnavailable:(id)arg1;	// IMP=0x0000000100084b08
- (void)linkIsSuspended:(id)arg1;	// IMP=0x0000000100084970
- (void)linkIsReady:(id)arg1;	// IMP=0x0000000100084620
- (void)linkIsAvailable:(id)arg1;	// IMP=0x0000000100084070
- (void)sendDeviceLinkStateOnLink:(id)arg1;	// IMP=0x0000000100083f88
- (void)addStopQuickRelayRequest;	// IMP=0x0000000100083ed0
- (unsigned int)cancelAllLinks;	// IMP=0x0000000100083cec
- (void)removePoliciesForLink:(id)arg1;	// IMP=0x00000001000839dc
- (void)setIPTunnelPolicyForLink:(id)arg1;	// IMP=0x0000000100080adc
- (void)resumeLinkOfType:(unsigned char)arg1;	// IMP=0x0000000100080940
- (void)suspendLinkOfType:(unsigned char)arg1;	// IMP=0x00000001000807dc
- (void)sendHelloWithPreferredLink:(id)arg1 forced:(_Bool)arg2;	// IMP=0x00000001000806e0
- (void)rejectPreferWiFiRequest:(id)arg1;	// IMP=0x0000000100080560
- (void)updatePrimaryLink;	// IMP=0x00000001000802d0
- (void)serviceRequests;	// IMP=0x000000010007fc9c
- (void)processRequest:(id)arg1;	// IMP=0x000000010007ee84
- (_Bool)hasServiceRequestOfType:(unsigned char)arg1;	// IMP=0x000000010007ed2c
- (void)removeRequestOfType:(unsigned char)arg1;	// IMP=0x000000010007ea98
- (void)removeRequest:(id)arg1;	// IMP=0x000000010007e9f8
- (void)addRequest:(id)arg1;	// IMP=0x000000010007e68c
- (void)refreshCompanionProxyAgent;	// IMP=0x000000010007e518
- (id)copyStatusString;	// IMP=0x000000010007e030
- (void)enableWiFiAutojoin;	// IMP=0x000000010007df50
- (void)disableWiFiAutojoinIfApplicable;	// IMP=0x000000010007de90
- (void)forceWoWMode;	// IMP=0x000000010007de8c
- (_Bool)isDeviceNearby;	// IMP=0x000000010007de2c
- (_Bool)isAlwaysOnWiFiSupported;	// IMP=0x000000010007dca8
- (void)setWiFiLinkBringUpTimeout;	// IMP=0x000000010007da54
- (void)setPreferWiFiTimeout;	// IMP=0x000000010007d860
- (_Bool)sendPreferWiFiRequest:(_Bool)arg1 immediately:(_Bool)arg2 removeIfFailed:(_Bool)arg3 preferLinkType:(unsigned char)arg4 isAck:(_Bool)arg5 completion:(CDUnknownBlockType)arg6;	// IMP=0x000000010007d708
- (_Bool)isLastSentWiFiEndpointValid;	// IMP=0x000000010007d660
- (void)setWiFiRangeExtensionAllowedForTesting:(_Bool)arg1;	// IMP=0x000000010007d470
- (void)setWiFiState:(_Bool)arg1;	// IMP=0x000000010007d270
- (void)setBringUpWiFiImmediatelyInner:(_Bool)arg1 timeout:(unsigned short)arg2 addSuspendBTRequest:(_Bool)arg3;	// IMP=0x000000010007cea8
- (id)copyPrimaryLink;	// IMP=0x000000010007ce70
- (id)copyLinkOfType:(unsigned char)arg1;	// IMP=0x000000010007cd14
- (void)addSuspendBluetoothRequestWhenWiFiAvailable;	// IMP=0x000000010007c788
- (void)updateDeviceMonitorConnections;	// IMP=0x000000010007c530
- (id)copyDeviceMonitorStatusWithReplyDict:(id)arg1;	// IMP=0x000000010007c338
- (void)updateCompanionLinkViability;	// IMP=0x000000010007c024
- (void)startQuickRelayLinkIfApplicable;	// IMP=0x000000010007beb0
- (void)cancelConductor;	// IMP=0x000000010007b884
- (void)startConductor;	// IMP=0x000000010007b29c
- (id)initConductorWithNRUUID:(id)arg1 queue:(id)arg2;	// IMP=0x000000010007aee4
