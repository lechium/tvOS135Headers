...
+ (id)agentFromData:(id)arg1;	// IMP=0x00000001000bee88
+ (id)agentDomain;	// IMP=0x00000001000bee44
+ (id)agentType;	// IMP=0x00000001000bee00
- (void).cxx_destruct;	// IMP=0x00000001000beaf0
...
- (void)unassertAgentWithOptions:(id)arg1;	// IMP=0x00000001000be96c
- (_Bool)assertAgentWithOptions:(id)arg1;	// IMP=0x00000001000be8ec
- (_Bool)registerAgent;	// IMP=0x00000001000be440
- (_Bool)unregisterAgent;	// IMP=0x00000001000be2a8
@property(nonatomic) _Bool requiresAssert;
- (id)copyAgentData;	// IMP=0x00000001000be298
- (void)dealloc;	// IMP=0x00000001000be24c
- (id)initWithQueue:(id)arg1 delegate:(id)arg2;	// IMP=0x00000001000bdf7c
