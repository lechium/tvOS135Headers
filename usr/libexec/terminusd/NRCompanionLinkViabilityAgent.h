...
+ (id)agentFromData:(id)arg1;	// IMP=0x0000000100034dfc
+ (id)agentDomain;	// IMP=0x0000000100034db8
+ (id)agentType;	// IMP=0x0000000100034d74
- (void).cxx_destruct;	// IMP=0x0000000100034ca8
...
- (void)unassertAgentWithOptions:(id)arg1;	// IMP=0x0000000100034b6c
- (_Bool)assertAgentWithOptions:(id)arg1;	// IMP=0x0000000100034b24
- (_Bool)registerAgentWithActivate:(_Bool)arg1;	// IMP=0x0000000100034580
- (void)activateAgent;	// IMP=0x0000000100034458
- (void)suspendAgent;	// IMP=0x0000000100034330
- (_Bool)unregisterAgent;	// IMP=0x000000010003413c
- (id)copyAgentData;	// IMP=0x0000000100034134
- (id)description;	// IMP=0x0000000100033fbc
- (void)dealloc;	// IMP=0x0000000100033f18
- (id)initWithNRUUID:(id)arg1 queue:(id)arg2;	// IMP=0x0000000100033a3c
