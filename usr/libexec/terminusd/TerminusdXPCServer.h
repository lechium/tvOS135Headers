...
+ (id)copySharedServer;	// IMP=0x000000010002bbfc
- (void).cxx_destruct;	// IMP=0x0000000100025c50
...
- (void)handleRequest:(id)arg1 onConnection:(id)arg2;	// IMP=0x00000001000258e8
- (void)startXPCListener;	// IMP=0x00000001000255b0
- (void)registerHandlerFunctions;	// IMP=0x0000000100024168
- (void)registerHandlerFunction:(CDUnknownFunctionPointerType)arg1 type:(unsigned long long)arg2 allowedEntitlementGroup:(id)arg3;	// IMP=0x0000000100023d30
- (id)initInternal;	// IMP=0x0000000100023968
