...
- (void).cxx_destruct;	// IMP=0x000000010009c058
...
- (id)initDTLSWithQueue:(id)arg1 server:(_Bool)arg2 delegate:(id)arg3;	// IMP=0x000000010009baf0
- (void)startDTLS;	// IMP=0x000000010009b624
- (void)handleIsReady;	// IMP=0x000000010009b590
- (void)readOnDTLSConnection;	// IMP=0x000000010009b488
- (void)readOnUDPConnection;	// IMP=0x000000010009b380
- (void)retransmitOutboundEncryptedData:(id)arg1 retransmitCount:(unsigned int)arg2;	// IMP=0x000000010009b290
- (void)processInboundEncryptedData:(id)arg1;	// IMP=0x000000010009b16c
- (void)processOutboundUnencryptedData:(id)arg1;	// IMP=0x000000010009b05c
- (id)description;	// IMP=0x000000010009afc8
