...
- (void)addToProhibited:(id)arg1;	// IMP=0x000000010006dc24
- (_Bool)handlePathUpdate:(id)arg1;	// IMP=0x000000010006d948
- (id)initWithInstance:(id)arg1 interface:(unsigned int)arg2;	// IMP=0x000000010006cfa4
- (_Bool)setupLocalAddress;	// IMP=0x000000010006cf94
- (_Bool)setupLocalAddressCheckAgainst:(const struct in6_addr *)arg1;	// IMP=0x000000010006c8fc
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010006c880
- (id)description;	// IMP=0x000000010006c7f4
- (void)readPackets;	// IMP=0x000000010006bc9c
- (void)dealloc;	// IMP=0x000000010006bc20
- (void)sendPacket:(struct iovec *)arg1 iovLen:(unsigned int)arg2 toAddr:(const struct in6_addr *)arg3;	// IMP=0x000000010006ba10
