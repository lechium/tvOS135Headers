...
- (void).cxx_destruct;	// IMP=0x000000010004a818
...
- (void)attemptPairingUsingOutOfBandKey:(id)arg1 completionBlock:(CDUnknownBlockType)arg2;	// IMP=0x0000000100048b60
- (void)setPacketReceiver:(id)arg1;	// IMP=0x0000000100048904
- (_Bool)sendPacketData:(id)arg1;	// IMP=0x00000001000487bc
- (void)requestConfigurationForListener:(id)arg1 session:(id)arg2 sessionConfig:(id)arg3 childConfig:(id)arg4 validateAuthBlock:(CDUnknownBlockType)arg5 responseBlock:(CDUnknownBlockType)arg6;	// IMP=0x0000000100047898
- (id)respondToIKESession:(id)arg1 dataProtectionClass:(unsigned char)arg2 validateAuthBlock:(CDUnknownBlockType)arg3;	// IMP=0x0000000100047470
- (void)listener:(id)arg1 receivedNewSession:(id)arg2;	// IMP=0x0000000100047374
- (_Bool)setupIPsec;	// IMP=0x0000000100047148
- (void)restartIKESessionForDataProtectionClass:(unsigned char)arg1;	// IMP=0x0000000100046f80
- (void)scheduleIKESessionClassADueToConnectFailure;	// IMP=0x0000000100046d5c
- (void)restartIKESessionClassA;	// IMP=0x0000000100046d4c
- (void)restartIKESessionClassC;	// IMP=0x0000000100046d3c
- (void)restartIKESessionClassD;	// IMP=0x0000000100046d2c
- (void)setupIPsecInitiatorIfNecessary:(unsigned char)arg1;	// IMP=0x0000000100046660
- (void)setupIPsecForPairingInitiatorIfNecessary;	// IMP=0x0000000100046398
- (void)setupIKECallbacksPairing;	// IMP=0x0000000100045f34
- (void)sendlocalPublicClassAKeysEncryptedWithIDS;	// IMP=0x0000000100045ce8
- (void)sendlocalPublicClassCKeysEncryptedWithIDS;	// IMP=0x0000000100045a9c
- (void)setupIKECallbacksClassA;	// IMP=0x0000000100045a8c
- (void)setupIKECallbacksClassC;	// IMP=0x0000000100045a7c
- (void)setupIKECallbacksClassD;	// IMP=0x0000000100045a6c
- (void)setupIKECallbacks:(unsigned char)arg1;	// IMP=0x00000001000454b8
- (void)reportRegistrationFailureIfNeededWithFailureCode:(long long)arg1 errorDescription:(id)arg2;	// IMP=0x000000010004549c
- (void)handleNotifyCode:(unsigned short)arg1 payload:(id)arg2;	// IMP=0x0000000100043d38
- (void)sendNotifyPayload;	// IMP=0x0000000100043d34
- (_Bool)sendAlwaysOnWiFiUpdate;	// IMP=0x0000000100043b24
- (id)copyNotifyPayloadsToSendWithProxy:(_Bool)arg1;	// IMP=0x0000000100043394
- (_Bool)sendControlData:(id)arg1;	// IMP=0x0000000100043144
- (_Bool)handleIncomingIKEData:(id)arg1;	// IMP=0x0000000100042f04
- (_Bool)sendIKEData:(id)arg1;	// IMP=0x0000000100042bf8
- (void)handleRequestToActivateNexus:(id)arg1 fromFlow:(id)arg2;	// IMP=0x0000000100042bf4
- (void)acceptNewFlow:(id)arg1 fromNexus:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000100042b64
- (_Bool)appendEncapsulatedData:(id)arg1 type:(unsigned char)arg2;	// IMP=0x00000001000427f0
- (void)appendlinkOutgoingData:(id)arg1;	// IMP=0x0000000100042780
- (_Bool)sendData;	// IMP=0x0000000100042770
- (_Bool)sendDataWithCount:(unsigned int)arg1;	// IMP=0x0000000100042528
- (void)stopReadingPackets;	// IMP=0x0000000100042518
- (void)stopReadingPacketsWithCount:(unsigned int)arg1;	// IMP=0x0000000100042394
- (void)resumeReadingPackets;	// IMP=0x0000000100042384
- (void)resumeReadingPacketsWithCount:(unsigned int)arg1;	// IMP=0x00000001000421dc
- (unsigned long long)writeBytesToChannel:(const char *)arg1 length:(unsigned long long)arg2;	// IMP=0x0000000100041f94
- (void)readDataFromChannelWithIsUrgent:(_Bool)arg1;	// IMP=0x0000000100041d28
- (void)readIncomingData:(char *)arg1 length:(unsigned long long)arg2 isUrgentLink:(_Bool)arg3;	// IMP=0x0000000100041a8c
- (void)handleIncoming6LoWPANData:(const char *)arg1 tlvBufferLength:(unsigned short)arg2 length:(unsigned short)arg3 tlvType:(unsigned char)arg4;	// IMP=0x0000000100041740
- (void)handPacketToNexus:(id)arg1;	// IMP=0x0000000100041734
- (void)writePacketToNexusChannel:(id)arg1;	// IMP=0x0000000100041638
- (void)handleReadData:(_Bool)arg1;	// IMP=0x000000010003f26c
- (void)flushPipeWithReason:(id)arg1;	// IMP=0x000000010003f1d8
- (void)cleanupLinkReadBufferWithExtra:(unsigned int)arg1;	// IMP=0x000000010003f054
- (void)armLinkStatsTimer;	// IMP=0x000000010003ef34
- (_Bool)setupNexus;	// IMP=0x000000010003e9d4
- (void)checkProxyAgentWithForceUpdate:(_Bool)arg1;	// IMP=0x000000010003e908
- (void)addVirtualInterfaceRoutes;	// IMP=0x000000010003e730
- (void)handlePongSequenceNumber:(unsigned long long)arg1 receiveTime:(unsigned long long)arg2;	// IMP=0x000000010003e390
- (void)measureLatencyWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000010003df68
- (void)updateDatagramPipe:(id)arg1;	// IMP=0x000000010003d59c
- (void)updateUrgentPipe:(id)arg1;	// IMP=0x000000010003cbfc
- (void)cleanupUrgentPipeState;	// IMP=0x000000010003c8f8
- (_Bool)setQosMarkingEnabled;	// IMP=0x000000010003c628
- (_Bool)setMPKLLoggingWithEnabled:(_Bool)arg1;	// IMP=0x000000010003c3e0
- (_Bool)setupNexusChannelVoice:(id)arg1;	// IMP=0x000000010003bd90
- (_Bool)setupNexusChannelBestEffort:(id)arg1;	// IMP=0x000000010003b740
- (_Bool)setupNexusChannelBackground:(id)arg1;	// IMP=0x000000010003b0f0
- (_Bool)setupNexusChannelVideo:(id)arg1;	// IMP=0x000000010003aaa0
- (_Bool)validateChannelAttributes:(struct channel_attr *)arg1;	// IMP=0x0000000100039fe0
- (_Bool)setupNexusChannel;	// IMP=0x0000000100039d6c
- (void)pipeDidDisconnect;	// IMP=0x0000000100039d58
- (_Bool)resume;	// IMP=0x0000000100039c5c
- (_Bool)suspend;	// IMP=0x0000000100039af0
- (_Bool)cancelBecausePipeDisconnected;	// IMP=0x0000000100039980
- (_Bool)cancelWithReason:(id)arg1;	// IMP=0x0000000100039430
- (unsigned short)metric;	// IMP=0x0000000100039428
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x0000000100039250
- (void)refreshCompanionProxyAgent;	// IMP=0x00000001000391c8
- (void)dealloc;	// IMP=0x000000010003912c
- (void)invalidateLink;	// IMP=0x0000000100038d1c
- (void)invalidateNexusChannels;	// IMP=0x0000000100038720
- (void)invalidateIKESessionClassA;	// IMP=0x0000000100038710
- (void)invalidateIKESessionClassC;	// IMP=0x0000000100038700
- (void)invalidateIKESessionClassD;	// IMP=0x00000001000386f0
- (id *)ikeSessionPointerForDataProtectionClass:(unsigned char)arg1;	// IMP=0x0000000100038598
- (void)invalidateIKESessionForClass:(unsigned char)arg1;	// IMP=0x000000010003852c
- (_Bool)start;	// IMP=0x0000000100036a14
- (id)copyShortDescriptionInner;	// IMP=0x0000000100036924
- (id)copyDescriptionInner;	// IMP=0x00000001000367a0
- (id)initLinkWithQueue:(id)arg1 linkDelegate:(id)arg2 nrUUID:(id)arg3 pipe:(id)arg4 remoteDeviceName:(id)arg5;	// IMP=0x000000010003622c
@property(readonly, nonatomic) _Bool hasValidPipe;
- (id)copyStatusString;	// IMP=0x0000000100034e44
