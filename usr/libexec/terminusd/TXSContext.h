...
- (void).cxx_destruct;	// IMP=0x00000001000237a8
...
- (id)copyClientDescription;	// IMP=0x0000000100023650
- (id)initWithRequest:(id)arg1 onConnection:(id)arg2;	// IMP=0x00000001000233a4
