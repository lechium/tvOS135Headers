...
- (void).cxx_destruct;	// IMP=0x000000010008d478
...
- (void)checkEnabledDevices;	// IMP=0x000000010008d0a0
- (void)linkDidReceiveData:(id)arg1 data:(id)arg2;	// IMP=0x000000010008cf1c
- (void)linkIsUnavailable:(id)arg1;	// IMP=0x000000010008cd60
- (void)linkIsSuspended:(id)arg1;	// IMP=0x000000010008cbe0
- (void)linkIsReady:(id)arg1;	// IMP=0x000000010008ca60
- (void)linkIsAvailable:(id)arg1;	// IMP=0x000000010008c8a4
- (void)setup;	// IMP=0x000000010008c628
- (id)createFixedInterfaceLinkForNRUUID:(id)arg1;	// IMP=0x000000010008c4d4
- (id)copyStatusString;	// IMP=0x000000010008c2d4
- (id)copyName;	// IMP=0x000000010008c2c8
- (void)dealloc;	// IMP=0x000000010008c22c
- (void)invalidateManager;	// IMP=0x000000010008c1f8
- (void)cancel;	// IMP=0x000000010008bf68
- (id)initManagerWithQueue:(id)arg1 managerDelegate:(id)arg2 fixedInterfaceName:(id)arg3 peerEndpoint:(id)arg4;	// IMP=0x000000010008bd74
