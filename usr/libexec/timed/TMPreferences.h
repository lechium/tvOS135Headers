...
- (id)description;	// IMP=0x00000001000155a8
- (id)defaultNTPServer;	// IMP=0x0000000100015574
- (void)registerDefaults;	// IMP=0x0000000100014fc4
- (void)setAccurateThresholds:(_Bool)arg1;	// IMP=0x0000000100014d40
...
- (id)init;	// IMP=0x0000000100014c34
- (id)initWithDefaults:(id)arg1;	// IMP=0x0000000100014b9c
- (void)dealloc;	// IMP=0x0000000100014b54
