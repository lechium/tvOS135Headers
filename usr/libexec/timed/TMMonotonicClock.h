...
- (_Bool)isMachTimeValid:(unsigned long long)arg1;	// IMP=0x000000010000fc58
...
- (void)montonicTimeForMachTime:(unsigned long long)arg1 toQueue:(id)arg2 withCompletionHandler:(CDUnknownBlockType)arg3;	// IMP=0x000000010000f484
- (void)dealloc;	// IMP=0x000000010000f43c
- (id)initWithSyncInterval:(double)arg1;	// IMP=0x000000010000f388
- (id)init;	// IMP=0x000000010000f2f8
