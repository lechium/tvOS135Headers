...
- (double)intervalRemaining;	// IMP=0x00000001000121e0
- (void)setWantedTime:(double)arg1;	// IMP=0x0000000100011ed0
- (void)dealloc;	// IMP=0x0000000100011e5c
- (void)fetchTime;	// IMP=0x0000000100011df8
- (void)retry;	// IMP=0x0000000100011c9c
- (void)_fetchTime;	// IMP=0x00000001000110b0
- (void)_executeNTPJob:(id)arg1;	// IMP=0x0000000100010e18
- (void)waitForNetworkBeyondWantedThreshold;	// IMP=0x00000001000109b4
