...
- (void).cxx_destruct;	// IMP=0x00000001000023f4
...
- (void)recordBytes:(unsigned long long)arg1 bundleID:(id)arg2;	// IMP=0x0000000100002278
- (void)deleteMetrics;	// IMP=0x000000010000219c
- (void)saveMetrics;	// IMP=0x0000000100001f4c
- (void)readMetrics;	// IMP=0x0000000100001c60
- (id)initWithStageURL:(id)arg1 reportHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000001000019c4
