...
+ (id)readSDKDictionary:(id)arg1;	// IMP=0x000000010001a770
- (void).cxx_destruct;	// IMP=0x000000010001d2c0
...
- (id)description;	// IMP=0x000000010001cfd8
- (id)_localizedFileProviderActionNamesForPKDict:(id)arg1 fromBundle:(id)arg2;	// IMP=0x000000010001cd80
- (void)_loadLocalizedNames;	// IMP=0x000000010001ca34
- (_Bool)useBundle:(id)arg1 error:(id *)arg2;	// IMP=0x000000010001ca2c
...
- (void)localizedInfoDictionaryForKeys:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000010001c1ec
- (id)augmentInterface:(id)arg1;	// IMP=0x000000010001c1e4
- (id)attribute:(id)arg1;	// IMP=0x000000010001c164
- (id)pluginKey:(id)arg1;	// IMP=0x000000010001c0e4
- (id)infoKey:(id)arg1;	// IMP=0x000000010001c028
...
- (id)embeddedProtocolSpec;	// IMP=0x000000010001be10
- (id)embeddedCodePath;	// IMP=0x000000010001be08
...
- (void)setAnnotation:(id)arg1 value:(id)arg2;	// IMP=0x000000010001ba50
- (void)updateFromForm:(id)arg1;	// IMP=0x000000010001b9f0
- (id)diagnose;	// IMP=0x000000010001b7b8
- (id)export:(id *)arg1;	// IMP=0x000000010001b1b0
- (id)mergeSharedResources:(id)arg1 into:(id)arg2;	// IMP=0x000000010001b124
- (id)sdkOnlyKeyPaths;	// IMP=0x000000010001afc4
- (id)mergeSDKDictionary:(id)arg1 intoExtensionDictionary:(id)arg2;	// IMP=0x000000010001aca8
- (id)resolveSDKWithInfoPlist:(id)arg1 extensionPointCache:(id)arg2;	// IMP=0x000000010001ab38
- (id)sdkDictionaryWithInfoPlist:(id)arg1 extensionPointCache:(id)arg2;	// IMP=0x000000010001a984
- (void)canonicalize;	// IMP=0x000000010001a5f0
- (_Bool)setupWithForm:(id)arg1;	// IMP=0x000000010001a088
- (id)normalizeInfoDictionary:(id)arg1;	// IMP=0x000000010001a070
- (_Bool)setDictionaries:(id)arg1;	// IMP=0x0000000100019dc8
- (_Bool)setupWithName:(id)arg1 url:(id)arg2 bundleInfo:(id)arg3 uuid:(id)arg4 discoveryInstanceUUID:(id)arg5 extensionPointCache:(id)arg6;	// IMP=0x0000000100019af4
- (unsigned long long)hash;	// IMP=0x0000000100019a80
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001000199a0
- (id)initWithForm:(id)arg1;	// IMP=0x0000000100019930
- (id)initWithName:(id)arg1 url:(id)arg2 bundleInfo:(id)arg3 uuid:(id)arg4 discoveryInstanceUUID:(id)arg5 extensionPointCache:(id)arg6;	// IMP=0x000000010001981c
- (id)init;	// IMP=0x00000001000197e8
