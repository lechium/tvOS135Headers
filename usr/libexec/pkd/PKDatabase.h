...
- (void)pluginsWillUninstall:(id)arg1;	// IMP=0x0000000100014610
- (void)pluginsDidInstall:(id)arg1;	// IMP=0x000000010001431c
- (void)autoElect:(id)arg1;	// IMP=0x000000010001416c
- (void)notifyAnnotationChange;	// IMP=0x00000001000140f0
- (id)setAnnotation:(id)arg1 forPlugIn:(id)arg2;	// IMP=0x0000000100013fbc
- (id)annotationForPlugIn:(id)arg1;	// IMP=0x0000000100013e20
- (id)removePlugIn:(id)arg1;	// IMP=0x0000000100013c98
- (id)addPlugIn:(id)arg1;	// IMP=0x0000000100013b10
- (id)plugInsWithinApplication:(id)arg1;	// IMP=0x000000010001386c
- (id)findPlugInAtPath:(id)arg1;	// IMP=0x000000010001377c
- (id)findPlugIn:(id)arg1;	// IMP=0x00000001000133c4
- (id)findPlugIns:(id)arg1 discoveryInstanceUUID:(id)arg2;	// IMP=0x00000001000123ac
- (void)purgeCachesToLimit:(long long)arg1;	// IMP=0x0000000100012220
- (id)createPlugInForProxy:(id)arg1 knowledgeUUID:(id)arg2 discoveryInstanceUUID:(id)arg3 extensionPointCache:(id)arg4;	// IMP=0x0000000100011fd8
- (id)plugInForProxy:(id)arg1 knowledgeUUID:(id)arg2 discoveryInstanceUUID:(id)arg3 extensionPointCache:(id)arg4;	// IMP=0x0000000100011b80
- (id)initWithDatabase:(const char *)arg1;	// IMP=0x0000000100011810
