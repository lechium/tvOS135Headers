...
- (void).cxx_destruct;	// IMP=0x00000001000181c8
...
- (id)description;	// IMP=0x000000010001803c
- (unsigned long long)hash;	// IMP=0x0000000100017ff0
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100017f30
- (id)initWithPlugIns:(id)arg1 forClient:(id)arg2;	// IMP=0x0000000100017db8
