...
+ (id)sharedInstance;	// IMP=0x0000000100046a3c
- (void).cxx_destruct;	// IMP=0x0000000100048f70
...
- (void)URLSession:(id)arg1 task:(id)arg2 didReceiveChallenge:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x0000000100048b78
- (void)URLSession:(id)arg1 task:(id)arg2 didCompleteWithError:(id)arg3;	// IMP=0x0000000100048744
- (void)URLSession:(id)arg1 dataTask:(id)arg2 didReceiveData:(id)arg3;	// IMP=0x0000000100048328
- (void)URLSession:(id)arg1 dataTask:(id)arg2 didReceiveResponse:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x00000001000480e4
- (void)invalidate;	// IMP=0x00000001000480a4
- (_Bool)directDownload:(id)arg1 withCredential:(id)arg2 to:(id)arg3 error:(id *)arg4 retry:(long long)arg5;	// IMP=0x0000000100047050
- (id)init;	// IMP=0x0000000100046aa8
