...
+ (id)sharedInstance;	// IMP=0x0000000100005984
...
- (void)processCoreDuetCallBack;	// IMP=0x0000000100006138
- (void)startPowerForegroundAppMonitoring;	// IMP=0x0000000100005e08
- (void)monitorDiskSpace;	// IMP=0x0000000100005ce4
- (void)startSystemIdleDetection;	// IMP=0x0000000100005b10
- (void)stopSystemIdleDetection;	// IMP=0x00000001000059f0
