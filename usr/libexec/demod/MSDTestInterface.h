...
+ (id)sharedInstance;	// IMP=0x00000001000043e0
- (void).cxx_destruct;	// IMP=0x000000010000508c
...
- (id)sanitizeTestLog:(id)arg1;	// IMP=0x0000000100004ee0
- (void)pushTestLog:(id)arg1;	// IMP=0x0000000100004e48
- (void)sendCommandsToDemod:(id)arg1 replyFromDemod:(CDUnknownBlockType)arg2;	// IMP=0x0000000100004b70
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x00000001000048f0
- (void)sendTestEvents:(id)arg1;	// IMP=0x00000001000047b4
- (void)pushTestEvent:(id)arg1 ofType:(id)arg2;	// IMP=0x00000001000046e4
- (id)getTimeStamp;	// IMP=0x0000000100004688
- (void)start;	// IMP=0x0000000100004464
