...
+ (id)sharedInstance;	// IMP=0x0000000100049bc8
- (void).cxx_destruct;	// IMP=0x000000010004b80c
...
- (_Bool)compareSavedHubHostsWithNewHosts;	// IMP=0x000000010004b3a8
- (_Bool)compareSavedHubHostNameWithNewHostName;	// IMP=0x000000010004b114
- (_Bool)enrollAndSetup:(id *)arg1;	// IMP=0x000000010004ab2c
- (_Bool)askFindMyHubForHubInfoAndDeviceOptions;	// IMP=0x000000010004a03c
- (unsigned long long)queryFindMyHubAndDetermineLogicSyncResult;	// IMP=0x0000000100049d38
- (_Bool)discoverAndEnrollWithHub:(id *)arg1;	// IMP=0x0000000100049c78
