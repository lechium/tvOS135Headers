...
- (void).cxx_destruct;	// IMP=0x0000000100022204
...
- (_Bool)restoreAllAttributesFromManifest;	// IMP=0x0000000100021f94
- (_Bool)processAlreadyHaveList:(id)arg1;	// IMP=0x0000000100021720
- (_Bool)downloadAndVerifyFile:(id)arg1 to:(id)arg2 withError:(id *)arg3;	// IMP=0x0000000100021204
- (_Bool)downloadCreationList:(id)arg1;	// IMP=0x00000001000207a8
- (_Bool)processCreationList:(id)arg1;	// IMP=0x000000010001f770
- (_Bool)verify;	// IMP=0x000000010001efcc
- (_Bool)process:(id *)arg1;	// IMP=0x000000010001eb18
- (id)initWithMasterManifest:(id)arg1 andDeviceManifest:(id)arg2 forSection:(id)arg3;	// IMP=0x000000010001e5f8
