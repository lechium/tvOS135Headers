...
+ (id)contentServerConnection:(id)arg1 port:(id)arg2;	// IMP=0x0000000100042fa0
- (void).cxx_destruct;	// IMP=0x0000000100046938
...
- (void)URLSession:(id)arg1 task:(id)arg2 willPerformHTTPRedirection:(id)arg3 newRequest:(id)arg4 completionHandler:(CDUnknownBlockType)arg5;	// IMP=0x0000000100046574
- (void)URLSession:(id)arg1 dataTask:(id)arg2 didReceiveData:(id)arg3;	// IMP=0x00000001000460d4
- (void)URLSession:(id)arg1 dataTask:(id)arg2 didReceiveResponse:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x0000000100045de4
- (void)URLSession:(id)arg1 task:(id)arg2 didCompleteWithError:(id)arg3;	// IMP=0x0000000100045630
- (void)URLSession:(id)arg1 task:(id)arg2 didReceiveChallenge:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x00000001000452c8
- (_Bool)addAuthenticationHeadersToRequest:(id)arg1 withBody:(id)arg2 error:(id *)arg3;	// IMP=0x0000000100045018
- (void)cancelDownloading;	// IMP=0x0000000100044cc4
- (void)runRunLoopUntilDone;	// IMP=0x0000000100044c88
- (_Bool)startDownloadingFile;	// IMP=0x0000000100043f60
- (void)invalidate;	// IMP=0x0000000100043f20
- (void)enableAuthenticationWithHMACKey:(id)arg1;	// IMP=0x0000000100043f14
- (_Bool)downloadTo:(id)arg1 byPosting:(id)arg2 toPath:(id)arg3 retry:(int)arg4 error:(id *)arg5;	// IMP=0x0000000100043c24
- (id)postDataForEnrolment:(id)arg1 to:(id)arg2 retry:(int)arg3 error:(id *)arg4;	// IMP=0x0000000100043b34
- (id)postData:(id)arg1 to:(id)arg2 retry:(int)arg3 error:(id *)arg4;	// IMP=0x00000001000439d0
- (_Bool)downloadFile:(id)arg1 to:(id)arg2 retry:(long long)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x0000000100043564
- (id)downloadFileToNSData:(id)arg1 retry:(long long)arg2 error:(id *)arg3;	// IMP=0x0000000100043420
- (void)dealloc;	// IMP=0x00000001000432e0
- (void)setupServer:(id)arg1 port:(id)arg2;	// IMP=0x0000000100043268
- (id)initWithCellularAccess:(_Bool)arg1;	// IMP=0x0000000100043034
