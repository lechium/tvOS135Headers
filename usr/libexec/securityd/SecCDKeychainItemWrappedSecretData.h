...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000100038194
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000001000380b0
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000100037e50
- (id)initWithCiphertext:(id)arg1 wrappedKeyData:(id)arg2 refKeyBlob:(id)arg3;	// IMP=0x0000000100037d60
