...
+ (id)loadAllFromKeychain:(id *)arg1;	// IMP=0x0000000100110acc
+ (id)loadFromKeychain:(id)arg1 error:(id *)arg2;	// IMP=0x0000000100110740
- (void).cxx_destruct;	// IMP=0x0000000100178afc
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000001001788ac
- (unsigned long long)hash;	// IMP=0x0000000100178758
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010017853c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000100178374
- (void)copyTo:(id)arg1;	// IMP=0x00000001001781f0
- (void)writeTo:(id)arg1;	// IMP=0x0000000100178090
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000100177a88
- (id)dictionaryRepresentation;	// IMP=0x00000001001777d4
- (id)description;	// IMP=0x0000000100177720
...
- (_Bool)deleteFromKeychain:(id *)arg1;	// IMP=0x000000010011043c
- (_Bool)saveToKeychain:(id *)arg1;	// IMP=0x000000010010fdc4
- (_Bool)escrowAttemptedWithinLastSeconds:(double)arg1;	// IMP=0x000000010011068c
