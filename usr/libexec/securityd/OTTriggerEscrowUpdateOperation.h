...
- (void).cxx_destruct;	// IMP=0x00000001000561a4
...
- (void)groupStart;	// IMP=0x0000000100055d38
- (id)initWithDependencies:(id)arg1 intendedState:(id)arg2 errorState:(id)arg3;	// IMP=0x0000000100055c50
