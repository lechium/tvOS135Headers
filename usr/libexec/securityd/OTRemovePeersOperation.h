...
- (void).cxx_destruct;	// IMP=0x000000010011b864
...
- (void)groupStart;	// IMP=0x000000010011b500
- (id)initWithDependencies:(id)arg1 intendedState:(id)arg2 errorState:(id)arg3 peerIDs:(id)arg4;	// IMP=0x000000010011b3c0
