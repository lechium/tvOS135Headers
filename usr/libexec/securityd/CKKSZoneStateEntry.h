...
+ (id)fromDatabaseRow:(id)arg1;	// IMP=0x000000010006f0b8
+ (id)sqlColumns;	// IMP=0x000000010006eff0
+ (id)sqlTable;	// IMP=0x000000010006efe4
+ (id)tryFromDatabase:(id)arg1 error:(id *)arg2;	// IMP=0x000000010006eebc
+ (id)fromDatabase:(id)arg1 error:(id *)arg2;	// IMP=0x000000010006ed94
+ (id)state:(id)arg1;	// IMP=0x000000010006ec34
- (void).cxx_destruct;	// IMP=0x000000010006ebcc
...
- (id)sqlValues;	// IMP=0x000000010006e6b8
- (id)whereClauseToFindSelf;	// IMP=0x000000010006e60c
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010006de58
- (id)initWithCKZone:(id)arg1 zoneCreated:(_Bool)arg2 zoneSubscribed:(_Bool)arg3 changeToken:(id)arg4 moreRecordsInCloudKit:(_Bool)arg5 lastFetch:(id)arg6 lastFixup:(unsigned long long)arg7 encodedRateLimiter:(id)arg8;	// IMP=0x000000010006dce0
