...
- (void).cxx_destruct;	// IMP=0x00000001001b3168
...
- (id)initWithDefaults:(id)arg1 dateDescription:(id)arg2 earliest:(double)arg3 latest:(double)arg4;	// IMP=0x00000001001b303c
- (void)schedule;	// IMP=0x00000001001b2ff0
- (void)followup;	// IMP=0x00000001001b2fa8
- (_Bool)checkDate;	// IMP=0x00000001001b2f44
- (id)getDate;	// IMP=0x00000001001b2f30
