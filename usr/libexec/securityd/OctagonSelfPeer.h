...
- (void).cxx_destruct;	// IMP=0x000000010004100c
...
- (_Bool)matchesPeer:(id)arg1;	// IMP=0x0000000100040f2c
...
- (id)initWithPeerID:(id)arg1 signingIdentity:(id)arg2 encryptionIdentity:(id)arg3;	// IMP=0x0000000100040c98
