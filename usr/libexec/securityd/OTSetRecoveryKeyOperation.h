...
- (void).cxx_destruct;	// IMP=0x000000010008c2dc
...
- (void)proceedWithKeys:(id)arg1 salt:(id)arg2;	// IMP=0x000000010008bfd0
- (void)groupStart;	// IMP=0x000000010008baf0
- (id)initWithDependencies:(id)arg1 recoveryKey:(id)arg2;	// IMP=0x000000010008ba3c
