...
- (void).cxx_destruct;	// IMP=0x0000000100168e48
...
- (void)rpcVoucher:(id)arg1 peerID:(id)arg2 permanentInfo:(id)arg3 permanentInfoSig:(id)arg4 stableInfo:(id)arg5 stableInfoSig:(id)arg6 reply:(CDUnknownBlockType)arg7;	// IMP=0x00000001001689ec
- (void)rpcEpoch:(id)arg1 reply:(CDUnknownBlockType)arg2;	// IMP=0x00000001001686b4
- (void)notifyContainerChange;	// IMP=0x0000000100168510
- (id)_onqueueNextClientStateMachineTransition:(id)arg1;	// IMP=0x0000000100168098
- (_Bool)isAcceptorWaitingForFirstMessage;	// IMP=0x0000000100167fe4
- (void)handleExternalClientStateMachineRequest:(id)arg1 client:(id)arg2;	// IMP=0x0000000100167f04
- (void)_onqueueStartNextClientStateMachineOperation:(id)arg1;	// IMP=0x0000000100167cac
- (void)_onqueuePokeClientStateMachine:(id)arg1;	// IMP=0x0000000100167c18
- (id)createOperationToFinishAttemptForClient:(id)arg1 clientName:(id)arg2;	// IMP=0x0000000100167a84
- (void)startOctagonStateMachine;	// IMP=0x0000000100167a08
@property(retain) NSString<OctagonStateString> *currentState;
- (void)dealloc;	// IMP=0x00000001001678ac
- (id)initWithContainerName:(id)arg1 contextID:(id)arg2 clientName:(id)arg3 cuttlefish:(id)arg4;	// IMP=0x000000010016756c
