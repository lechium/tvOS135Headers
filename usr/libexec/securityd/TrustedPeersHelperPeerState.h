...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000001001666a4
- (void).cxx_destruct;	// IMP=0x0000000100166674
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000010016649c
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000100166334
- (id)description;	// IMP=0x0000000100166200
- (id)initWithPeerID:(id)arg1 isPreapproved:(_Bool)arg2 status:(unsigned long long)arg3 memberChanges:(_Bool)arg4 unknownMachineIDs:(_Bool)arg5 osVersion:(id)arg6;	// IMP=0x000000010016612c
