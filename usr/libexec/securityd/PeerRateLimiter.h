...
- (void).cxx_destruct;	// IMP=0x00000001001cf648
...
- (int)stateForAccessGroup:(id)arg1;	// IMP=0x00000001001cf4cc
- (id)initWithPeer:(struct __OpaqueSOSPeer *)arg1;	// IMP=0x00000001001cf3c0
- (id)setUpConfigForPeer;	// IMP=0x00000001001cf33c
