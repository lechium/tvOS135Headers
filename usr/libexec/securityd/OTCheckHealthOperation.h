...
- (void).cxx_destruct;	// IMP=0x00000001000431c4
...
- (void)handleRepairSuggestions:(_Bool)arg1 postEscrowCFU:(_Bool)arg2 resetOctagon:(_Bool)arg3 leaveTrust:(_Bool)arg4;	// IMP=0x0000000100042e64
- (void)groupStart;	// IMP=0x000000010004242c
- (_Bool)checkIfPasscodeIsSetForDevice;	// IMP=0x0000000100042400
- (id)initWithDependencies:(id)arg1 intendedState:(id)arg2 errorState:(id)arg3 deviceInfo:(id)arg4 skipRateLimitedCheck:(_Bool)arg5;	// IMP=0x00000001000422d8
