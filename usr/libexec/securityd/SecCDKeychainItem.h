...
- (void).cxx_destruct;	// IMP=0x000000010003edec
...
- (id)secretsFromEncryptedData:(id)arg1 withKeybag:(int)arg2 error:(id *)arg3;	// IMP=0x000000010003e8a8
- (id)encryptedSecretDataWithAttributeData:(id)arg1 keybag:(int)arg2 error:(id *)arg3;	// IMP=0x000000010003e1bc
- (id)primaryKeyStringRepresentationWithError:(id *)arg1;	// IMP=0x000000010003dde4
- (id)primaryKeys;	// IMP=0x000000010003ddd4
...
- (id)description;	// IMP=0x000000010003dc00
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010003db10
- (id)initWithManagedItem:(id)arg1 keychain:(id)arg2 error:(id *)arg3;	// IMP=0x000000010003d808
- (id)initItemType:(id)arg1 withPersistentID:(id)arg2 attributes:(id)arg3 lookupAttributes:(id)arg4 secrets:(id)arg5 owner:(id)arg6 keyclass:(int)arg7;	// IMP=0x000000010003d6a0
