...
- (void).cxx_destruct;	// IMP=0x000000010019a73c
...
- (void)requestSyncWithPeers:(id)arg1;	// IMP=0x000000010019a5b0
- (void)requestSyncWith:(id)arg1;	// IMP=0x000000010019a4e8
- (void)finish;	// IMP=0x00000001001981ec
- (void)restart;	// IMP=0x00000001001981b8
- (void)start;	// IMP=0x0000000100197d90
- (id)initWithAccount:(id)arg1 quiet:(_Bool)arg2;	// IMP=0x0000000100197cfc
@property(readonly) NSString *description;
- (void)updateSOSCircleCachedStatus;	// IMP=0x0000000100197a28
- (unsigned long long)currentTrustBitmask;	// IMP=0x0000000100197920
