...
- (void).cxx_destruct;	// IMP=0x0000000100090d04
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000100090b8c
- (unsigned long long)hash;	// IMP=0x0000000100090ad0
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010009096c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000100090840
- (void)copyTo:(id)arg1;	// IMP=0x0000000100090768
- (void)writeTo:(id)arg1;	// IMP=0x00000001000906a4
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000001000903e0
- (id)dictionaryRepresentation;	// IMP=0x00000001000902a8
- (id)description;	// IMP=0x00000001000901f4
