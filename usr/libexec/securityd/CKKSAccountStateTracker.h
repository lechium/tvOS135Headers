...
+ (id)stringFromAccountStatus:(long long)arg1;	// IMP=0x0000000100035e6c
+ (id)getCircleStatus;	// IMP=0x0000000100035d48
+ (void)fetchCirclePeerID:(CDUnknownBlockType)arg1;	// IMP=0x0000000100035ca4
...
- (void)setHSA2iCloudAccountStatus:(long long)arg1;	// IMP=0x0000000100033d40
- (void)triggerOctagonStatusFetch;	// IMP=0x0000000100033b5c
- (id)checkForAllDeliveries;	// IMP=0x0000000100033a40
- (void)notifyCircleStatusChangeAndWaitForSignal;	// IMP=0x0000000100033a00
- (void)notifyCKAccountStatusChangeAndWaitForSignal;	// IMP=0x00000001000339c0
- (void)_onqueueDeliverCurrentCloudKitState:(id)arg1 listenerQueue:(id)arg2 oldStatus:(id)arg3 group:(id)arg4;	// IMP=0x000000010003387c
- (void)_onqueueDeliverCloudKitStateChanges:(id)arg1 dispatchGroup:(id)arg2;	// IMP=0x00000001000336c4
- (void)_onqueueUpdateAccountState:(id)arg1 dispatchGroup:(id)arg2;	// IMP=0x00000001000333d0
- (void)_onqueueUpdateAccountState:(id)arg1 deliveredSemaphore:(id)arg2;	// IMP=0x0000000100033248
- (void)_onqueueUpdateCirclePeerID:(id)arg1;	// IMP=0x0000000100033040
- (id)notifyCircleChange:(id)arg1;	// IMP=0x0000000100032f38
- (void)_onqueueUpdateCKDeviceID:(id)arg1;	// IMP=0x0000000100032d9c
- (id)notifyCKAccountStatusChange:(id)arg1;	// IMP=0x0000000100032c74
- (id)registerForNotificationsOfCloudKitAccountStatusChange:(id)arg1;	// IMP=0x0000000100032b80
@property(readonly, copy) NSString *debugDescription;
@property(readonly, copy) NSString *description;
- (id)descriptionInternal:(id)arg1;	// IMP=0x00000001000329c4
- (void)dealloc;	// IMP=0x0000000100032948
- (void)performInitialDispatches;	// IMP=0x00000001000328b8
- (id)init:(id)arg1 nsnotificationCenterClass:(Class)arg2;	// IMP=0x00000001000324e0
