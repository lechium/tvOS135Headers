...
+ (id)loadForZone:(id)arg1;	// IMP=0x0000000100084090
- (void).cxx_destruct;	// IMP=0x0000000100084000
...
- (id)asKeychainBackedSet:(id *)arg1;	// IMP=0x0000000100083ca4
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001000839f4
- (id)description;	// IMP=0x0000000100083768
- (id)initForZoneName:(id)arg1;	// IMP=0x00000001000836f0
