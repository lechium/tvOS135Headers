...
- (void).cxx_destruct;	// IMP=0x0000000100089b40
...
- (void)cancel;	// IMP=0x0000000100089990
- (void)_onqueueTrigger:(unsigned long long)arg1 maximumDelay:(unsigned long long)arg2;	// IMP=0x0000000100089430
- (void)trigger;	// IMP=0x0000000100089364
- (void)_onqueueTimerTick;	// IMP=0x0000000100089034
- (void)triggerAt:(unsigned long long)arg1;	// IMP=0x0000000100088f58
- (void)waitUntil:(unsigned long long)arg1;	// IMP=0x0000000100088ed0
@property(readonly) NSDate *nextFireTime;
- (id)description;	// IMP=0x0000000100088cec
- (id)makeOperationDependency;	// IMP=0x0000000100088c10
- (void)changeDelays:(unsigned long long)arg1 continuingDelay:(unsigned long long)arg2;	// IMP=0x0000000100088b80
- (id)initWithName:(id)arg1 initialDelay:(unsigned long long)arg2 expontialBackoff:(double)arg3 maximumDelay:(unsigned long long)arg4 keepProcessAlive:(_Bool)arg5 dependencyDescriptionCode:(long long)arg6 block:(CDUnknownBlockType)arg7;	// IMP=0x000000010008899c
- (id)initWithName:(id)arg1 initialDelay:(unsigned long long)arg2 continuingDelay:(unsigned long long)arg3 keepProcessAlive:(_Bool)arg4 dependencyDescriptionCode:(long long)arg5 block:(CDUnknownBlockType)arg6;	// IMP=0x00000001000888f4
- (id)initWithName:(id)arg1 delay:(unsigned long long)arg2 keepProcessAlive:(_Bool)arg3 dependencyDescriptionCode:(long long)arg4 block:(CDUnknownBlockType)arg5;	// IMP=0x0000000100088874
