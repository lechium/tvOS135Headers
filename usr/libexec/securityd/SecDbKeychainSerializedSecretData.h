...
- (void).cxx_destruct;	// IMP=0x000000010012818c
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000100128050
- (unsigned long long)hash;	// IMP=0x0000000100127fc4
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100127e98
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000100127d98
- (void)copyTo:(id)arg1;	// IMP=0x0000000100127cfc
- (void)writeTo:(id)arg1;	// IMP=0x0000000100127c70
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000100127a4c
- (id)dictionaryRepresentation;	// IMP=0x0000000100127970
- (id)description;	// IMP=0x00000001001278bc
