...
- (void).cxx_destruct;	// IMP=0x00000001000cd764
...
- (id)initWithData:(id)arg1;	// IMP=0x00000001000cd608
- (id)initRefKeyWrappedKeyWithData:(id)arg1 refKeyBlob:(id)arg2;	// IMP=0x00000001000cd530
- (id)initRegularWrappedKeyWithData:(id)arg1;	// IMP=0x00000001000cd48c
