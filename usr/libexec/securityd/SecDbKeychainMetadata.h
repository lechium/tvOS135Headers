...
- (void).cxx_destruct;	// IMP=0x00000001000cdd24
...
- (id)initWithData:(id)arg1;	// IMP=0x00000001000cd964
- (id)initWithCiphertext:(id)arg1 wrappedKey:(id)arg2 tamperCheck:(id)arg3 error:(id *)arg4;	// IMP=0x00000001000cd770
