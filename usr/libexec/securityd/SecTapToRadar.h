...
+ (_Bool)askUserIfTTR:(id)arg1;	// IMP=0x000000010001e5e4
+ (void)triggerTapToRadar:(id)arg1;	// IMP=0x000000010001e4d0
+ (void)disableTTRsEntirely;	// IMP=0x000000010001e4cc
+ (_Bool)isRateLimited:(id)arg1;	// IMP=0x000000010001e4c4
+ (id)keyname:(id)arg1;	// IMP=0x000000010001e444
...
- (void)trigger;	// IMP=0x000000010001e178
- (void)clearRetryTimestamp;	// IMP=0x000000010001e0f4
- (void)updateRetryTimestamp;	// IMP=0x000000010001e014
- (_Bool)isRateLimited;	// IMP=0x000000010001deec
- (id)initTapToRadar:(id)arg1 description:(id)arg2 radar:(id)arg3;	// IMP=0x000000010001dd80
