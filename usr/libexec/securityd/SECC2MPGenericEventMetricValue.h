...
- (void).cxx_destruct;	// IMP=0x0000000100070ee0
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000100070da4
- (unsigned long long)hash;	// IMP=0x0000000100070cb0
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100070b7c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000100070a7c
- (void)copyTo:(id)arg1;	// IMP=0x00000001000709c0
- (void)writeTo:(id)arg1;	// IMP=0x000000010007090c
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000100070904
- (id)dictionaryRepresentation;	// IMP=0x0000000100070798
- (id)description;	// IMP=0x00000001000706e4
