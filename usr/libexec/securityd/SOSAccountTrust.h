...
+ (id)trust;	// IMP=0x00000001001b99e0
- (void).cxx_destruct;	// IMP=0x00000001001b99a4
...
- (void)dealloc;	// IMP=0x00000001001b9768
- (id)initWithRetirees:(id)arg1 fpi:(struct __OpaqueSOSFullPeerInfo *)arg2 circle:(struct __OpaqueSOSCircle *)arg3 departureCode:(int)arg4 peerExpansion:(id)arg5;	// IMP=0x00000001001b9670
- (id)init;	// IMP=0x00000001001b9574
