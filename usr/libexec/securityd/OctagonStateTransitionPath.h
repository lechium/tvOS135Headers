...
+ (id)pathFromDictionary:(id)arg1;	// IMP=0x000000010009d90c
- (void).cxx_destruct;	// IMP=0x000000010009d8dc
...
- (id)asPathStep;	// IMP=0x000000010009d7a4
- (id)initWithState:(id)arg1 pathStep:(id)arg2;	// IMP=0x000000010009d700
