...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000010010ecf0
- (unsigned long long)hash;	// IMP=0x000000010010ec4c
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010010eb14
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010010ea10
- (void)copyTo:(id)arg1;	// IMP=0x000000010010e958
- (void)writeTo:(id)arg1;	// IMP=0x000000010010e8b0
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000010010e8a8
- (id)dictionaryRepresentation;	// IMP=0x000000010010e770
- (id)description;	// IMP=0x000000010010e6bc
