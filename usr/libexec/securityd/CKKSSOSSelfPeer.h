...
- (void).cxx_destruct;	// IMP=0x000000010008eb4c
...
- (_Bool)shouldHaveView:(id)arg1;	// IMP=0x000000010008ea8c
- (_Bool)matchesPeer:(id)arg1;	// IMP=0x000000010008e984
@property(readonly) NSString *peerID;
@property(readonly) _SFECPublicKey *publicSigningKey;
@property(readonly) _SFECPublicKey *publicEncryptionKey;
- (id)initWithSOSPeerID:(id)arg1 encryptionKey:(id)arg2 signingKey:(id)arg3 viewList:(id)arg4;	// IMP=0x000000010008e704
