...
- (void).cxx_destruct;	// IMP=0x000000010016f198
...
- (void)cancel;	// IMP=0x000000010016f028
- (void)holdFetchesUntil:(id)arg1;	// IMP=0x000000010016f01c
- (id)createSuccesfulFetchDependency;	// IMP=0x000000010016efb0
- (void)_onqueueCreateNewFetch;	// IMP=0x000000010016e84c
- (void)maybeCreateNewFetch;	// IMP=0x000000010016e7d0
- (void)maybeCreateNewFetchOnQueue;	// IMP=0x000000010016e640
- (id)requestSuccessfulFetchForManyReasons:(id)arg1;	// IMP=0x000000010016e510
- (id)requestFetchDueToAPNS:(id)arg1;	// IMP=0x000000010016e238
- (id)requestSuccessfulFetch:(id)arg1;	// IMP=0x000000010016e1d0
- (id)clients;	// IMP=0x000000010016e004
- (void)registerClient:(id)arg1;	// IMP=0x000000010016df28
- (id)description;	// IMP=0x000000010016ddb4
- (id)initWithContainer:(id)arg1 fetchClass:(Class)arg2 reachabilityTracker:(id)arg3;	// IMP=0x000000010016daa4
