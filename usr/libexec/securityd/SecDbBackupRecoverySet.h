...
- (void).cxx_destruct;	// IMP=0x0000000100081c7c
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000100081aec
- (unsigned long long)hash;	// IMP=0x0000000100081a30
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001000818cc
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001000817a0
- (void)copyTo:(id)arg1;	// IMP=0x00000001000816c8
- (void)writeTo:(id)arg1;	// IMP=0x0000000100081604
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000001000812e8
- (id)dictionaryRepresentation;	// IMP=0x000000010008118c
- (id)description;	// IMP=0x00000001000810d8
