...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000001001674b8
- (void).cxx_destruct;	// IMP=0x000000010016747c
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000100167280
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000100166ef0
- (id)description;	// IMP=0x0000000100166e7c
- (id)initWithEgoPeerID:(id)arg1 status:(unsigned long long)arg2 viablePeerCountsByModelID:(id)arg3 peerCountsByMachineID:(id)arg4 isExcluded:(_Bool)arg5 isLocked:(_Bool)arg6;	// IMP=0x0000000100166c7c
