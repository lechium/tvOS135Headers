...
- (void).cxx_destruct;	// IMP=0x000000010015ccf0
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000010015c32c
- (unsigned long long)hash;	// IMP=0x000000010015be04
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010015b674
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010015afb0
- (void)copyTo:(id)arg1;	// IMP=0x000000010015a970
- (void)writeTo:(id)arg1;	// IMP=0x000000010015a3d4
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000010015a3cc
- (id)dictionaryRepresentation;	// IMP=0x000000010015983c
- (id)description;	// IMP=0x0000000100159788
