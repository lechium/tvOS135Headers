...
- (void).cxx_destruct;	// IMP=0x00000001001446a8
...
- (id)fastStatus;	// IMP=0x0000000100143f04
- (id)status;	// IMP=0x0000000100143d10
- (void)halt;	// IMP=0x0000000100143cbc
- (void)cancelAllOperations;	// IMP=0x0000000100143b04
- (void)cancelPendingOperations;	// IMP=0x000000010014370c
- (void)waitForKeyHierarchyReadiness;	// IMP=0x000000010014368c
- (id)waitForFetchAndIncomingQueueProcessing;	// IMP=0x0000000100143644
- (_Bool)outgoingQueueEmpty:(id *)arg1;	// IMP=0x0000000100143598
- (void)trustedPeerSetChanged:(id)arg1;	// IMP=0x000000010014346c
- (void)selfPeerChanged:(id)arg1;	// IMP=0x0000000100143374
- (_Bool)shouldRetryAfterFetchError:(id)arg1;	// IMP=0x0000000100142fa8
- (_Bool)ckErrorOrPartialError:(id)arg1 isError:(long long)arg2;	// IMP=0x0000000100142d9c
- (void)changesFetched:(id)arg1 deletedRecordIDs:(id)arg2 newChangeToken:(id)arg3 moreComing:(_Bool)arg4 resync:(_Bool)arg5;	// IMP=0x0000000100142bcc
- (id)participateInFetch;	// IMP=0x0000000100142a7c
- (_Bool)_onQueueZoneIsReadyForFetching;	// IMP=0x0000000100142918
- (_Bool)zoneIsReadyForFetching;	// IMP=0x000000010014286c
- (void)endTrustedOperation;	// IMP=0x00000001001427c8
- (void)beginTrustedOperation:(id)arg1 suggestTLKUpload:(id)arg2;	// IMP=0x00000001001425dc
- (void)handleCKLogout;	// IMP=0x00000001001424e0
- (void)superHandleCKLogout;	// IMP=0x00000001001424ac
- (void)handleCKLogin;	// IMP=0x0000000100142280
- (void)superHandleCKLogin;	// IMP=0x000000010014224c
- (void)notifyZoneChange:(id)arg1;	// IMP=0x0000000100142118
- (void)dispatchSyncWithPeerProviders:(id)arg1 override:(_Bool)arg2 block:(CDUnknownBlockType)arg3;	// IMP=0x0000000100141df0
- (void)dispatchSyncWithAccountKeys:(CDUnknownBlockType)arg1;	// IMP=0x0000000100141d78
- (void)dispatchSync:(CDUnknownBlockType)arg1;	// IMP=0x0000000100141b78
- (_Bool)dispatchSyncWithConnection:(struct __OpaqueSecDbConnection *)arg1 block:(CDUnknownBlockType)arg2;	// IMP=0x00000001001419fc
- (_Bool)_onqueueWithAccountKeysWithPeers:(id)arg1 checkTLK:(id)arg2 error:(id *)arg3;	// IMP=0x0000000100140a78
- (_Bool)_onqueueWithAccountKeysCheckTLKFromShares:(id)arg1 error:(id *)arg2;	// IMP=0x0000000100140680
- (_Bool)_onqueueWithAccountKeysCheckTLK:(id)arg1 error:(id *)arg2;	// IMP=0x00000001001401a4
- (_Bool)_onqueueUpdateLatestManifestWithError:(id *)arg1;	// IMP=0x00000001001400d8
- (_Bool)_onqueueErrorOutgoingQueueEntry:(id)arg1 itemError:(id)arg2 error:(id *)arg3;	// IMP=0x000000010013fe90
- (_Bool)_onqueueChangeOutgoingQueueEntry:(id)arg1 toState:(id)arg2 error:(id *)arg3;	// IMP=0x000000010013f710
- (_Bool)_onqueueResetAllInflightOQE:(id *)arg1;	// IMP=0x000000010013f364
- (void)_onqueueCKRecordDeviceStateChanged:(id)arg1 resync:(_Bool)arg2;	// IMP=0x000000010013eedc
- (void)_onqueueCKRecordManifestLeafChanged:(id)arg1 resync:(_Bool)arg2;	// IMP=0x000000010013ecc8
- (void)_onqueueCKRecordManifestChanged:(id)arg1 resync:(_Bool)arg2;	// IMP=0x000000010013eab4
- (void)_onqueueCKRecordCurrentItemPointerChanged:(id)arg1 resync:(_Bool)arg2;	// IMP=0x000000010013e4c4
- (void)_onqueueCKRecordCurrentKeyPointerChanged:(id)arg1 resync:(_Bool)arg2;	// IMP=0x000000010013de90
- (void)_onqueueCKRecordTLKShareChanged:(id)arg1 resync:(_Bool)arg2;	// IMP=0x000000010013dce0
- (void)_onqueueCKRecordKeyChanged:(id)arg1 resync:(_Bool)arg2;	// IMP=0x000000010013d4dc
- (void)_onqueueCKRecordItemChanged:(id)arg1 resync:(_Bool)arg2;	// IMP=0x000000010013c820
- (_Bool)_onqueueCKRecordChanged:(id)arg1 resync:(_Bool)arg2;	// IMP=0x000000010013c380
- (_Bool)_onqueueCKRecordDeleted:(id)arg1 recordType:(id)arg2 resync:(_Bool)arg3;	// IMP=0x000000010013b58c
- (_Bool)_onqueueCKWriteFailed:(id)arg1 attemptedRecordsChanged:(id)arg2;	// IMP=0x000000010013a8cc
- (id)fetchAndProcessCKChangesDueToAPNS:(id)arg1;	// IMP=0x000000010013a6ec
- (id)fetchAndProcessCKChanges:(id)arg1 after:(id)arg2;	// IMP=0x000000010013a53c
- (id)fetchAndProcessCKChanges:(id)arg1;	// IMP=0x000000010013a52c
- (id)resyncLocal;	// IMP=0x000000010013a4d8
- (id)resyncWithCloud;	// IMP=0x000000010013a484
- (id)_onqueueCurrentDeviceStateEntry:(id *)arg1;	// IMP=0x00000001001391bc
- (id)updateDeviceState:(_Bool)arg1 waitForKeyHierarchyInitialization:(unsigned long long)arg2 ckoperationGroup:(id)arg3;	// IMP=0x0000000100138f7c
- (id)scanLocalItems:(id)arg1 ckoperationGroup:(id)arg2 after:(id)arg3;	// IMP=0x0000000100138c88
- (id)scanLocalItems:(id)arg1;	// IMP=0x0000000100138c74
- (id)processIncomingQueue:(_Bool)arg1 after:(id)arg2;	// IMP=0x00000001001389c8
- (id)processIncomingQueue:(_Bool)arg1;	// IMP=0x00000001001389b8
- (id)resultsOfNextProcessIncomingQueueOperation;	// IMP=0x0000000100138860
- (void)processIncomingQueueAfterNextUnlock;	// IMP=0x00000001001386b0
- (id)processOutgoingQueueAfter:(id)arg1 requiredDelay:(unsigned long long)arg2 ckoperationGroup:(id)arg3;	// IMP=0x0000000100138168
- (id)processOutgoingQueueAfter:(id)arg1 ckoperationGroup:(id)arg2;	// IMP=0x0000000100138100
- (id)processOutgoingQueue:(id)arg1;	// IMP=0x00000001001380ec
- (long long)countPendingOperations:(id)arg1;	// IMP=0x0000000100137f58
- (id)findFirstPendingOperation:(id)arg1 ofClass:(Class)arg2;	// IMP=0x0000000100137db8
- (id)findFirstPendingOperation:(id)arg1;	// IMP=0x0000000100137da8
- (void)receiveTLKUploadRecords:(id)arg1;	// IMP=0x0000000100137a94
- (void)_onqueueRunKeysetProviderOperations:(id)arg1;	// IMP=0x0000000100137880
- (id)findKeySet;	// IMP=0x00000001001377a8
- (id)keyForItem:(struct SecDbItem *)arg1 error:(id *)arg2;	// IMP=0x00000001001372fc
- (void)getCurrentItemForAccessGroup:(id)arg1 identifier:(id)arg2 fetchCloudValue:(_Bool)arg3 complete:(CDUnknownBlockType)arg4;	// IMP=0x0000000100136ec8
- (void)setCurrentItemForAccessGroup:(id)arg1 hash:(id)arg2 accessGroup:(id)arg3 identifier:(id)arg4 replacing:(id)arg5 hash:(id)arg6 complete:(CDUnknownBlockType)arg7;	// IMP=0x00000001001368f0
- (void)handleKeychainEventDbConnection:(struct __OpaqueSecDbConnection *)arg1 source:(unsigned long long)arg2 added:(struct SecDbItem *)arg3 deleted:(struct SecDbItem *)arg4 rateLimiter:(id)arg5;	// IMP=0x0000000100136250
- (void)_onqueueKeyHierarchyFetchForReasons:(id)arg1;	// IMP=0x000000010013604c
- (void)_onqueueKeyHierarchyFetch;	// IMP=0x0000000100135f74
- (id)_onqueueEnsureKeyHierarchyHealth:(id)arg1 error:(id *)arg2;	// IMP=0x00000001001348cc
- (id)_onqueueCreateMissingKeyShares:(id)arg1 peers:(id)arg2 error:(id *)arg3;	// IMP=0x000000010013415c
- (id)_onqueueCreateMissingKeyShares:(id)arg1 error:(id *)arg2;	// IMP=0x0000000100133e34
- (_Bool)_onqueueAreNewSharesSufficient:(id)arg1 currentTLK:(id)arg2 error:(id *)arg3;	// IMP=0x0000000100133a6c
- (id)_onqueueFindPeers:(id)arg1 missingShare:(id)arg2 afterUploading:(id)arg3 error:(id *)arg4;	// IMP=0x00000001001323b0
- (_Bool)_onqueueOtherDevicesReportHavingTLKs:(id)arg1;	// IMP=0x00000001001313d4
- (_Bool)otherDevicesReportHavingTLKs:(id)arg1;	// IMP=0x00000001001312f8
- (id)operationToEnterState:(id)arg1 keyStateError:(id)arg2 named:(id)arg3;	// IMP=0x000000010013119c
- (void)_onqueueHandleKeyStateNonTransientDependency:(id)arg1;	// IMP=0x0000000100130f10
- (void)_onqueueAdvanceKeyStateMachineToState:(id)arg1 withError:(id)arg2;	// IMP=0x000000010012b84c
- (id)createKeyStateNontransientDependency;	// IMP=0x000000010012b708
- (id)createKeyStateReadyDependency:(id)arg1 ckoperationGroup:(id)arg2;	// IMP=0x000000010012b544
- (void)_onqueueKeyStateMachineRequestProcess;	// IMP=0x000000010012b4dc
- (void)keyStateMachineRequestProcess;	// IMP=0x000000010012b484
- (void)_onqueueKeyStateMachineRequestFetch;	// IMP=0x000000010012b41c
- (id)resetCloudKitZone:(id)arg1;	// IMP=0x000000010012b024
- (id)createPendingDeleteZoneOperation:(id)arg1;	// IMP=0x000000010012aefc
- (id)resetLocalData;	// IMP=0x000000010012abf4
- (id)createPendingResetLocalDataOperation;	// IMP=0x000000010012aa50
- (_Bool)_onqueueResetLocalData:(id *)arg1;	// IMP=0x0000000100129f44
- (void)_onqueuePerformKeyStateInitialized:(id)arg1;	// IMP=0x00000001001293f4
- (id)createPendingInitializationOperation;	// IMP=0x000000010012931c
- (void)ensureKeyStateReadyDependency:(id)arg1;	// IMP=0x00000001001291e8
- (void)_onqueueResetSetup:(id)arg1 resetMessage:(id)arg2 ckoperationGroup:(id)arg3;	// IMP=0x0000000100128fc8
...
- (id)initWithContainer:(id)arg1 zoneName:(id)arg2 accountTracker:(id)arg3 lockStateTracker:(id)arg4 reachabilityTracker:(id)arg5 changeFetcher:(id)arg6 zoneModifier:(id)arg7 savedTLKNotifier:(id)arg8 cloudKitClassDependencies:(id)arg9;	// IMP=0x00000001001281f4
