...
- (void).cxx_destruct;	// IMP=0x00000001000861a8
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000100085ee4
- (unsigned long long)hash;	// IMP=0x0000000100085da4
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100085b94
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001000859c8
- (void)copyTo:(id)arg1;	// IMP=0x0000000100085850
- (void)writeTo:(id)arg1;	// IMP=0x00000001000856fc
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000001000850d0
- (id)dictionaryRepresentation;	// IMP=0x0000000100084d7c
- (id)description;	// IMP=0x0000000100084cc8
...
- (int)StringAsMetricType:(id)arg1;	// IMP=0x0000000100084ab4
- (id)metricTypeAsString:(int)arg1;	// IMP=0x0000000100084a3c
