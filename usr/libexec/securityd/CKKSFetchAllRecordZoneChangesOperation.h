...
- (void).cxx_destruct;	// IMP=0x000000010009b2c4
...
- (void)cancel;	// IMP=0x000000010009b014
- (void)sendChangesToClient:(id)arg1 moreComing:(_Bool)arg2;	// IMP=0x000000010009aaf4
- (void)performFetch;	// IMP=0x000000010009a418
- (void)groupStart;	// IMP=0x000000010009a1f4
- (void)queryClientsForChangeTokens;	// IMP=0x0000000100099d30
- (id)initWithContainer:(id)arg1 fetchClass:(Class)arg2 clients:(id)arg3 fetchReasons:(id)arg4 apnsPushes:(id)arg5 forceResync:(_Bool)arg6 ckoperationGroup:(id)arg7;	// IMP=0x000000010009996c
- (id)init;	// IMP=0x0000000100099954
