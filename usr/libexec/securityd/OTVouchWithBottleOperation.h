...
- (void).cxx_destruct;	// IMP=0x0000000100069aa4
...
- (void)proceedWithKeys:(id)arg1 filteredTLKShares:(id)arg2;	// IMP=0x00000001000696e0
- (void)noteMetric:(id)arg1 count:(long long)arg2;	// IMP=0x0000000100069554
- (void)proceedWithPeerID:(id)arg1;	// IMP=0x000000010006938c
- (void)groupStart;	// IMP=0x0000000100068d0c
- (id)initWithDependencies:(id)arg1 intendedState:(id)arg2 errorState:(id)arg3 bottleID:(id)arg4 entropy:(id)arg5 bottleSalt:(id)arg6;	// IMP=0x0000000100068b98
