...
- (void).cxx_destruct;	// IMP=0x00000001000b5e40
...
- (void)proceedWithKeys:(id)arg1 tlkShares:(id)arg2 salt:(id)arg3;	// IMP=0x00000001000b5b00
- (void)proceedWithRecoveryKeyID:(id)arg1;	// IMP=0x00000001000b5938
- (void)groupStart;	// IMP=0x00000001000b53c8
- (id)initWithDependencies:(id)arg1 intendedState:(id)arg2 errorState:(id)arg3 recoveryKey:(id)arg4;	// IMP=0x00000001000b52ac
