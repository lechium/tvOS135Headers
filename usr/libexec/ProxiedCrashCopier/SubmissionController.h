...
- (void)submitWithOptions:(id)arg1 resultsCallback:(CDUnknownBlockType)arg2;	// IMP=0x0000000100003b78
- (void)_setupScheduler;	// IMP=0x00000001000039a4
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x00000001000038c0
- (void)handleOptInChange;	// IMP=0x0000000100003564
- (void)handleWatchDog;	// IMP=0x0000000100003438
- (void)handleUnlock;	// IMP=0x00000001000033b8
- (id)init;	// IMP=0x0000000100003128
