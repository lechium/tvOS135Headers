...
- (void)watchForPortDeathOnQueue:(id)arg1 block:(CDUnknownBlockType)arg2;	// IMP=0x0000000100064ca4
- (id)description;	// IMP=0x0000000100064ac0
- (void)invalidate;	// IMP=0x0000000100064a4c
- (void)dealloc;	// IMP=0x0000000100064980
- (id)init;	// IMP=0x000000010006493c
