...
+ (id)accessibilityHIDServices;	// IMP=0x0000000100068110
- (void).cxx_destruct;	// IMP=0x00000001000680e0
...
- (id)initWithSenderID:(unsigned long long)arg1;	// IMP=0x0000000100067fdc
