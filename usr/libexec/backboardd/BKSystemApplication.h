...
- (void).cxx_destruct;	// IMP=0x00000001000525f0
...
- (id)descriptionBuilderWithMultilinePrefix:(id)arg1;	// IMP=0x000000010005242c
- (id)descriptionWithMultilinePrefix:(id)arg1;	// IMP=0x00000001000523d8
- (id)succinctDescriptionBuilder;	// IMP=0x0000000100052330
- (id)succinctDescription;	// IMP=0x00000001000522dc
@property(readonly, copy) NSString *description;
- (void)dealloc;	// IMP=0x0000000100052280
- (id)initWithConnection:(id)arg1;	// IMP=0x00000001000521e4
