...
- (void).cxx_destruct;	// IMP=0x000000010001006c
...
- (void)resetForCancel;	// IMP=0x000000010000ffb4
- (id)description;	// IMP=0x000000010000fe38
- (id)initWithService:(id)arg1;	// IMP=0x000000010000fc2c
