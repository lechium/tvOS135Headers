...
+ (id)defaultClient;	// IMP=0x000000010005b510
- (void).cxx_destruct;	// IMP=0x000000010005b498
...
- (id)initWithMode:(unsigned long long)arg1 port:(id)arg2 auditToken:(id)arg3;	// IMP=0x000000010005b314
