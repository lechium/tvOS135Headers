...
- (void)clearCacheServerUrl;	// IMP=0x00000001000117dc
- (void)addNewDownloadInfo:(id)arg1;	// IMP=0x00000001000117c4
- (double)currentEstimate;	// IMP=0x0000000100011634
- (void)updateDownloadData:(long long)arg1;	// IMP=0x00000001000115cc
- (_Bool)addNewRateDataPoint:(double)arg1;	// IMP=0x0000000100011468
- (void)dealloc;	// IMP=0x00000001000113d0
- (void)determineDownloadUrl:(id)arg1 callback:(CDUnknownBlockType)arg2;	// IMP=0x00000001000111dc
- (id)initWithUrl:(id)arg1 options:(id)arg2;	// IMP=0x0000000100011128
