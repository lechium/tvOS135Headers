...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000010000df5c
...
- (void)logOptions;	// IMP=0x000000010000e588
- (id)description;	// IMP=0x000000010000e464
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000010000e290
- (void)dealloc;	// IMP=0x000000010000e240
- (id)initWithCoder:(id)arg1;	// IMP=0x000000010000dfc0
- (id)init;	// IMP=0x000000010000df64
