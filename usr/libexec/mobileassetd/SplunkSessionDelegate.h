...
- (void)URLSession:(id)arg1 task:(id)arg2 didCompleteWithError:(id)arg3;	// IMP=0x000000010001bb7c
- (void)dealloc;	// IMP=0x000000010001bb48
- (id)initWithDownloadManager:(id)arg1;	// IMP=0x000000010001bb00
