...
- (void).cxx_destruct;	// IMP=0x00000001000714d0
...
- (void)setNotificationRef:(struct __CFUserNotification *)arg1;	// IMP=0x00000001000713f4
- (struct __CFUserNotification *)notificationRef;	// IMP=0x00000001000713ec
- (void)dealloc;	// IMP=0x00000001000713a0
- (id)init;	// IMP=0x0000000100071330
