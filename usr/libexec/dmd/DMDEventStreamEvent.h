...
- (void).cxx_destruct;	// IMP=0x000000010004a698
...
- (id)eventStatusMessageWithPayloadIdentifier:(id)arg1;	// IMP=0x000000010004a538
- (id)description;	// IMP=0x000000010004a4ac
- (id)initWithEventType:(id)arg1 details:(id)arg2;	// IMP=0x000000010004a3d0
