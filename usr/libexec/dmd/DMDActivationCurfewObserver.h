...
- (void).cxx_destruct;	// IMP=0x000000010000f004
...
- (id)_nextDateAfter:(id)arg1 matchingWeekday:(long long)arg2 hour:(long long)arg3 minute:(long long)arg4 second:(long long)arg5 inCalendar:(id)arg6;	// IMP=0x000000010000ed7c
- (id)_datesForNextCurfewBoundary;	// IMP=0x000000010000e9b4
- (void)_registerPredicateObserver;	// IMP=0x000000010000e5b8
- (_Bool)_extractComponentsFromPredicate:(id)arg1;	// IMP=0x000000010000dccc
- (id)metadata;	// IMP=0x000000010000db84
- (void)updateObserverRegistration;	// IMP=0x000000010000db78
- (void)invalidate;	// IMP=0x000000010000d9f8
- (id)evaluatePredicateWithError:(id *)arg1;	// IMP=0x000000010000d500
- (id)initWithDelegate:(id)arg1 uniqueIdentifier:(id)arg2 curfewPredicate:(id)arg3;	// IMP=0x000000010000d3cc
