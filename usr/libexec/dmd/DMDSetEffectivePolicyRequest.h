...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000010006917c
- (void).cxx_destruct;	// IMP=0x0000000100069744
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000100069484
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000100069184
