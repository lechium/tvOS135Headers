...
- (void).cxx_destruct;	// IMP=0x00000001000494ac
...
- (void)startWithScheduleElapsedHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000001000492a8
- (unsigned long long)hash;	// IMP=0x0000000100049160
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100048ee4
- (id)description;	// IMP=0x0000000100048e14
- (void)dealloc;	// IMP=0x0000000100048dc4
- (id)initWithScheduleRegistration:(id)arg1;	// IMP=0x0000000100048acc
