...
- (_Bool)_registerPredicateObserver;	// IMP=0x000000010000cec8
- (_Bool)_budgetDays:(id)arg1 duration:(id)arg2 calendar:(id)arg3 schedule:(id)arg4;	// IMP=0x000000010000cb78
- (_Bool)_extractComponentsFromCompositeBudgetPredicate:(id)arg1;	// IMP=0x000000010000c4a0
- (_Bool)_extractComponentsFromBudgetPredicate:(id)arg1;	// IMP=0x000000010000bdb0
- (id)metadata;	// IMP=0x000000010000bc88
- (void)invalidate;	// IMP=0x000000010000b9c4
- (id)evaluatePredicateWithError:(id *)arg1;	// IMP=0x000000010000b404
- (id)initWithDelegate:(id)arg1 uniqueIdentifier:(id)arg2 compositeBudgetPredicate:(id)arg3;	// IMP=0x000000010000b2c8
- (id)initWithDelegate:(id)arg1 uniqueIdentifier:(id)arg2 budgetPredicate:(id)arg3;	// IMP=0x000000010000b18c
