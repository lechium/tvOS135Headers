...
- (void).cxx_destruct;	// IMP=0x00000001000346cc
...
- (void)resolveAssetWithContext:(id)arg1;	// IMP=0x0000000100034530
- (void)configurationSourceController:(id)arg1 fetchEventsWithCompletionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000100034404
- (void)configurationSourceController:(id)arg1 fetchStatusUpdatesWithCompletionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000001000342d8
- (void)unregisterConfigurationSource:(id)arg1;	// IMP=0x0000000100034244
- (id)registerConfigurationSource:(id)arg1;	// IMP=0x0000000100034060
- (id)configurationSourceWithIdentifier:(id)arg1;	// IMP=0x0000000100033f80
...
- (void)updateWithOrganization:(id)arg1;	// IMP=0x00000001000334ec
- (id)initWithOrganization:(id)arg1 delegate:(id)arg2;	// IMP=0x00000001000333f0
