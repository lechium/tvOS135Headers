...
- (void).cxx_destruct;	// IMP=0x0000000100012f88
...
- (void)handleNotifyMatchingNotificationWithName:(id)arg1;	// IMP=0x0000000100012e10
- (void)handleAlarmWithIdentifier:(id)arg1;	// IMP=0x0000000100012cd8
@property(readonly, nonatomic) NSArray *notifyMatchingNotifications;
@property(readonly, nonatomic) _Bool alarms;
- (id)_subPredicateObserversForCompoundSubPredicates:(id)arg1 withUniqueIdentifier:(id)arg2;	// IMP=0x0000000100012a4c
- (id)_predicateObserverForPredicate:(id)arg1 withUniqueIdentifier:(id)arg2;	// IMP=0x000000010001261c
- (void)_updateAllActivationPredicateObserverRegistrations;	// IMP=0x0000000100012570
- (void)_reportChangeToObserver:(id)arg1;	// IMP=0x00000001000123dc
- (void)activationPredicateObserverDidTrigger:(id)arg1;	// IMP=0x00000001000123d0
- (id)activationPredicateObserverForIdentifier:(id)arg1;	// IMP=0x000000010001230c
- (void)removeActivationPredicateObserverWithUniqueIdentifier:(id)arg1;	// IMP=0x00000001000121fc
- (id)addActivationPredicateObserverForPredicate:(id)arg1 withUniqueIdentifier:(id)arg2;	// IMP=0x00000001000120b0
- (id)init;	// IMP=0x000000010001204c
