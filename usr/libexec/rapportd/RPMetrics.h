...
+ (id)sharedMetricsNoCreate;	// IMP=0x000000010003bf90
+ (id)sharedMetrics;	// IMP=0x000000010003bed8
- (void).cxx_destruct;	// IMP=0x000000010003d0b8
@property(retain, nonatomic) NSObject<OS_dispatch_queue> *dispatchQueue; // @synthesize dispatchQueue=_dispatchQueue;
- (void)_logReceivedMessageType:(int)arg1 identifier:(id)arg2 options:(id)arg3 appID:(id)arg4 timeBegin:(double)arg5 timeEnd:(double)arg6 bytesAdded:(unsigned long long)arg7 messagesAdded:(unsigned long long)arg8;	// IMP=0x000000010003cd80
- (void)logReceivedMessageType:(int)arg1 identifier:(id)arg2 options:(id)arg3 appID:(id)arg4 ctx:(CDStruct_20fd928a *)arg5;	// IMP=0x000000010003cbe0
- (void)_reportMetrics:(_Bool)arg1;	// IMP=0x000000010003c6d8
- (void)reportMetrics;	// IMP=0x000000010003c66c
- (void)invalidate;	// IMP=0x000000010003c580
- (void)_activate;	// IMP=0x000000010003c454
- (void)activate;	// IMP=0x000000010003c3ec
- (id)descriptionWithLevel:(int)arg1;	// IMP=0x000000010003c06c
- (id)init;	// IMP=0x000000010003bf9c
