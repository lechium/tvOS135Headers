...
+ (id)secureCodedPropertyKeys;	// IMP=0x00000001001364d8
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001001367a0
- (unsigned long long)hash;	// IMP=0x0000000100136788
- (void)dealloc;	// IMP=0x0000000100136408
- (void)updateWithCacheObject:(id)arg1;	// IMP=0x000000010013d1cc
