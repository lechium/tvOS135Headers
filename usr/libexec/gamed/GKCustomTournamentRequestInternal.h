...
+ (id)customTournamentRequestWithTournamentDefinition:(id)arg1 player:(id)arg2;	// IMP=0x00000001000f5488
+ (id)secureCodedPropertyKeys;	// IMP=0x00000001000f528c
- (void).cxx_destruct;	// IMP=0x00000001000f5844
