...
+ (id)entityName;	// IMP=0x000000010004ac44
- (id)internalRepresentation;	// IMP=0x000000010004ae70
- (void)updateWithServerRepresentation:(id)arg1 expirationDate:(id)arg2;	// IMP=0x000000010004acb8
- (_Bool)isValid;	// IMP=0x000000010004ac50
