...
+ (id)entityName;	// IMP=0x000000010004db00
- (id)internalRepresentation;	// IMP=0x000000010004d8f4
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x000000010004d4b0
