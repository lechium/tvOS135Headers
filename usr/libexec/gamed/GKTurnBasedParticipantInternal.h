...
+ (id)secureCodedPropertyKeys;	// IMP=0x0000000100135dbc
...
- (id)descriptionSubstitutionMap;	// IMP=0x00000001001361d8
- (id)serverRepresentation;	// IMP=0x0000000100136048
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100135f78
- (unsigned long long)hash;	// IMP=0x0000000100135f5c
- (void)dealloc;	// IMP=0x0000000100135d0c
@property(readonly, nonatomic) NSString *playerID;
- (void)updateWithCacheObject:(id)arg1;	// IMP=0x000000010013cfcc
