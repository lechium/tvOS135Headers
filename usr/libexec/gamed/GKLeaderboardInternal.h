...
+ (id)secureCodedPropertyKeys;	// IMP=0x000000010012ce60
...
- (unsigned long long)hash;	// IMP=0x000000010012d18c
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010012d0f8
- (void)dealloc;	// IMP=0x000000010012cda0
