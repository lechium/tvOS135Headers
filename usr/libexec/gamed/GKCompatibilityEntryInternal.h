...
+ (id)secureCodedPropertyKeys;	// IMP=0x0000000100138588
...
- (unsigned long long)hash;	// IMP=0x00000001001388bc
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100138750
- (void)dealloc;	// IMP=0x0000000100138508
