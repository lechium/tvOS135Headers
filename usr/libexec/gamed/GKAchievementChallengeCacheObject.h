...
+ (id)entityName;	// IMP=0x000000010005bb30
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x000000010005bfa4
- (id)internalRepresentation;	// IMP=0x000000010005bcb0
- (Class)classForInternalRepresentation;	// IMP=0x000000010005bca4
- (_Bool)hasDetails;	// IMP=0x000000010005bb3c
