...
+ (id)secureCodedPropertyKeys;	// IMP=0x0000000100137eb4
+ (id)nearbyInviteIDForPlayerID:(id)arg1 deviceID:(id)arg2 bundleID:(id)arg3;	// IMP=0x0000000100137d04
+ (id)inviteFromNearbyPlayer:(id)arg1 participantID:(id)arg2 deviceID:(id)arg3 bundleID:(id)arg4 connectionData:(id)arg5;	// IMP=0x0000000100137bcc
+ (id)inviteWithBulletin:(id)arg1;	// IMP=0x0000000100137764
...
- (id)descriptionSubstitutionMap;	// IMP=0x0000000100138244
@property(readonly, nonatomic) _Bool isNearby; // @dynamic isNearby;
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001001381a8
- (unsigned long long)hash;	// IMP=0x0000000100138184
- (void)dealloc;	// IMP=0x0000000100137da4
- (id)init;	// IMP=0x0000000100137d40
