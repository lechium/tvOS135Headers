...
+ (id)secureCodedPropertyKeys;	// IMP=0x000000010012b658
+ (_Bool)supportsSecureCoding;	// IMP=0x000000010012b5f0
...
- (unsigned long long)hash;	// IMP=0x000000010012b7fc
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010012b75c
- (void)dealloc;	// IMP=0x000000010012b5f8
