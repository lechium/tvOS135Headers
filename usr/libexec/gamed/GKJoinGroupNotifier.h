...
- (void)setResult:(CDUnknownBlockType)arg1 error:(id)arg2;	// IMP=0x00000001000990e0
@property(retain) NSError *error; // @synthesize error=_error;
@property(nonatomic) GKJoinGroup *group; // @synthesize group=_group;
- (oneway void)release;	// IMP=0x0000000100098fb0
- (id)retain;	// IMP=0x0000000100098f20
- (void)dealloc;	// IMP=0x0000000100098ebc
- (id)init;	// IMP=0x0000000100098e54
