...
+ (Class)entryClass;	// IMP=0x0000000100059e1c
+ (id)entityName;	// IMP=0x0000000100059e10
- (void)updateWithServerRepresentation:(id)arg1 expirationDate:(id)arg2;	// IMP=0x0000000100059e28
