...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000100095da0
...
- (void)loadGoalTextForGameDescriptor:(id)arg1 handler:(CDUnknownBlockType)arg2;	// IMP=0x00000001000965d4
- (void)loadDetailsWithHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000100095e58
- (id)initWithChallenge:(id)arg1;	// IMP=0x0000000100095e00
- (id)challengeInternalObject;	// IMP=0x0000000100095df8
- (id)description;	// IMP=0x0000000100095da8
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000100095cb4
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000100095b08
- (void)dealloc;	// IMP=0x0000000100095a80
