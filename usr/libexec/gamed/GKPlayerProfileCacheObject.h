...
+ (id)entityName;	// IMP=0x0000000100046f80
+ (id)playerProfilesWithPlayerIDs:(id)arg1 inManagedObjectContext:(id)arg2;	// IMP=0x0000000100045afc
+ (id)playerProfilesWithPlayers:(id)arg1 inManagedObjectContext:(id)arg2;	// IMP=0x0000000100045a9c
+ (id)profileForPlayer:(id)arg1 context:(id)arg2;	// IMP=0x0000000100045a14
+ (id)playerProfileWithPlayerID:(id)arg1 inManagedObjectContext:(id)arg2;	// IMP=0x0000000100045810
+ (id)localPlayerInManagedObjectContext:(id)arg1;	// IMP=0x0000000100045650
+ (const void *)uniqueObjectIDLookupKey;	// IMP=0x0000000100044cec
+ (id)uniqueAttributeName;	// IMP=0x0000000100044ce0
+ (id)filterPlayerIDs:(id)arg1 familiarity:(int)arg2 includeSelf:(_Bool)arg3;	// IMP=0x0000000100048110
+ (unsigned char)piecesToLoadForFamiliarity:(int)arg1;	// IMP=0x00000001000480e0
+ (id)playersByFamiliarity:(id)arg1;	// IMP=0x0000000100047c10
+ (void)setFamiliarPlayerIDs:(id)arg1 familiarity:(int)arg2;	// IMP=0x0000000100047a74
+ (void)removeFamiliarPlayerIDs:(id)arg1 familiarity:(int)arg2;	// IMP=0x0000000100047714
+ (void)addFamiliarPlayerIDs:(id)arg1 familiarity:(int)arg2;	// IMP=0x00000001000475a0
+ (int)familiarityForPlayerID:(id)arg1;	// IMP=0x0000000100047424
+ (id)selfPlayerID;	// IMP=0x00000001000473d4
+ (void)buildFamiliarilyLookupForProfile:(id)arg1;	// IMP=0x00000001000471fc
+ (id)_familiarityLookup;	// IMP=0x00000001000470a0
- (void)expireRecentMatchesWithGame:(id)arg1;	// IMP=0x0000000100046f8c
- (id)internalRepresentation;	// IMP=0x0000000100046e48
- (id)internalRepresentationWithPieces:(unsigned char)arg1;	// IMP=0x0000000100046c44
- (void)updateWithServerRepresentation:(id)arg1 expirationDate:(id)arg2 pieces:(unsigned char)arg3;	// IMP=0x000000010004612c
- (id)updateImagesWithImageURLs:(id)arg1;	// IMP=0x0000000100045da4
- (void)updateWithServerRepresentation:(id)arg1 expirationDate:(id)arg2;	// IMP=0x0000000100045d94
- (void)deleteCachedImage:(id)arg1;	// IMP=0x00000001000452bc
- (void)deleteCachedAvatars;	// IMP=0x00000001000450b8
- (void)clearImages;	// IMP=0x0000000100044e50
...
- (void)invalidate;	// IMP=0x0000000100044d70
