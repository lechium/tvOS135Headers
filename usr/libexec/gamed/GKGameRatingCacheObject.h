...
+ (id)entityName;	// IMP=0x000000010004d370
+ (id)ratingForGameDescriptor:(id)arg1 context:(id)arg2;	// IMP=0x000000010004cfe8
- (void)updateWithServerRepresentation:(id)arg1 expirationDate:(id)arg2;	// IMP=0x000000010004d1d0
