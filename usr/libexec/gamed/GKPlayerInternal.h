...
+ (Class)classForFamiliarity:(int)arg1;	// IMP=0x00000001001291ec
+ (id)displayNameWithOptions:(unsigned char)arg1 alias:(id)arg2 composite:(id)arg3;	// IMP=0x000000010012916c
+ (id)compositeNameForFirstName:(id)arg1 lastName:(id)arg2;	// IMP=0x000000010012902c
+ (id)secureCodedPropertyKeys;	// IMP=0x000000010012892c
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000100128924
+ (id)propertiesToFetch;	// IMP=0x000000010013b3d8
+ (int)familiarity;	// IMP=0x000000010013b3d0
+ (unsigned char)piecesToLoad;	// IMP=0x000000010013b394
...
- (void)setAllowNearbyMultiplayer:(_Bool)arg1;	// IMP=0x0000000100129424
- (_Bool)allowNearbyMultiplayer;	// IMP=0x000000010012941c
...
- (int)defaultFamiliarity;	// IMP=0x000000010012924c
- (id)displayNameWithOptions:(unsigned char)arg1;	// IMP=0x00000001001290c8
- (id)minimalInternal;	// IMP=0x0000000100128e6c
- (unsigned long long)hash;	// IMP=0x0000000100128e48
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100128dac
- (id)serverRepresentation;	// IMP=0x0000000100128cb8
- (id)conciseDescription;	// IMP=0x0000000100128c30
- (id)cacheKey;	// IMP=0x0000000100128c24
- (void)dealloc;	// IMP=0x0000000100128814
- (void)updateWithProperties:(id)arg1;	// IMP=0x000000010013b520
- (void)updateWithCacheObject:(id)arg1;	// IMP=0x000000010013b060
