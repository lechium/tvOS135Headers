...
+ (id)relationshipKeyPathsForPrefetch;	// IMP=0x000000010004cfb0
+ (id)fetchSortDescriptors;	// IMP=0x000000010004cecc
+ (id)entityName;	// IMP=0x000000010004cec0
+ (id)recordForGame:(id)arg1 playerProfile:(id)arg2;	// IMP=0x000000010004b764
+ (id)recordsForGames:(id)arg1 playerProfile:(id)arg2;	// IMP=0x000000010004b504
- (id)internalRepresentation;	// IMP=0x000000010004cd98
- (void)updateAchievementsWithServerRepresentation:(id)arg1;	// IMP=0x000000010004cbb8
- (void)updateIDsWithServerRepresentation:(id)arg1;	// IMP=0x000000010004c298
- (void)updateWithServerRepresentation:(id)arg1 expirationDate:(id)arg2;	// IMP=0x000000010004b7fc
