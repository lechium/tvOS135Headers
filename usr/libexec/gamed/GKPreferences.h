...
+ (id)displayNameForEnvironment:(long long)arg1;	// IMP=0x000000010007bbc8
+ (id)hostNameForEnvironment:(long long)arg1;	// IMP=0x000000010007bb9c
+ (id)shared;	// IMP=0x000000010007abfc
...
- (void)removeOverrideForKey:(id)arg1;	// IMP=0x000000010007b0bc
- (void)setStringValue:(id)arg1 forKey:(struct __CFString *)arg2;	// IMP=0x000000010007b0a4
- (id)stringValueForKey:(struct __CFString *)arg1 defaultValue:(id)arg2;	// IMP=0x000000010007b074
- (void)setTimeInterval:(double)arg1 forKey:(struct __CFString *)arg2;	// IMP=0x000000010007b018
- (double)timeIntervalForKey:(struct __CFString *)arg1 defaultValue:(double)arg2;	// IMP=0x000000010007afd4
- (void)setUnsignedIntegerValue:(long long)arg1 forKey:(struct __CFString *)arg2;	// IMP=0x000000010007af78
- (long long)unsignedIntegerValueForKey:(struct __CFString *)arg1 defaultValue:(long long)arg2;	// IMP=0x000000010007af34
- (void)setIntegerValue:(long long)arg1 forKey:(struct __CFString *)arg2;	// IMP=0x000000010007aed8
- (long long)integerValueForKey:(struct __CFString *)arg1 defaultValue:(long long)arg2;	// IMP=0x000000010007ae94
- (void)setBooleanValue:(_Bool)arg1 forKey:(struct __CFString *)arg2;	// IMP=0x000000010007ae34
- (_Bool)booleanValueForKey:(struct __CFString *)arg1;	// IMP=0x000000010007ae24
- (_Bool)booleanValueForKey:(struct __CFString *)arg1 defaultValue:(_Bool)arg2;	// IMP=0x000000010007ade0
- (id)preferencesValueForKey:(id)arg1;	// IMP=0x000000010007ad90
- (void)_didWriteKey:(struct __CFString *)arg1;	// IMP=0x000000010007ad68
- (void)synchronize;	// IMP=0x000000010007ad2c
- (void)invalidate;	// IMP=0x000000010007ad1c
- (_Bool)isInternalBuild;	// IMP=0x000000010007aca0
- (void)dealloc;	// IMP=0x000000010007abb4
- (id)init;	// IMP=0x000000010007aba8
- (id)initWithoutUIKitNotifications;	// IMP=0x000000010007ab28
- (id)initWithUIKitNotifications;	// IMP=0x000000010007ab1c
- (void)profileConnectionDidReceiveEffectiveSettingsChangedNotification:(id)arg1 userInfo:(id)arg2;	// IMP=0x00000001000e5528
- (_Bool)restrictionEnabledForKey:(id)arg1;	// IMP=0x00000001000e54e0
