...
+ (id)secureCodedPropertyKeys;	// IMP=0x000000010013715c
...
- (_Bool)hasGuestPlayers;	// IMP=0x000000010013747c
- (unsigned long long)hash;	// IMP=0x00000001001370e8
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100136ccc
- (void)dealloc;	// IMP=0x0000000100136c1c
- (id)init;	// IMP=0x0000000100136b9c
