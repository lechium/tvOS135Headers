...
+ (id)secureCodedPropertyKeys;	// IMP=0x0000000100134c30
...
- (id)descriptionSubstitutionMap;	// IMP=0x0000000100135958
@property(nonatomic) unsigned int state; // @synthesize state=_state;
- (long long)activeExchangeCount;	// IMP=0x000000010013533c
- (long long)previousParticipantIndex;	// IMP=0x00000001001351b4
- (long long)localPlayerParticipantIndex;	// IMP=0x0000000100135160
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010013504c
- (unsigned long long)hash;	// IMP=0x0000000100135028
- (void)dealloc;	// IMP=0x0000000100134ad0
- (void)updateWithCacheObject:(id)arg1;	// IMP=0x000000010013c748
