...
+ (id)secureCodedPropertyKeys;	// IMP=0x000000010008ece8
...
- (_Bool)transitionToState:(long long)arg1;	// IMP=0x000000010008eea8
- (_Bool)isCancelled;	// IMP=0x000000010008ee68
- (_Bool)isFinished;	// IMP=0x000000010008ee28
- (int)_incrementSequence;	// IMP=0x000000010008ee18
