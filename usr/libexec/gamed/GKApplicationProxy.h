...
+ (id)metadataForBundleURL:(id)arg1;	// IMP=0x000000010008fadc
...
- (id)bundleURL;	// IMP=0x000000010008fcd4
...
- (void)dealloc;	// IMP=0x000000010008fbb4
- (id)initWithBundleID:(id)arg1;	// IMP=0x000000010008fa9c
- (id)initWithProxy:(id)arg1;	// IMP=0x000000010008fa3c
