...
+ (_Bool)displayNotification;	// IMP=0x00000001000dd7a4
+ (_Bool)supportsSecureCoding;	// IMP=0x00000001000dd79c
- (void).cxx_destruct;	// IMP=0x00000001000dfda4
...
- (id)description;	// IMP=0x00000001000dfb30
- (void)assembleBulletin;	// IMP=0x00000001000df534
- (void)localizeMessage;	// IMP=0x00000001000df460
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000001000df164
- (id)initWithCoder:(id)arg1;	// IMP=0x00000001000dee44
- (id)initWithPushNotification:(id)arg1;	// IMP=0x00000001000deb34
- (void)distributeData;	// IMP=0x00000001000deb30
- (void)loadDataWithHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000001000de61c
- (void)determineGameLocationOnDeviceOrInStoreWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000001000dd7ac
