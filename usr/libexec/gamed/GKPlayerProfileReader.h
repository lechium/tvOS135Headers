...
+ (id)readerWithLocalPlayer:(id)arg1 language:(id)arg2 readerConnection:(id)arg3 writerConnection:(id)arg4 transport:(id)arg5;	// IMP=0x0000000100133e54
...
- (void)readResources:(id)arg1 handler:(CDUnknownBlockType)arg2;	// IMP=0x00000001001341f0
- (id)poolName;	// IMP=0x000000010013419c
- (int)familiarityForPlayer:(id)arg1;	// IMP=0x0000000100133ff4
- (void)dealloc;	// IMP=0x0000000100133f8c
- (id)initWithLocalPlayer:(id)arg1 language:(id)arg2 readerConnection:(id)arg3 writerConnection:(id)arg4 transport:(id)arg5;	// IMP=0x0000000100133ebc
