...
+ (id)entityName;	// IMP=0x0000000100051f10
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x0000000100051f1c
- (id)internalRepresentation;	// IMP=0x0000000100051ce8
