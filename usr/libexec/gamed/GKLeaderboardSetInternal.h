...
+ (id)secureCodedPropertyKeys;	// IMP=0x000000010012d410
...
- (unsigned long long)hash;	// IMP=0x000000010012d668
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010012d5d4
- (void)dealloc;	// IMP=0x000000010012d380
