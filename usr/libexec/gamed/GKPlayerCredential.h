...
+ (id)secureCodedPropertyKeys;	// IMP=0x0000000100124cf0
...
- (id)description;	// IMP=0x0000000100124c04
@property(readonly) NSString *scopeAsString;
- (void)dealloc;	// IMP=0x0000000100124a88
- (unsigned long long)hash;	// IMP=0x0000000100124a64
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100124904
