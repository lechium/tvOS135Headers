...
+ (id)entityName;	// IMP=0x000000010004a5b4
+ (id)_gamesForFullGameDescriptors:(id)arg1 context:(id)arg2;	// IMP=0x0000000100048c68
+ (id)gamesForGameDescriptors:(id)arg1 context:(id)arg2;	// IMP=0x0000000100048b28
+ (id)gamesForBundleIDs:(id)arg1 context:(id)arg2;	// IMP=0x00000001000489e8
+ (id)gameForBundleID:(id)arg1 context:(id)arg2;	// IMP=0x0000000100048818
+ (id)gameForGameDescriptor:(id)arg1 context:(id)arg2;	// IMP=0x000000010004877c
+ (id)fetchSortDescriptors;	// IMP=0x00000001000486d0
+ (const void *)uniqueObjectIDLookupKey;	// IMP=0x00000001000486c4
+ (id)uniqueAttributeName;	// IMP=0x00000001000486b8
- (id)gameDescriptor;	// IMP=0x000000010004a2fc
- (id)leaderboardSetWithIdentifier:(id)arg1;	// IMP=0x000000010004a280
- (id)internalRepresentation;	// IMP=0x000000010004a158
- (_Bool)storePiecesExpired;	// IMP=0x000000010004a128
- (_Bool)storePiecesValid;	// IMP=0x000000010004a0e4
- (void)updateStorePiecesWithServerRepresentation:(id)arg1 expirationDate:(id)arg2;	// IMP=0x0000000100049b34
- (void)updateWithServerRepresentation:(id)arg1 expirationDate:(id)arg2;	// IMP=0x0000000100049590
- (void)updateWithGameDescriptor:(id)arg1;	// IMP=0x0000000100049028
- (_Bool)isValid;	// IMP=0x0000000100048fac
- (void)invalidate;	// IMP=0x0000000100048664
