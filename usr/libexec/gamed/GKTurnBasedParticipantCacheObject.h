...
+ (id)entityName;	// IMP=0x0000000100057fd0
- (id)internalRepresentation;	// IMP=0x00000001000582c8
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x0000000100057fdc
