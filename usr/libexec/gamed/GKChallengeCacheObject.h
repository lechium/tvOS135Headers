...
+ (id)entityName;	// IMP=0x000000010005b16c
+ (id)fetchSortDescriptors;	// IMP=0x000000010005a64c
+ (id)challengeWithServerRepresentation:(id)arg1 context:(id)arg2;	// IMP=0x000000010005a3cc
+ (id)challengesWithChallengeIDs:(id)arg1 context:(id)arg2;	// IMP=0x000000010005a280
+ (const void *)uniqueObjectIDLookupKey;	// IMP=0x000000010005a274
+ (id)uniqueAttributeName;	// IMP=0x000000010005a268
- (void)invalidate;	// IMP=0x000000010005b2a4
- (_Bool)hasDetails;	// IMP=0x000000010005b178
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x000000010005ac8c
- (id)orderedSetOfCompatibleBundleIDs;	// IMP=0x000000010005aa08
- (id)internalRepresentation;	// IMP=0x000000010005a6d8
- (Class)classForInternalRepresentation;	// IMP=0x000000010005a6d0
