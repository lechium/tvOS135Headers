...
+ (id)writerWithTransport:(id)arg1 forBagKey:(id)arg2;	// IMP=0x0000000100168194
...
- (void)writeResources:(id)arg1 handler:(CDUnknownBlockType)arg2;	// IMP=0x00000001001682b4
- (void)dealloc;	// IMP=0x0000000100168254
- (id)initWithTransport:(id)arg1 forBagKey:(id)arg2;	// IMP=0x00000001001681d4
