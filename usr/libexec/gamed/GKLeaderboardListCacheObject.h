...
+ (id)entityName;	// IMP=0x000000010004dc90
- (_Bool)isValid;	// IMP=0x000000010004dd50
- (void)updateWithServerRepresentation:(id)arg1 expirationDate:(id)arg2;	// IMP=0x000000010004dc9c
