...
+ (void)performAsync:(CDUnknownBlockType)arg1;	// IMP=0x00000001000e4cdc
+ (_Bool)shouldProcessNotification;	// IMP=0x00000001000e4a34
+ (_Bool)supportsSecureCoding;	// IMP=0x00000001000e4664
+ (void)loadBulletinsForPushNotification:(id)arg1 withHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000001000e3d00
+ (void)bulletinsForPushNotification:(id)arg1 withHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000001000e35c0
+ (id)syncQueue;	// IMP=0x00000001000e3558
...
- (id)description;	// IMP=0x00000001000e4f6c
- (void)handleAction:(id)arg1;	// IMP=0x00000001000e4e34
- (void)executeBulletinWithBulletinController:(id)arg1;	// IMP=0x00000001000e4b88
- (void)dealloc;	// IMP=0x00000001000e498c
- (id)initWithPushNotification:(id)arg1;	// IMP=0x00000001000e47d0
- (id)dataFrom64String:(id)arg1;	// IMP=0x00000001000e466c
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000001000e4248
- (id)initWithCoder:(id)arg1;	// IMP=0x00000001000e3e24
