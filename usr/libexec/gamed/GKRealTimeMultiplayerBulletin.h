...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000100035f64
...
- (id)description;	// IMP=0x0000000100037680
- (id)customInviteSoundPathForBundleID:(id)arg1;	// IMP=0x0000000100037510
- (void)declineInviteWithReason:(int)arg1;	// IMP=0x0000000100037348
- (void)updateDeclineInviteTrackingForReason:(long long)arg1;	// IMP=0x00000001000371cc
- (id)clientNotification;	// IMP=0x0000000100036e50
- (id)clientNotificationWithiCloudID:(id)arg1;	// IMP=0x0000000100036de4
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000100036aa8
- (id)initWithCoder:(id)arg1;	// IMP=0x00000001000366d4
- (id)initWithPushNotification:(id)arg1;	// IMP=0x0000000100036374
- (void)parseClientData:(id)arg1;	// IMP=0x00000001000361f8
- (long long)inviteVersionFromMessage:(id)arg1;	// IMP=0x0000000100036080
- (void)dealloc;	// IMP=0x0000000100035fa0
- (id)init;	// IMP=0x0000000100035f6c
