...
+ (id)secureCodedPropertyKeys;	// IMP=0x0000000100122ecc
+ (id)propertiesToFetch;	// IMP=0x00000001001394c8
...
- (id)description;	// IMP=0x000000010012315c
- (id)serverRepresentation;	// IMP=0x0000000100123150
- (void)dealloc;	// IMP=0x0000000100122e4c
- (unsigned long long)hash;	// IMP=0x0000000100122e28
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100122da4
- (id)defaultCategory;	// IMP=0x0000000100123628
- (unsigned short)numberOfCategories;	// IMP=0x000000010012361c
- (void)updateWithProperties:(id)arg1;	// IMP=0x0000000100139728
- (void)updateWithCacheObject:(id)arg1;	// IMP=0x000000010013903c
