...
+ (id)entityName;	// IMP=0x000000010004ac38
- (id)internalRepresentation;	// IMP=0x000000010004a9b8
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x000000010004a6e8
