...
+ (id)secureCodedPropertyKeys;	// IMP=0x00000001001236e4
...
- (void)storeItemURLForGamePlatform:(long long)arg1 withContext:(id)arg2 withHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000001001239bc
- (id)storeItemURLForURL:(id)arg1 gamePlatform:(long long)arg2 extraQueryParams:(id)arg3;	// IMP=0x000000010012395c
- (_Bool)isValid;	// IMP=0x0000000100123938
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001001238b4
- (unsigned long long)hash;	// IMP=0x000000010012389c
- (void)dealloc;	// IMP=0x0000000100123634
- (void)updateWithProperties:(id)arg1;	// IMP=0x000000010013adb0
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x000000010013a9d0
- (void)updateWithCacheObject:(id)arg1;	// IMP=0x000000010013a6b8
