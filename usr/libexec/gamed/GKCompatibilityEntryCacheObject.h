...
+ (id)entityName;	// IMP=0x00000001000509f0
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x0000000100050e2c
- (id)internalRepresentation;	// IMP=0x00000001000509fc
