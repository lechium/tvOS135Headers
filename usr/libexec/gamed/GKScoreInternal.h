...
+ (id)secureCodedPropertyKeys;	// IMP=0x000000010012dcf4
+ (_Bool)supportsSecureCoding;	// IMP=0x000000010012d7c0
...
- (unsigned long long)hash;	// IMP=0x000000010012e1b0
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010012dfc0
- (id)serverRepresentation;	// IMP=0x000000010012de98
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010012dbb4
- (id)initWithCoder:(id)arg1;	// IMP=0x000000010012d7e8
- (void)dealloc;	// IMP=0x000000010012d730
