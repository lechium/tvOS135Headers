...
- (void).cxx_destruct;	// IMP=0x00000001000c4e64
...
- (void)cancelConnection;	// IMP=0x00000001000c4de4
- (void)readData;	// IMP=0x00000001000c4de0
- (void)_sendData:(id)arg1;	// IMP=0x00000001000c4ddc
- (_Bool)sendData:(id)arg1;	// IMP=0x00000001000c4d70
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x00000001000c4b44
- (void)dealloc;	// IMP=0x00000001000c4aa8
- (id)initWithConnection:(id)arg1 delegate:(id)arg2 delegateQueue:(id)arg3;	// IMP=0x00000001000c49b0
