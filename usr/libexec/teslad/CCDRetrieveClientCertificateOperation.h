...
- (void).cxx_destruct;	// IMP=0x000000010000d494
...
- (void)timeoutTimerDidFire:(id)arg1;	// IMP=0x000000010000d3a0
- (void)_startRetryTimerWithInterval:(double)arg1;	// IMP=0x000000010000d280
- (void)_retryCertificateRetrievalIfAllowedAfterDelayOrFailWithError:(id)arg1;	// IMP=0x000000010000d1f8
- (void)_retryCertificateRetrievalIfAllowed:(_Bool)arg1 afterDelay:(double)arg2 orFailWithError:(id)arg3;	// IMP=0x000000010000d110
- (void)_endOperation;	// IMP=0x000000010000d0d4
- (void)_completeOperationWithReferenceKey:(id)arg1 certificates:(id)arg2 error:(id)arg3;	// IMP=0x000000010000ce98
- (void)retrieveClientCertificate;	// IMP=0x000000010000ccd8
- (void)start;	// IMP=0x000000010000cc8c
- (_Bool)isAsynchronous;	// IMP=0x000000010000cc84
- (_Bool)isFinished;	// IMP=0x000000010000cbfc
- (_Bool)isExecuting;	// IMP=0x000000010000cb74
- (_Bool)isReady;	// IMP=0x000000010000caec
- (id)init;	// IMP=0x000000010000caa4
