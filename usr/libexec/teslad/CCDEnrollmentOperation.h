...
- (void).cxx_destruct;	// IMP=0x00000001000098d8
...
- (id)errorForStatusCode:(long long)arg1 responseData:(id)arg2;	// IMP=0x0000000100009740
- (id)responseWithResponseData:(id)arg1 contentType:(id)arg2 outError:(id *)arg3;	// IMP=0x000000010000966c
- (void)completeOperationWithResponse:(id)arg1 error:(id)arg2;	// IMP=0x00000001000094c0
- (id)responseWithResponseData:(id)arg1 contentType:(id)arg2 statusCode:(long long)arg3 retryNeeded:(_Bool *)arg4 outError:(id *)arg5;	// IMP=0x000000010000939c
