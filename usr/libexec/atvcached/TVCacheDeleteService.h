...
+ (id)sharedInstance;	// IMP=0x0000000100004530
...
- (id)manager:(id)arg1 purgeTasksForUrgency:(long long)arg2;	// IMP=0x00000001000050ac
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x00000001000049ec
- (void)start;	// IMP=0x0000000100004918
- (void)dealloc;	// IMP=0x00000001000048b4
- (id)_init;	// IMP=0x00000001000045a8
