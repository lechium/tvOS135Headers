...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000010008d30c
...
- (id)initWithCoder:(id)arg1;	// IMP=0x000000010008d428
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000010008d314
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010008d218
- (_Bool)conformsToProtocol:(id)arg1;	// IMP=0x000000010008d198
- (id)description;	// IMP=0x000000010008cfa0
- (unsigned long long)hash;	// IMP=0x000000010008cf6c
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010008cf04
- (_Bool)isEqualToPeerMessageFragment:(id)arg1;	// IMP=0x000000010008ce78
- (void)dealloc;	// IMP=0x000000010008ce20
- (id)init;	// IMP=0x000000010008cde0
