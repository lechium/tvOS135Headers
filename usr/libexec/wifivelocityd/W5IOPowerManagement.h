...
- (unsigned int)caps;	// IMP=0x0000000100086d80
- (void)stopEventMonitoring;	// IMP=0x0000000100086cdc
- (void)startEventMonitoring;	// IMP=0x0000000100086a44
- (void)dealloc;	// IMP=0x00000001000869f0
- (id)init;	// IMP=0x0000000100086894
