...
- (unsigned int)flags;	// IMP=0x0000000100016928
- (void)stopEventMonitoring;	// IMP=0x000000010001686c
- (void)startEventMonitoring;	// IMP=0x0000000100016650
- (id)description;	// IMP=0x00000001000165b4
- (void)dealloc;	// IMP=0x0000000100016470
- (id)init;	// IMP=0x0000000100016438
- (id)initWithHostName:(id)arg1;	// IMP=0x0000000100016370
