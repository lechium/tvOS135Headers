...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010005cda0
- (unsigned long long)hash;	// IMP=0x000000010005cd90
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010005cd28
- (_Bool)isEqualToLogItemRequestInternal:(id)arg1;	// IMP=0x000000010005ccec
- (id)description;	// IMP=0x000000010005caac
- (void)dealloc;	// IMP=0x000000010005ca3c
