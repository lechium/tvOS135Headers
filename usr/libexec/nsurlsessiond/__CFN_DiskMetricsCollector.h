...
- (void).cxx_destruct;	// IMP=0x00000001000055bc
...
- (void)recordBytes:(unsigned long long)arg1 bundleID:(id)arg2;	// IMP=0x0000000100005440
- (void)deleteMetrics;	// IMP=0x0000000100005364
- (void)saveMetrics;	// IMP=0x0000000100005114
- (void)readMetrics;	// IMP=0x0000000100004e28
- (id)initWithStageURL:(id)arg1 reportHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000100004b8c
