...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000010004b9f4
- (void).cxx_destruct;	// IMP=0x000000010004b9e8
...
- (id)initWithCoder:(id)arg1;	// IMP=0x000000010004b88c
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000010004b798
- (id)initWithCallbackType:(int)arg1 taskIdentifier:(unsigned long long)arg2 args:(id)arg3;	// IMP=0x000000010004b6b4
