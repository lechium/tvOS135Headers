...
- (void).cxx_destruct;	// IMP=0x000000010003c744
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000010003c60c
- (unsigned long long)hash;	// IMP=0x000000010003c564
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010003c438
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010003c33c
- (void)copyTo:(id)arg1;	// IMP=0x000000010003c270
- (void)writeTo:(id)arg1;	// IMP=0x000000010003c1ac
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000010003bda8
- (id)dictionaryRepresentation;	// IMP=0x000000010003bc04
- (id)description;	// IMP=0x000000010003bb50
