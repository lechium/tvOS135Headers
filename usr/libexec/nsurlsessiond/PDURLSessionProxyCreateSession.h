...
- (void).cxx_destruct;	// IMP=0x0000000100008a9c
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000100008878
- (unsigned long long)hash;	// IMP=0x0000000100008748
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100008548
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001000083a0
- (void)copyTo:(id)arg1;	// IMP=0x000000010000823c
- (void)writeTo:(id)arg1;	// IMP=0x00000001000080f0
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000100007a30
- (id)dictionaryRepresentation;	// IMP=0x0000000100007778
- (id)description;	// IMP=0x00000001000076c4
