...
- (void).cxx_destruct;	// IMP=0x000000010015d8e8
...
- (id)peerListFromAWDLInfo:(id)arg1;	// IMP=0x000000010015cf88
- (void)sendData:(id)arg1 bleDevice:(id)arg2 direct:(_Bool)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x000000010015ca98
- (void)sendData:(id)arg1 bleDevice:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x000000010015ca28
- (void)sendAWDLInfo:(_Bool)arg1;	// IMP=0x000000010015c2f8
- (void)sendAWDLInfo;	// IMP=0x000000010015c2e8
- (void)sendData:(id)arg1 type:(unsigned short)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x000000010015c220
- (void)sendData:(id)arg1 type:(unsigned short)arg2 errorHandler:(CDUnknownBlockType)arg3;	// IMP=0x000000010015c104
- (void)sendAWDLInfoData:(id)arg1 type:(unsigned short)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x000000010015c0ac
- (void)_start;	// IMP=0x000000010015c0a0
- (void)start;	// IMP=0x000000010015c014
- (id)getAppName;	// IMP=0x000000010015c00c
- (void)handleMessageWithWrapper:(id)arg1;	// IMP=0x000000010015c008
- (void)connectionActivated;	// IMP=0x000000010015c004
- (void)invalidate;	// IMP=0x000000010015bef4
- (id)initWithDevice:(id)arg1 sessionID:(id)arg2 bleDevice:(id)arg3;	// IMP=0x000000010015be2c
