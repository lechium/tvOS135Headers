...
- (void).cxx_destruct;	// IMP=0x0000000100159894
...
- (void)companionStreamClosedStreams:(id)arg1;	// IMP=0x0000000100159814
- (void)manager:(id)arg1 connectedToService:(id)arg2 withFileHandle:(id)arg3 acceptHandler:(CDUnknownBlockType)arg4;	// IMP=0x00000001001595f4
- (void)disableService:(id)arg1;	// IMP=0x000000010015956c
- (void)enableService:(id)arg1;	// IMP=0x00000001001594e8
- (id)streamHandlerForService:(id)arg1;	// IMP=0x0000000100159484
- (void)stop;	// IMP=0x0000000100159298
- (void)start;	// IMP=0x0000000100159248
- (id)initWithClientProxy:(id)arg1 withIdentifier:(id)arg2;	// IMP=0x0000000100159140
