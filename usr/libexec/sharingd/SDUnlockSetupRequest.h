...
- (void).cxx_destruct;	// IMP=0x00000001000d9b58
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000001000d99f8
- (unsigned long long)hash;	// IMP=0x00000001000d9920
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001000d97b8
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001000d9694
- (void)copyTo:(id)arg1;	// IMP=0x00000001000d95ac
- (void)writeTo:(id)arg1;	// IMP=0x00000001000d94d8
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000001000d94d0
- (id)dictionaryRepresentation;	// IMP=0x00000001000d8f4c
- (id)description;	// IMP=0x00000001000d8e98
