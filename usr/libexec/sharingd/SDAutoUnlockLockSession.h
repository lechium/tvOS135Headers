...
- (void).cxx_destruct;	// IMP=0x00000001001cdd44
...
- (void)sendUnlockConfirmation:(_Bool)arg1 withError:(id)arg2;	// IMP=0x00000001001cce34
- (void)sendKeyExchangeResponseWithData:(id)arg1;	// IMP=0x00000001001ccb34
- (void)sendAuthPromptImageDataIfReady:(id)arg1;	// IMP=0x00000001001cc3b8
- (void)sendAuthPromptRequestWithImageHash:(id)arg1 appName:(id)arg2;	// IMP=0x00000001001cbf98
- (void)sendAWDLInfoData:(id)arg1 type:(unsigned short)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000001001cbc90
- (void)consumeAuthTokenIfReady;	// IMP=0x00000001001cb714
- (void)startAWDL;	// IMP=0x00000001001cab80
- (void)handleConfirmationACK;	// IMP=0x00000001001ca920
- (void)handleSessionAuthToken:(id)arg1;	// IMP=0x00000001001ca4e4
- (void)handleSessionKeyExchangeRequest:(id)arg1;	// IMP=0x00000001001c9d10
- (void)handleAuthPromptResponse:(id)arg1;	// IMP=0x00000001001c99a4
- (void)handleAWDLInfo:(id)arg1;	// IMP=0x00000001001c931c
- (void)handleMessageWithWrapper:(id)arg1;	// IMP=0x00000001001c8e78
- (void)notifyDelegateWithError:(id)arg1;	// IMP=0x00000001001c8c28
- (void)handleWiFiRequestInvalidated;	// IMP=0x00000001001c8bbc
- (void)handleRangingStarted;	// IMP=0x00000001001c8b1c
- (void)handlePeerFound:(_Bool)arg1;	// IMP=0x00000001001c8a54
- (void)handleAWDLUp;	// IMP=0x00000001001c8880
- (void)handlePeerOutOfRange;	// IMP=0x00000001001c85a8
- (void)handlePeerInRange;	// IMP=0x00000001001c8450
- (_Bool)peerInRange:(id)arg1;	// IMP=0x00000001001c819c
- (void)handleRangingResults:(id)arg1 errorCode:(long long)arg2;	// IMP=0x00000001001c7d14
- (void)invalidateConfirmationTimer;	// IMP=0x00000001001c7c3c
- (void)restartConfirmationTimer:(unsigned long long)arg1 error:(id)arg2;	// IMP=0x00000001001c79b8
- (void)handleTimerFired;	// IMP=0x00000001001c7444
- (void)invalidateTimerIfReady;	// IMP=0x00000001001c73ec
- (id)aksPeerAvailable;	// IMP=0x00000001001c71e4
- (void)deviceConnected:(id)arg1;	// IMP=0x00000001001c6dfc
- (_Bool)handleFoundBLEDevice:(id)arg1 available:(_Bool)arg2 lockedOnWrist:(_Bool)arg3;	// IMP=0x00000001001c6b04
- (_Bool)handleFoundBLEDevice:(id)arg1;	// IMP=0x00000001001c6a98
- (void)connectionActivated;	// IMP=0x00000001001c677c
- (void)updateImageData:(id)arg1 imageHash:(id)arg2;	// IMP=0x00000001001c6160
- (id)getAppName;	// IMP=0x00000001001c6158
@property(readonly, nonatomic) _Bool usingProxy;
- (id)hintToken;	// IMP=0x00000001001c6024
- (_Bool)isAcceptor;	// IMP=0x00000001001c601c
- (id)attemptResults;	// IMP=0x00000001001c5440
- (void)logResults;	// IMP=0x00000001001c4648
- (void)displayConfigChanged:(id)arg1;	// IMP=0x00000001001c45a4
- (void)clamshellStateChanged:(id)arg1;	// IMP=0x00000001001c4500
- (void)removeObservers;	// IMP=0x00000001001c44b0
- (void)addObservers;	// IMP=0x00000001001c43a8
- (void)handleDecryptionFailure:(long long)arg1;	// IMP=0x00000001001c4238
- (void)_handleCanceledAfterSuccess;	// IMP=0x00000001001c4130
- (void)handleCanceledAfterSuccess;	// IMP=0x00000001001c40a4
- (void)lockKeyBagIfNeeded;	// IMP=0x00000001001c3fc0
- (void)_cancel;	// IMP=0x00000001001c3c4c
- (void)cancel;	// IMP=0x00000001001c3bc0
- (void)invalidateNoDisconnect;	// IMP=0x00000001001c3b8c
- (void)invalidate;	// IMP=0x00000001001c3988
- (id)initWithAutoUnlockDevice:(id)arg1 sessionID:(id)arg2 bleDevice:(id)arg3;	// IMP=0x00000001001c3594
