...
- (void).cxx_destruct;	// IMP=0x000000010009a1c4
...
- (_Bool)stateIsNearby;	// IMP=0x0000000100099e48
- (_Bool)stateIsMedium;	// IMP=0x0000000100099e04
- (_Bool)stateIsClose;	// IMP=0x0000000100099df0
- (void)resetTicks;	// IMP=0x0000000100099c44
@property(readonly, copy, nonatomic) NSString *name;
@property(readonly, copy, nonatomic) NSString *effectiveID;
@property(readonly, nonatomic) _Bool isReady;
- (_Bool)_canTransition:(int)arg1;	// IMP=0x0000000100099900
- (_Bool)canTransition:(int)arg1;	// IMP=0x0000000100099804
- (id)description;	// IMP=0x0000000100099460
