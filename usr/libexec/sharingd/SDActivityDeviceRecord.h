...
- (void).cxx_destruct;	// IMP=0x000000010004779c
...
- (void)updateWithRawAdvertisementData:(id)arg1 receivedViaScanning:(_Bool)arg2 isReplay:(_Bool)arg3 newAdvertisementHandler:(CDUnknownBlockType)arg4;	// IMP=0x0000000100046868
- (void)updateWithRawAdvertisementData:(id)arg1 receivedViaScanning:(_Bool)arg2 newAdvertisementHandler:(CDUnknownBlockType)arg3;	// IMP=0x000000010004680c
- (id)description;	// IMP=0x000000010004671c
- (id)initWithDevice:(id)arg1;	// IMP=0x0000000100046680
