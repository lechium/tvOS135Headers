...
- (void).cxx_destruct;	// IMP=0x000000010016e8d8
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000010016e43c
- (unsigned long long)hash;	// IMP=0x000000010016e1b8
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010016de08
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010016daac
- (void)copyTo:(id)arg1;	// IMP=0x000000010016d7a4
- (void)writeTo:(id)arg1;	// IMP=0x000000010016d4e8
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000010016d4e0
- (id)dictionaryRepresentation;	// IMP=0x000000010016c3e4
- (id)description;	// IMP=0x000000010016c330
