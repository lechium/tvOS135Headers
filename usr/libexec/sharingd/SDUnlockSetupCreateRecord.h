...
- (void).cxx_destruct;	// IMP=0x00000001000c4b50
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000001000c49ec
- (unsigned long long)hash;	// IMP=0x00000001000c4920
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001000c47c4
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001000c4694
- (void)copyTo:(id)arg1;	// IMP=0x00000001000c45a8
- (void)writeTo:(id)arg1;	// IMP=0x00000001000c44c8
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000001000c44c0
- (id)dictionaryRepresentation;	// IMP=0x00000001000c3f40
- (id)description;	// IMP=0x00000001000c3e8c
