...
- (void).cxx_destruct;	// IMP=0x00000001000f1a60
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000001000f1160
- (unsigned long long)hash;	// IMP=0x00000001000f0bd4
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001000f03fc
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001000efd6c
- (void)copyTo:(id)arg1;	// IMP=0x00000001000ef740
- (void)writeTo:(id)arg1;	// IMP=0x00000001000ef1ac
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000001000ef1a4
- (id)dictionaryRepresentation;	// IMP=0x00000001000ecc64
- (id)description;	// IMP=0x00000001000ecbb0
