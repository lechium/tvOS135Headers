...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000100171630
- (unsigned long long)hash;	// IMP=0x000000010017157c
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100171430
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000100171320
- (void)copyTo:(id)arg1;	// IMP=0x000000010017122c
- (void)writeTo:(id)arg1;	// IMP=0x000000010017113c
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000100171134
- (id)dictionaryRepresentation;	// IMP=0x0000000100170a50
- (id)description;	// IMP=0x000000010017099c
