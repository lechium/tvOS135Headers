...
+ (id)sharedSession;	// IMP=0x00000001000c9ba4
- (void).cxx_destruct;	// IMP=0x00000001000c9e70
...
- (void)connectionManagerDidInvalidate:(id)arg1;	// IMP=0x00000001000c9e38
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x00000001000c9d98
- (void)stop;	// IMP=0x00000001000c9d40
- (void)start;	// IMP=0x00000001000c9c80
- (id)init;	// IMP=0x00000001000c9c10
