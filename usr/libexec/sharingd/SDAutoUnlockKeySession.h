...
- (void).cxx_destruct;	// IMP=0x00000001000411d4
...
- (void)logAutoUnlockEnd;	// IMP=0x0000000100040d34
- (void)logAutoUnlockStart;	// IMP=0x0000000100040be4
- (void)invalidateAssertionTimer;	// IMP=0x0000000100040b0c
- (void)restartAssertionTimer;	// IMP=0x00000001000408f4
- (void)releaseIdleSleepAssertion;	// IMP=0x000000010004084c
- (void)declareSystemActivityAssertion;	// IMP=0x00000001000405e8
- (void)sendConfirmationACK;	// IMP=0x00000001000403b0
- (void)sendSessionAuthToken:(id)arg1 error:(id)arg2;	// IMP=0x000000010003ff10
- (void)sendKeyExchangeRequestWithData:(id)arg1 error:(id)arg2;	// IMP=0x000000010003fbc4
- (void)sendAuthPromptResponseWithData:(id)arg1 error:(id)arg2;	// IMP=0x000000010003f8a0
- (void)sendAWDLInfoWithKeyData:(id)arg1 error:(id)arg2;	// IMP=0x000000010003f20c
- (void)handleUnlockConfirmation:(id)arg1;	// IMP=0x000000010003ede8
- (void)createAuthTokenIfReady;	// IMP=0x000000010003e6a8
- (void)handleSessionKeyExchangeResponse:(id)arg1;	// IMP=0x000000010003e438
- (void)handleAuthPromptImageData:(id)arg1;	// IMP=0x000000010003e174
- (void)handleAuthPromptRequest:(id)arg1;	// IMP=0x000000010003dcf0
- (_Bool)handleAWDLInfo:(id)arg1;	// IMP=0x000000010003d92c
- (void)handleMessageWithWrapper:(id)arg1;	// IMP=0x000000010003d29c
- (void)handleWiFiRequestInvalidated;	// IMP=0x000000010003d254
- (void)handleWiFiRequestStartedWithStartAWDLHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000010003d220
- (void)awdlNetworkStarted;	// IMP=0x000000010003d054
- (void)createWiFiRequest;	// IMP=0x000000010003ca48
- (void)alertOfUnlock;	// IMP=0x000000010003c934
- (void)promptForApproval;	// IMP=0x000000010003c930
- (void)deviceDisconnected:(id)arg1;	// IMP=0x000000010003c6b8
- (void)removeObservers;	// IMP=0x000000010003c668
- (void)addObservers;	// IMP=0x000000010003c600
- (void)beginAKSSession;	// IMP=0x000000010003c5fc
- (void)notifyDelegateWithError:(id)arg1;	// IMP=0x000000010003c428
- (_Bool)keyCanUnlock;	// IMP=0x000000010003c420
- (void)_invalidate;	// IMP=0x000000010003c1ec
- (void)invalidate;	// IMP=0x000000010003c168
- (id)initWithBLEDevice:(id)arg1 sessionID:(id)arg2;	// IMP=0x000000010003bea0
