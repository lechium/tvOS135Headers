...
- (void).cxx_destruct;	// IMP=0x00000001000c1480
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000001000c1268
- (unsigned long long)hash;	// IMP=0x00000001000c1134
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001000c0f34
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001000c0d94
- (void)copyTo:(id)arg1;	// IMP=0x00000001000c0c38
- (void)writeTo:(id)arg1;	// IMP=0x00000001000c0afc
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000001000c0af4
- (id)dictionaryRepresentation;	// IMP=0x00000001000c0324
- (id)description;	// IMP=0x00000001000c0270
