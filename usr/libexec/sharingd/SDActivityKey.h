...
- (void).cxx_destruct;	// IMP=0x000000010011f790
...
- (unsigned long long)hash;	// IMP=0x000000010011f594
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010011f4bc
- (id)description;	// IMP=0x000000010011f3b8
- (void)dealloc;	// IMP=0x000000010011f300
- (id)initWithDictRepresentation:(id)arg1;	// IMP=0x000000010011f10c
