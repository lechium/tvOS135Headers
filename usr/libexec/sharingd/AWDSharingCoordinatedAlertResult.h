...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000010015bc78
- (unsigned long long)hash;	// IMP=0x000000010015bb84
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010015b9d0
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010015b870
- (void)copyTo:(id)arg1;	// IMP=0x000000010015b72c
- (void)writeTo:(id)arg1;	// IMP=0x000000010015b5f4
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000010015b5ec
- (id)dictionaryRepresentation;	// IMP=0x000000010015acec
- (id)description;	// IMP=0x000000010015ac38
