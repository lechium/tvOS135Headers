...
+ (id)sharedManager;	// IMP=0x00000001000d7a38
- (void).cxx_destruct;	// IMP=0x00000001000d8bec
...
- (void)unlockSessionDidFinish:(id)arg1;	// IMP=0x00000001000d8a90
- (void)companionStreamClosedStreams:(id)arg1;	// IMP=0x00000001000d8a80
- (void)appleAccountSignedOut;	// IMP=0x00000001000d8a00
- (void)appleAccountSignedIn;	// IMP=0x00000001000d8980
- (void)createUnlockManagerWithReply:(CDUnknownBlockType)arg1;	// IMP=0x00000001000d88f8
- (void)createStreamsForMessage:(id)arg1 reply:(CDUnknownBlockType)arg2;	// IMP=0x00000001000d8630
- (void)createCompanionServiceManagerWithIdentifier:(id)arg1 clientProxy:(id)arg2 reply:(CDUnknownBlockType)arg3;	// IMP=0x00000001000d82b8
- (void)cleanUpConnections;	// IMP=0x00000001000d8018
- (void)start;	// IMP=0x00000001000d7bfc
- (id)initWithXPCConnection:(id)arg1;	// IMP=0x00000001000d7aa4
