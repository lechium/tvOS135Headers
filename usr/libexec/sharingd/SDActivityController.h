...
- (void).cxx_destruct;	// IMP=0x0000000100080d04
...
- (void)service:(id)arg1 nearbyDevicesChanged:(id)arg2;	// IMP=0x0000000100080bf4
- (void)service:(id)arg1 devicesChanged:(id)arg2;	// IMP=0x0000000100080a74
- (void)nearbyServiceDevicesChanged:(id)arg1;	// IMP=0x00000001000805b8
- (void)activityServiceDevicesChanged:(id)arg1;	// IMP=0x00000001000805b4
- (id)idsDeviceFromBTIdentifier:(id)arg1;	// IMP=0x0000000100080274
- (void)stop;	// IMP=0x0000000100080270
- (_Bool)restart;	// IMP=0x0000000100080268
- (void)start;	// IMP=0x0000000100080264
- (id)init;	// IMP=0x00000001000801c8
