...
- (void).cxx_destruct;	// IMP=0x0000000100102334
...
- (void)stop;	// IMP=0x00000001001022a0
- (int)start;	// IMP=0x00000001001021f0
- (void)eject;	// IMP=0x0000000100101fbc
- (void)ejectMountPoints:(id)arg1 useAssistant:(_Bool)arg2;	// IMP=0x0000000100101fb8
- (void)notifyClientAboutEject:(int)arg1;	// IMP=0x0000000100101e38
- (void)dealloc;	// IMP=0x0000000100101df0
- (id)initWithNode:(struct __SFNode *)arg1;	// IMP=0x0000000100101d7c
