...
- (void).cxx_destruct;	// IMP=0x0000000100177040
...
- (void)logClientReceived;	// IMP=0x0000000100176e48
- (void)logClientSent;	// IMP=0x0000000100176dd4
- (void)writeNetworkStream;	// IMP=0x0000000100176cc8
- (void)readClientStream;	// IMP=0x0000000100176aa0
- (void)writeClientStream;	// IMP=0x0000000100176760
- (void)handleOpenedStream;	// IMP=0x00000001001766c0
- (void)stream:(id)arg1 handleEvent:(unsigned long long)arg2;	// IMP=0x00000001001764f8
- (void)streamHandlerDidClose:(id)arg1 withError:(id)arg2;	// IMP=0x000000010017627c
- (void)streamHandler:(id)arg1 didReceiveStreamData:(id)arg2;	// IMP=0x0000000100176208
- (void)streamHandler:(id)arg1 bufferSpaceChanged:(_Bool)arg2;	// IMP=0x0000000100176184
- (void)handleStreamResponse:(id)arg1;	// IMP=0x0000000100175f84
- (void)handleStreamRequest:(id)arg1;	// IMP=0x0000000100175d0c
- (void)streamHandler:(id)arg1 didReceiveMessage:(id)arg2;	// IMP=0x0000000100175b68
- (void)netServiceBrowser:(id)arg1 didFindService:(id)arg2 moreComing:(_Bool)arg3;	// IMP=0x0000000100175ab0
- (int)setBufferSize:(int)arg1 socket:(int)arg2;	// IMP=0x0000000100175a4c
@property(readonly) NSFileHandle *fileHandle; // @synthesize fileHandle=_fileHandle;
- (void)notifyStreamRequestWithError:(id)arg1;	// IMP=0x0000000100175518
- (void)switchToStreaming;	// IMP=0x0000000100175484
- (void)sendInitialResponse:(_Bool)arg1;	// IMP=0x0000000100175178
- (void)sendInitialRequest;	// IMP=0x0000000100174df0
- (void)startBrowser;	// IMP=0x0000000100174d14
- (void)getStreamsWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000100174cb0
- (void)setBundleID:(id)arg1;	// IMP=0x0000000100174bfc
- (void)stopIfReady;	// IMP=0x0000000100174bac
- (void)stop;	// IMP=0x00000001001749e8
- (void)start;	// IMP=0x00000001001749ac
- (void)dealloc;	// IMP=0x0000000100174960
- (id)initWithAuthorData:(id)arg1 streamHandler:(id)arg2;	// IMP=0x0000000100174838
- (id)initWithStreamHandler:(id)arg1;	// IMP=0x0000000100174824
