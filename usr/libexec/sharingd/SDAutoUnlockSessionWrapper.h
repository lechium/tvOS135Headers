...
- (void).cxx_destruct;	// IMP=0x00000001000dc50c
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000001000dc228
- (unsigned long long)hash;	// IMP=0x00000001000dc0ac
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001000dbe38
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001000dbc20
- (void)copyTo:(id)arg1;	// IMP=0x00000001000dba64
- (void)writeTo:(id)arg1;	// IMP=0x00000001000db8d4
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000001000db8cc
- (id)dictionaryRepresentation;	// IMP=0x00000001000db054
- (id)description;	// IMP=0x00000001000dafa0
