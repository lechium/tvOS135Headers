...
- (void).cxx_destruct;	// IMP=0x000000010015f444
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000010015f1bc
- (unsigned long long)hash;	// IMP=0x000000010015f04c
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010015ee14
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010015ec24
- (void)copyTo:(id)arg1;	// IMP=0x000000010015ea78
- (void)writeTo:(id)arg1;	// IMP=0x000000010015e8f4
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000010015e8ec
- (id)dictionaryRepresentation;	// IMP=0x000000010015df48
- (id)description;	// IMP=0x000000010015de94
