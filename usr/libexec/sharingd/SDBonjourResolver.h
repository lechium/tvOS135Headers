...
- (void).cxx_destruct;	// IMP=0x00000001001c337c
...
- (void)cancel;	// IMP=0x00000001001c3280
- (void)resolve;	// IMP=0x00000001001c2db8
- (void)parseResults:(const char *)arg1 port:(unsigned short)arg2 txtLen:(unsigned short)arg3 txtRecord:(const char *)arg4 interface:(unsigned int)arg5;	// IMP=0x00000001001c29ec
- (void)notifyClient:(int)arg1;	// IMP=0x00000001001c299c
- (void)dealloc;	// IMP=0x00000001001c2950
- (id)initWithName:(id)arg1 type:(id)arg2 domain:(id)arg3 path:(id)arg4 timeout:(_Bool)arg5;	// IMP=0x00000001001c2810
