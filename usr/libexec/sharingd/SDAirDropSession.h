...
- (void).cxx_destruct;	// IMP=0x0000000100034450
...
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x0000000100034058
- (void)handleConversionProgress:(id)arg1;	// IMP=0x0000000100033f68
- (void)startProgress;	// IMP=0x0000000100033d74
- (void)postNotificationForTransferStatus:(long long)arg1 progress:(double)arg2;	// IMP=0x0000000100033d70
- (void)airDropClient:(id)arg1 event:(long long)arg2 withResults:(id)arg3;	// IMP=0x0000000100033640
- (void)removeClientAlerts;	// IMP=0x0000000100033518
- (void)dealloc;	// IMP=0x000000010003348c
- (void)stop;	// IMP=0x00000001000332f8
- (void)addClientForNode:(struct __SFNode *)arg1 shouldPublishProgress:(_Bool)arg2;	// IMP=0x000000010003306c
- (void)serversChanged:(id)arg1;	// IMP=0x0000000100032d94
- (_Bool)send;	// IMP=0x0000000100032c68
- (void)start;	// IMP=0x0000000100032a78
- (void)releaseSandboxExtensions;	// IMP=0x0000000100032964
- (void)consumeSandboxExtensions;	// IMP=0x000000010003276c
- (void)setProperty:(id)arg1 forKey:(id)arg2;	// IMP=0x0000000100032704
- (id)initWithPerson:(struct __SFNode *)arg1 items:(id)arg2 sandboxExtensions:(id)arg3;	// IMP=0x0000000100032510
