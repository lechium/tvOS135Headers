...
- (void).cxx_destruct;	// IMP=0x0000000100082b04
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000100082808
- (unsigned long long)hash;	// IMP=0x0000000100082658
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001000823d0
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010008218c
- (void)copyTo:(id)arg1;	// IMP=0x0000000100081f8c
- (void)writeTo:(id)arg1;	// IMP=0x0000000100081dbc
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000100081db4
- (id)dictionaryRepresentation;	// IMP=0x0000000100081218
- (id)description;	// IMP=0x0000000100081164
