...
+ (id)entryForBundle:(id)arg1 inContainer:(id)arg2 withError:(id *)arg3;	// IMP=0x00000001000048e4
+ (_Bool)enumeratePluginKitPluginsInBundle:(id)arg1 updatingPluginParentID:(_Bool)arg2 ensurePluginsAreExecutable:(_Bool)arg3 installProfiles:(_Bool)arg4 error:(id *)arg5 enumerator:(CDUnknownBlockType)arg6;	// IMP=0x0000000100004228
- (void).cxx_destruct;	// IMP=0x0000000100005648
...
- (_Bool)performGatherWithError:(id *)arg1;	// IMP=0x000000010000544c
- (void)errorOccurred:(id)arg1;	// IMP=0x00000001000053c0
- (_Bool)scanExecutableBundle:(id)arg1 inContainer:(id)arg2 withError:(id *)arg3;	// IMP=0x0000000100005064
- (id)_setForEntry:(id)arg1;	// IMP=0x0000000100004e3c
- (_Bool)_scanBundle:(id)arg1 inBundleContainer:(id)arg2 withError:(id *)arg3;	// IMP=0x0000000100004b98
- (id)initWithEnumerator:(CDUnknownBlockType)arg1;	// IMP=0x000000010000406c
