...
- (void).cxx_destruct;	// IMP=0x000000010001d780
...
- (id)launchServicesDictionaryWithError:(id *)arg1;	// IMP=0x000000010001a360
- (id)_staticDiskUsage;	// IMP=0x000000010001a034
- (id)_groupContainersDictionary;	// IMP=0x0000000100019dec
- (id)_sandboxEnvironment;	// IMP=0x0000000100019bfc
- (id)_determineApplicationType;	// IMP=0x0000000100019b24
- (id)initWithWatchKitAppBundle:(id)arg1 inBundle:(id)arg2;	// IMP=0x0000000100019a44
- (id)initWithPluginBundle:(id)arg1 inBundleIdentifier:(id)arg2 dataContainer:(id)arg3;	// IMP=0x0000000100019974
- (id)initWithBundleContainer:(id)arg1 dataContainer:(id)arg2;	// IMP=0x0000000100019898
- (id)initWithBundleContainer:(id)arg1;	// IMP=0x0000000100019888
- (id)initWithBundle:(id)arg1 dataContainer:(id)arg2;	// IMP=0x00000001000197d4
- (void)_fixUpForBuiltInAppParallelPlaceholder;	// IMP=0x0000000100018e20
