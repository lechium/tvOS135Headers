...
- (void).cxx_destruct;	// IMP=0x00000001000247ac
...
- (_Bool)createSnapshotWithError:(id *)arg1;	// IMP=0x000000010002453c
- (void)dealloc;	// IMP=0x00000001000244c4
- (id)initWithBundleID:(id)arg1 snapshotTo:(id)arg2 onlyV1AppIfPresent:(_Bool)arg3 placeholderOnly:(_Bool)arg4;	// IMP=0x0000000100024404
