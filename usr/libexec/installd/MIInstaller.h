...
+ (id)installerForURL:(id)arg1 withOptions:(id)arg2 forClient:(id)arg3;	// IMP=0x000000010000e940
- (void).cxx_destruct;	// IMP=0x0000000100013cc8
...
- (_Bool)performInstallationWithError:(id *)arg1;	// IMP=0x00000001000125fc
- (_Bool)_installProvisioningProfilesAtStagingRootWithError:(id *)arg1;	// IMP=0x00000001000121a0
- (_Bool)_installProvisioningProfilesFromUserOptionsWithError:(id *)arg1;	// IMP=0x0000000100011e2c
- (_Bool)_discoverInstallablesWithError:(id *)arg1;	// IMP=0x0000000100010dd4
- (void)_writeLockBundles:(id)arg1;	// IMP=0x0000000100010bb4
- (void)_acquireTerminationAssertionsForBundles:(id)arg1;	// IMP=0x00000001000109b0
- (id)_bundlesAtURL:(id)arg1 error:(id *)arg2;	// IMP=0x00000001000105f0
- (id)_manifestPathForBase:(id)arg1 withIdentifier:(id)arg2 patchType:(unsigned char *)arg3 error:(id *)arg4;	// IMP=0x0000000100010100
- (_Bool)_extractPackageContainedSymlink:(_Bool *)arg1 withError:(id *)arg2;	// IMP=0x000000010000f8d0
- (_Bool)_setupPackageStateWithError:(id *)arg1;	// IMP=0x000000010000ed14
- (_Bool)_takeOwnershipOfInstallableContainingSymlink:(_Bool *)arg1 error:(id *)arg2;	// IMP=0x000000010000eabc
- (void)_fireCallbackWithStatus:(id)arg1;	// IMP=0x000000010000ea50
- (void)_fireCallbackWithStatus:(id)arg1 percentComplete:(unsigned int)arg2;	// IMP=0x000000010000e9dc
- (void)dealloc;	// IMP=0x000000010000e764
- (id)initWithURL:(id)arg1 options:(id)arg2 forClient:(id)arg3;	// IMP=0x000000010000e694
- (id)init;	// IMP=0x000000010000e688
