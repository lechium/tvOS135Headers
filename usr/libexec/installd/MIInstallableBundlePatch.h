...
- (void).cxx_destruct;	// IMP=0x00000001000386b4
...
- (_Bool)performVerificationWithError:(id *)arg1;	// IMP=0x0000000100038440
- (_Bool)applyPatchWithError:(id *)arg1;	// IMP=0x0000000100037e18
- (_Bool)_applyParallelPatchWithError:(id *)arg1;	// IMP=0x000000010003792c
- (_Bool)_applyDeltaPatchWithError:(id *)arg1;	// IMP=0x0000000100037234
@property(readonly, nonatomic) NSString *patchTypeName; // @dynamic patchTypeName;
- (id)initWithBundle:(id)arg1 inStagingRoot:(id)arg2 packageFormat:(unsigned char)arg3 userOptions:(id)arg4 manifestURL:(id)arg5 existingBundleContainer:(id)arg6 patchType:(unsigned char)arg7 error:(id *)arg8;	// IMP=0x0000000100036d7c
