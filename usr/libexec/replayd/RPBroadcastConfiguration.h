...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000010001c064
- (void).cxx_destruct;	// IMP=0x000000010001c090
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000010001bf8c
- (id)initWithCoder:(id)arg1;	// IMP=0x000000010001be98
