...
- (void).cxx_destruct;	// IMP=0x00000001000107dc
...
- (void)statusBarCoordinator:(id)arg1 invalidatedRegistrationWithError:(id)arg2;	// IMP=0x0000000100010664
- (void)updateStatusStringWithTimer:(id)arg1;	// IMP=0x0000000100010660
- (void)updateDoubleHeightStatusBarWithDuration:(double)arg1 paused:(_Bool)arg2;	// IMP=0x000000010001065c
- (id)rpLocalizedRecordingDuration:(double)arg1 paused:(_Bool)arg2;	// IMP=0x0000000100010558
- (id)stringWithTimeInterval:(double)arg1;	// IMP=0x000000010001046c
- (void)invalidateDoubleHeightStatusBar;	// IMP=0x0000000100010468
- (void)startRepeatingTimer;	// IMP=0x000000010001036c
- (void)showDoubleHeightStatusBarWithPid:(int)arg1;	// IMP=0x0000000100010368
- (void)acquireAssertionWithPid:(int)arg1;	// IMP=0x000000010001030c
- (void)acquireAssertionWithPidWaitForCompletion:(int)arg1;	// IMP=0x0000000100010308
