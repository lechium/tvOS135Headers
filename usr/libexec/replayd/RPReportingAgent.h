...
+ (void)reportSessionEnded:(unsigned short)arg1 endReason:(id)arg2 withServiceName:(id)arg3;	// IMP=0x00000001000139f8
...
- (void)reportEventWithType:(unsigned short)arg1 dictionary:(id)arg2;	// IMP=0x00000001000136f8
- (id)collectSummaryEventMetrics;	// IMP=0x0000000100013278
- (id)initWithServiceName:(id)arg1;	// IMP=0x0000000100013204
