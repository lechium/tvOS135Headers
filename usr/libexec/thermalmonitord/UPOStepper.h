...
+ (id)log;	// IMP=0x00000001000198d0
+ (id)newStepperWithTrueRA:(int)arg1 withUPOCount:(int)arg2 fromConfiguration:(id)arg3 useWeightedRa:(_Bool)arg4;	// IMP=0x0000000100019880
+ (id)newStepperWithTrueRA:(int)arg1 withUPOCount:(int)arg2 fromConfiguration:(id)arg3 withDefaultsDomain:(id)arg4 useWeightedRa:(_Bool)arg5;	// IMP=0x00000001000194dc
+ (void)initParameterValues:(_Bool)arg1;	// IMP=0x0000000100019430
+ (void)readConfigurationParameters:(id)arg1 useWeightedRa:(_Bool)arg2;	// IMP=0x0000000100019164
+ (void)initIntParameter:(int *)arg1 ForKey:(id)arg2 WithConfig:(id)arg3 useWeightedRa:(_Bool)arg4;	// IMP=0x00000001000190b8
+ (id)defaultsDomainFromKey:(id)arg1;	// IMP=0x0000000100018940
...
- (id)description;	// IMP=0x000000010001b9a4
- (void)updateUPOMetricsAtTime:(long long)arg1 withTrueRa:(long long)arg2 withEffectiveRa:(long long)arg3 withProbeDuration:(long long)arg4 withMitigationState:(unsigned long long)arg5 wasMitigatedUPO:(_Bool)arg6;	// IMP=0x000000010001b60c
- (void)clearMitigatedUPOCount;	// IMP=0x000000010001b558
- (void)recordDataToPowerLog;	// IMP=0x000000010001b3ec
- (void)notifyMitigationsEnabled;	// IMP=0x000000010001b124
- (void)disableMitigations;	// IMP=0x000000010001b104
- (void)reset:(_Bool)arg1;	// IMP=0x000000010001afd0
- (void)updateTrueRA:(int)arg1;	// IMP=0x000000010001af6c
- (void)updateUPOCount:(int)arg1;	// IMP=0x000000010001af08
- (void)reduceEffectiveRA:(_Bool)arg1;	// IMP=0x000000010001ad18
- (void)checkpoint;	// IMP=0x000000010001abdc
- (unsigned long long)secondsSinceBoot;	// IMP=0x000000010001abac
- (long long)convertContinuousTimeToSeconds:(unsigned long long)arg1;	// IMP=0x000000010001ab54
- (void)deregisterForBatteryInformationChanges;	// IMP=0x000000010001ab2c
- (void)registerForBatteryInformationChanges;	// IMP=0x000000010001a90c
- (id)allocBatteryShutdownData;	// IMP=0x000000010001a87c
- (_Bool)tooManyUPOs;	// IMP=0x000000010001a804
- (_Bool)upoDataIsAvailable;	// IMP=0x000000010001a760
- (void)obtainUPOSoC:(int *)arg1 andTemp:(int *)arg2 andTimestamp:(long long *)arg3;	// IMP=0x000000010001a550
- (void)handleUPO;	// IMP=0x000000010001a104
- (void)updateStateWithSavedState:(id)arg1 withUPOCount:(int)arg2 haveUPOData:(_Bool)arg3;	// IMP=0x0000000100019a7c
- (id)currentBootSessionUUID;	// IMP=0x0000000100019a10
- (char *)currentBootSessionUUIDStr;	// IMP=0x0000000100019970
- (void)updateMitigationState:(unsigned long long)arg1;	// IMP=0x000000010001993c
- (void)dealloc;	// IMP=0x0000000100019038
- (void)invalidate;	// IMP=0x0000000100018ff0
- (id)initWithTrueRA:(int)arg1 withUPOCount:(int)arg2 withDefaultsDomain:(id)arg3 useWeightedRa:(_Bool)arg4;	// IMP=0x0000000100018990
