...
- (struct __CFString *)copyFieldCurrentValueForIndex:(int)arg1;	// IMP=0x00000001000052ac
- (struct __CFString *)copyHeaderForIndex:(int)arg1;	// IMP=0x0000000100005298
- (int)numberOfFields;	// IMP=0x0000000100005290
- (void)handleTemperatureChangeNotification:(int)arg1 temperatureSensorIndex:(int)arg2;	// IMP=0x000000010000523c
- (void)handleStateChangeNotification:(int)arg1 temperatureSensorIndex:(int)arg2;	// IMP=0x00000001000051e0
- (void)updateSensor:(int)arg1 temperature:(unsigned long long)arg2;	// IMP=0x0000000100005174
- (void)dealloc;	// IMP=0x00000001000050fc
- (void)enableRearCameraJasperNotifications:(int)arg1;	// IMP=0x0000000100004fe0
- (void)enableRearCameraSuperWideNotifications:(int)arg1;	// IMP=0x0000000100004e0c
- (void)enableRearCameraTeleNotifications:(int)arg1;	// IMP=0x0000000100004c38
- (id)initWithFrontCameraSensorIdx:(int)arg1 rearCameraSensorIdx:(int)arg2;	// IMP=0x0000000100004794
