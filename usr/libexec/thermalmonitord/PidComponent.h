...
- (void)applySeedToIntegratorFromControlEffort:(int)arg1 currentTemperature:(float)arg2;	// IMP=0x00000001000084d0
- (_Bool)isIntegratorAtMin;	// IMP=0x00000001000084c0
- (_Bool)isEqualMType:(int)arg1;	// IMP=0x00000001000084b0
- (void)calculateControlEffort:(float)arg1;	// IMP=0x0000000100008430
- (void)dealloc;	// IMP=0x00000001000083e4
- (id)initPIDWith:(struct __CFDictionary *)arg1;	// IMP=0x00000001000082d0
